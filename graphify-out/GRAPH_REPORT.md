# Graph Report - parallel-wiggling-summit  (2026-07-10)

## Corpus Check
- 841 files · ~1,812,292 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25701 nodes · 47641 edges · 2199 communities (1942 shown, 257 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 5183 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6aa03b82`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_safe_import_jax|safe_import_jax]]
- [[_COMMUNITY_RheoData|RheoData]]
- [[_COMMUNITY_OWChirp|OWChirp]]
...
- [[_COMMUNITY_window.py|window.py]]
...
- [[_COMMUNITY_test_project_codec.py|test_project_codec.py]]
...
- [[_COMMUNITY_LatticeEPM|LatticeEPM]]
...
- [[_COMMUNITY_TestModelFitTemplate|TestModelFitTemplate]]
- [[_COMMUNITY_DatasetRef|DatasetRef]]
- [[_COMMUNITY_run_analyze|run_analyze]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY_ndarray|ndarray]]
- [[_COMMUNITY_FitResult|FitResult]]
...
- [[_COMMUNITY_test_window_chrome.py|test_window_chrome.py]]
- [[_COMMUNITY__translate_y2_col|_translate_y2_col]]
- [[_COMMUNITY_build_transform_controller|build_transform_controller]]
...
- [[_COMMUNITY_structure_factor.py|structure_factor.py]]
...
- [[_COMMUNITY_._steady_state_conformation|._steady_state_conformation]]
...
- [[_COMMUNITY_._predict|._predict]]
- [[_COMMUNITY_lattice.py|lattice.py]]
...
- [[_COMMUNITY_TestMLIKHProtocols|TestMLIKHProtocols]]
...
- [[_COMMUNITY_tensor.py|tensor.py]]
- [[_COMMUNITY_percus_yevick_sk|percus_yevick_sk]]
- [[_COMMUNITY_test_protocol_preprocessing.py|test_protocol_preprocessing.py]]
- [[_COMMUNITY_TestProcessExitVerification|TestProcessExitVerification]]
- [[_COMMUNITY_._predict|._predict]]
- [[_COMMUNITY__kernels.py|_kernels.py]]
- [[_COMMUNITY_TestPlotLissajous|TestPlotLissajous]]
...
- [[_COMMUNITY_main|main]]
- [[_COMMUNITY_TestMLIKHModelFunction|TestMLIKHModelFunction]]
- [[_COMMUNITY_configure_logging|configure_logging]]
- [[_COMMUNITY_compute_l1_coefficients|compute_l1_coefficients]]
...
- [[_COMMUNITY__compute_y_band|_compute_y_band]]
- [[_COMMUNITY_test_dmta_removal.py|test_dmta_removal.py]]
- [[_COMMUNITY_OptimizationResult|OptimizationResult]]
- [[_COMMUNITY_check_kramers_kronig|check_kramers_kronig]]
- [[_COMMUNITY_test_isotropic.py|test_isotropic.py]]
...
- [[_COMMUNITY_TestPreprocessLaos|TestPreprocessLaos]]
- [[_COMMUNITY_ndarray|ndarray]]
...
- [[_COMMUNITY_estimate_eta0|estimate_eta0]]
...
- [[_COMMUNITY_get_jax_info|get_jax_info]]
- [[_COMMUNITY_TestISMProtocols|TestISMProtocols]]
- [[_COMMUNITY_TNTCates|TNTCates]]
- [[_COMMUNITY_ndarray|ndarray]]
- [[_COMMUNITY_base.py|base.py]]
- [[_COMMUNITY_get_gpu_info|get_gpu_info]]
...
- [[_COMMUNITY_RheoDataTableModel|RheoDataTableModel]]
- [[_COMMUNITY_Module Breakdown|Module Breakdown]]
- [[_COMMUNITY_TestFluidityEvolution|TestFluidityEvolution]]
- [[_COMMUNITY_TestHLValidation|TestHLValidation]]
- [[_COMMUNITY_TestPlotHarmonicSpectrum|TestPlotHarmonicSpectrum]]
...
- [[_COMMUNITY_test_unsaved_changes_guard.py|test_unsaved_changes_guard.py]]
...
- [[_COMMUNITY_TestFMLIKHParameters|TestFMLIKHParameters]]
...
- [[_COMMUNITY_TestPreprocessRelaxation|TestPreprocessRelaxation]]
...
- [[_COMMUNITY_TestStressFormParameter|TestStressFormParameter]]
...
- [[_COMMUNITY_test_dataset_preview.py|test_dataset_preview.py]]
- [[_COMMUNITY_Config|Config]]
- [[_COMMUNITY_TestHLModelFunction|TestHLModelFunction]]
...
- [[_COMMUNITY_check_gpu_availability|check_gpu_availability]]
- [[_COMMUNITY_TestVLBVariantRegression|TestVLBVariantRegression]]
- [[_COMMUNITY_test_device.py|test_device.py]]
- [[_COMMUNITY_import_worker.py|import_worker.py]]
...
- [[_COMMUNITY_get_recommended_package|get_recommended_package]]
...
- [[_COMMUNITY_SeedManager|SeedManager]]
...
- [[_COMMUNITY_get_system_cuda_version|get_system_cuda_version]]
...
- [[_COMMUNITY_When Analytical SAOS Breaks Down for Transient Network Models and Vitrimers|When Analytical SAOS Breaks Down for Transient Network Models and Vitrimers]]
- [[_COMMUNITY_export_worker.py|export_worker.py]]
...
- [[_COMMUNITY_TestPlotColeCole|TestPlotColeCole]]
...
- [[_COMMUNITY_TestFitPredictRoundtrip|TestFitPredictRoundtrip]]
...
- [[_COMMUNITY_TestGMMOscillationMode|TestGMMOscillationMode]]
...
- [[_COMMUNITY_TestISMCreepVolterra|TestISMCreepVolterra]]
- [[_COMMUNITY_TestCreepSimulation|TestCreepSimulation]]
- [[_COMMUNITY_TestPreprocessOscillation|TestPreprocessOscillation]]
...
- [[_COMMUNITY_plot_3d_trajectory|plot_3d_trajectory]]
...
- [[_COMMUNITY_giesekus_steady_normal_stresses|giesekus_steady_normal_stresses]]
...
- [[_COMMUNITY_TestITTMCTSchematicInitialization|TestITTMCTSchematicInitialization]]
...
- [[_COMMUNITY_TestModelInfo|TestModelInfo]]
- [[_COMMUNITY_._confirm_unsaved_changes|._confirm_unsaved_changes]]
- [[_COMMUNITY_TestFlowCurveFitting|TestFlowCurveFitting]]
- [[_COMMUNITY_TestModelInstantiation|TestModelInstantiation]]
- [[_COMMUNITY_TestFluidityLocalTransient|TestFluidityLocalTransient]]
...
- [[_COMMUNITY_TestSPPPlotEdgeCases|TestSPPPlotEdgeCases]]
...
- [[_COMMUNITY_TestTemplateStyles|TestTemplateStyles]]
...
- [[_COMMUNITY_TestHelperMethods|TestHelperMethods]]
- [[_COMMUNITY_TRIOSResult|TRIOSResult]]
- [[_COMMUNITY_TestFluidityLocalSmoke|TestFluidityLocalSmoke]]
...
- [[_COMMUNITY_giesekus_steady_shear_viscosity|giesekus_steady_shear_viscosity]]
...
- [[_COMMUNITY_TestISMInitialization|TestISMInitialization]]
...
- [[_COMMUNITY_TestFluidityNonlocalOscillation|TestFluidityNonlocalOscillation]]
...
- [[_COMMUNITY_._predict_viscosity|._predict_viscosity]]
- [[_COMMUNITY_TestMLIKHSAOSFrequencyFit|TestMLIKHSAOSFrequencyFit]]
...
- [[_COMMUNITY_herschel_bulkley_viscosity|herschel_bulkley_viscosity]]
- [[_COMMUNITY_TestLAOSSimulation|TestLAOSSimulation]]
- [[_COMMUNITY_.__init__|.__init__]]
...
- [[_COMMUNITY_TestArviZIntegration|TestArviZIntegration]]
- [[_COMMUNITY_TestPreprocessForProtocol|TestPreprocessForProtocol]]
...
- [[_COMMUNITY_TestThermalYieldStress|TestThermalYieldStress]]
...
- [[_COMMUNITY_TestFluidityNonlocalFlowCurve|TestFluidityNonlocalFlowCurve]]
- [[_COMMUNITY_test_bayesian.py|test_bayesian.py]]
- [[_COMMUNITY_stress_tensor_product_2d|stress_tensor_product_2d]]
...
- [[_COMMUNITY_TestVLBLocalExtension|TestVLBLocalExtension]]
...
- [[_COMMUNITY_.predict_rheo|.predict_rheo]]
- [[_COMMUNITY_ndarray|ndarray]]
- [[_COMMUNITY_test_fit_result.py|test_fit_result.py]]
- [[_COMMUNITY_print_device_summary|print_device_summary]]
...
- [[_COMMUNITY_TestBinghamRheoData|TestBinghamRheoData]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_TestModeEnum|TestModeEnum]]
- [[_COMMUNITY_TestMLIKHWeightedSumTransients|TestMLIKHWeightedSumTransients]]
- [[_COMMUNITY_TestPreprocessStartup|TestPreprocessStartup]]
...
- [[_COMMUNITY_TestHDF5Support|TestHDF5Support]]
- [[_COMMUNITY_TestCSVRoundTrip|TestCSVRoundTrip]]
- [[_COMMUNITY_TestExcelWriting|TestExcelWriting]]
- [[_COMMUNITY__read_segment_chunked|_read_segment_chunked]]
- [[_COMMUNITY_conftest.py|conftest.py]]
- [[_COMMUNITY_CarreauYasuda|CarreauYasuda]]
- [[_COMMUNITY_._predict_creep_jit|._predict_creep_jit]]
- [[_COMMUNITY_.free_energy|.free_energy]]
- [[_COMMUNITY_TestLogBayesian|TestLogBayesian]]
- [[_COMMUNITY_TestFitCreep|TestFitCreep]]
- [[_COMMUNITY_TestFitRelaxation|TestFitRelaxation]]
- [[_COMMUNITY_TestSteadyStateTemperature|TestSteadyStateTemperature]]
- [[_COMMUNITY_TestAdiabaticTemperatureRise|TestAdiabaticTemperatureRise]]
...
- [[_COMMUNITY_test_kernels.py|test_kernels.py]]
- [[_COMMUNITY_upper_convected_derivative_2d|upper_convected_derivative_2d]]
...
- [[_COMMUNITY_TestStartupFitting|TestStartupFitting]]
- [[_COMMUNITY_TestCreepFitting|TestCreepFitting]]
- [[_COMMUNITY_TestISMFluidVsGlass|TestISMFluidVsGlass]]
- [[_COMMUNITY_TestOscillationProtocol|TestOscillationProtocol]]
- [[_COMMUNITY_TestStartupProtocol|TestStartupProtocol]]
- [[_COMMUNITY_TestRepr|TestRepr]]
- [[_COMMUNITY_TestLAOSKwargsRegression|TestLAOSKwargsRegression]]
- [[_COMMUNITY_TestRegistryIntegration|TestRegistryIntegration]]
- [[_COMMUNITY_TestLAOSKwargsRegression|TestLAOSKwargsRegression]]
- [[_COMMUNITY_TestLAOSProtocol|TestLAOSProtocol]]
- [[_COMMUNITY_TestVLBNonlocalFene|TestVLBNonlocalFene]]
- [[_COMMUNITY_TestFluidityNonlocalFitting|TestFluidityNonlocalFitting]]
- [[_COMMUNITY_TestParameterSetRoundtrip|TestParameterSetRoundtrip]]
- [[_COMMUNITY_TestRelaxationProtocol|TestRelaxationProtocol]]
- [[_COMMUNITY_TestEarlyTermination|TestEarlyTermination]]
- [[_COMMUNITY_TestMultiModeRepresentation|TestMultiModeRepresentation]]
...
- [[_COMMUNITY_.set_dataset|.set_dataset]]
...
- [[_COMMUNITY_TestModuliEvolutionSingleAxes|TestModuliEvolutionSingleAxes]]
- [[_COMMUNITY_clean_notebook|clean_notebook]]
- [[_COMMUNITY_TestStressStrainTemplate|TestStressStrainTemplate]]
...
- [[_COMMUNITY_._validate_parameter_bounds|._validate_parameter_bounds]]
- [[_COMMUNITY_._epm_step|._epm_step]]
...
- [[_COMMUNITY_TestCarreauYasudaRheoData|TestCarreauYasudaRheoData]]
- [[_COMMUNITY_._make_error_result|._make_error_result]]
- [[_COMMUNITY_TestCarreauYasudaPredictions|TestCarreauYasudaPredictions]]
- [[_COMMUNITY_.get_diagnostics|.get_diagnostics]]
- [[_COMMUNITY__synthetic_laos|_synthetic_laos]]
- [[_COMMUNITY_._build_warm_start_values|._build_warm_start_values]]
...
- [[_COMMUNITY_._fit|._fit]]
- [[_COMMUNITY_.get_metadata|.get_metadata]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_TestBinghamModelFunction|TestBinghamModelFunction]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY_TestCarreauYasudaStability|TestCarreauYasudaStability]]
- [[_COMMUNITY_TestCarreauYasudaFitting|TestCarreauYasudaFitting]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
...
- [[_COMMUNITY_TestCarreauYasudaModelFunction|TestCarreauYasudaModelFunction]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
- [[_COMMUNITY___init__.py|__init__.py]]
...
- [[_COMMUNITY_TestVLBFenePhysics|TestVLBFenePhysics]]
...
- [[_COMMUNITY_Dimitriou & McKinley (2014)|Dimitriou & McKinley (2014)]]
- [[_COMMUNITY_Architecture Overview (Developer)|Architecture Overview (Developer)]]
- [[_COMMUNITY_Armstrong & Frederick (1966)|Armstrong & Frederick (1966)]]
- [[_COMMUNITY_Dimitriou & McKinley (2014)|Dimitriou & McKinley (2014)]]
- [[_COMMUNITY_IKH Model|IKH Model]]
- [[_COMMUNITY_Wei, Solomon & Larson (2018)|Wei, Solomon & Larson (2018)]]
- [[_COMMUNITY_Fuchs & Cates (2002)|Fuchs & Cates (2002)]]
- [[_COMMUNITY_TestArviZAvailability|TestArviZAvailability]]
...
- [[_COMMUNITY_TestSimulationProtocols|TestSimulationProtocols]]
- [[_COMMUNITY_.to_dataframe|.to_dataframe]]
- [[_COMMUNITY_.get_posterior_summary|.get_posterior_summary]]
- [[_COMMUNITY_TestLegacyNamesRejected|TestLegacyNamesRejected]]
- [[_COMMUNITY_.get_credible_intervals|.get_credible_intervals]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.__init__|.__init__]]
...
- [[_COMMUNITY_.test_export_directory_basic|.test_export_directory_basic]]
...
- [[_COMMUNITY_.test_export_directory_with_transforms|.test_export_directory_with_transforms]]
...
- [[_COMMUNITY_test_harmonic_reconstruction_full_preserves_phase|test_harmonic_reconstruction_full_preserves_phase]]
...
- [[_COMMUNITY_TestGMMBayesianPriorSafetyIntegration|TestGMMBayesianPriorSafetyIntegration]]
- [[_COMMUNITY_TestBayesianPipelineMultiChain|TestBayesianPipelineMultiChain]]
- [[_COMMUNITY_TestParameterEstimation|TestParameterEstimation]]
- [[_COMMUNITY_TestBayesianCredibleIntervals|TestBayesianCredibleIntervals]]
- [[_COMMUNITY_TestFractionalModelsRelaxation|TestFractionalModelsRelaxation]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.bounds|.bounds]]
- [[_COMMUNITY_.arrhenius_plot_data_dual|.arrhenius_plot_data_dual]]
- [[_COMMUNITY_.get_posterior_summary|.get_posterior_summary]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.__init__|.__init__]]
- [[_COMMUNITY_.check_saos_validity|.check_saos_validity]]
- [[_COMMUNITY_.compute_strain_amplification|.compute_strain_amplification]]
- [[_COMMUNITY_.delta_m|.delta_m]]
- [[_COMMUNITY_.E_a_diff|.E_a_diff]]
- [[_COMMUNITY_.G_I_eff|.G_I_eff]]
- [[_COMMUNITY_.include_interfacial_damage|.include_interfacial_damage]]
- [[_COMMUNITY_.k_diff_0_mat|.k_diff_0_mat]]
- [[_COMMUNITY_.lambda_crit_int|.lambda_crit_int]]
- [[_COMMUNITY_.phi_I|.phi_I]]
- [[_COMMUNITY_.__repr__|.__repr__]]
- [[_COMMUNITY_.X_phi|.X_phi]]
- [[_COMMUNITY_.tau_rep|.tau_rep]]
- [[_COMMUNITY_.tau_break|.tau_break]]
- [[_COMMUNITY_.tau_d|.tau_d]]
- [[_COMMUNITY_.eta_0|.eta_0]]
- [[_COMMUNITY_.tau_b|.tau_b]]
- [[_COMMUNITY_.tau_a|.tau_a]]
- [[_COMMUNITY_.nu|.nu]]
- [[_COMMUNITY_.f_B_eq|.f_B_eq]]
- [[_COMMUNITY_.G_eff|.G_eff]]
- [[_COMMUNITY_.eta_0|.eta_0]]
- [[_COMMUNITY_.eta_s|.eta_s]]
- [[_COMMUNITY_.tau_b|.tau_b]]
- [[_COMMUNITY_.eta_0|.eta_0]]
- [[_COMMUNITY_.xi|.xi]]
- [[_COMMUNITY_test_fit_bayesian_basic_functionality|test_fit_bayesian_basic_functionality]]
- [[_COMMUNITY_test_float64_precision_in_nuts_sampling|test_float64_precision_in_nuts_sampling]]
- [[_COMMUNITY_test_warm_start_from_nlsq_initial_values|test_warm_start_from_nlsq_initial_values]]
- [[_COMMUNITY_test_warm_start_multichain_initial_values|test_warm_start_multichain_initial_values]]
- [[_COMMUNITY_test_convergence_diagnostics_rhat_computation|test_convergence_diagnostics_rhat_computation]]
- [[_COMMUNITY_test_convergence_diagnostics_ess_computation|test_convergence_diagnostics_ess_computation]]
- [[_COMMUNITY_test_divergence_detection|test_divergence_detection]]
- [[_COMMUNITY_test_bayesian_mixin_initialization|test_bayesian_mixin_initialization]]
- [[_COMMUNITY_test_multi_chain_sampling|test_multi_chain_sampling]]
- [[_COMMUNITY_test_error_handling_mismatched_data_dimensions|test_error_handling_mismatched_data_dimensions]]
- [[_COMMUNITY_test_sample_prior_returns_correct_structure|test_sample_prior_returns_correct_structure]]
- [[_COMMUNITY_test_error_handling_invalid_initial_values|test_error_handling_invalid_initial_values]]
- [[_COMMUNITY_test_prior_sampling_respects_bounds|test_prior_sampling_respects_bounds]]
- [[_COMMUNITY_test_credible_intervals_coverage|test_credible_intervals_coverage]]
- [[_COMMUNITY_test_get_credible_intervals_computes_hdi|test_get_credible_intervals_computes_hdi]]
- [[_COMMUNITY_test_seed_parameter_different_seeds|test_seed_parameter_different_seeds]]
...
- [[_COMMUNITY_.test_export_directory_no_fit|.test_export_directory_no_fit]]
- [[_COMMUNITY_.test_laos_fit_requires_gamma0_and_omega|.test_laos_fit_requires_gamma0_and_omega]]
- [[_COMMUNITY_.test_parameter_validation_x_range|.test_parameter_validation_x_range]]
...
1. `RheoData` - 1363 edges
2. `ModelRegistry` - 597 edges
3. `ParameterSet` - 456 edges
4. `safe_import_jax()` - 313 edges
5. `BaseModel` - 307 edges
6. `get_logger()` - 248 edges
7. `StateStore` - 221 edges
8. `RheoJAXMainWindow` - 201 edges
9. `nlsq_optimize()` - 184 edges
10. `Pipeline` - 181 edges
...
## Communities (2199 total, 257 thin omitted)

### Community 0 - "safe_import_jax"
Cohesion: 0.01
Nodes (497): CLI subcommand for NLSQ model fitting.  Usage:     rheojax fit data.csv --mod, Bayesian inference infrastructure using NumPyro NUTS sampling.  This module prov, # NOTE: Precompilation cache is stored per-instance (set in precompile_bayesian), FitOrchestrator: encapsulates the full fit() workflow.  Extracted from BaseModel, _enable_compilation_cache(), Any, JAX configuration and safe import mechanism for float64 precision.  This module, Safely import JAX with float64 precision enforcement.      This function ensures (+489 more)

### Community 1 - "RheoData"
Cohesion: 0.01
Nodes (207): JAX-native container for rheological data with NumPy/JAX array support.      Thi, Get storage modulus label. Always returns "G'" (shear)., Get loss modulus label. Always returns 'G"' (shear)., RheoData, Benchmark 3: GPU Acceleration (if available)      Test CPU vs GPU performance., Verify fitting performance on the active JAX backend (CPU or GPU)., Benchmark 4: Memory Usage Profiling      Track memory usage for typical workflow, Profile memory usage for typical fitting workflow. (+199 more)

### Community 2 - "OWChirp"
Cohesion: 0.00
Nodes (667): BaseModel, BaseTransform, Base classes for models and transforms with JAX support.  This module provides a, Abstract base class for all data transforms.      This class defines the standar, Initialize base transform., Compose transforms using + operator.          Args:             other: Another t, Transform multiple datasets sequentially.          Applies the transform to each, String representation of transform. (+659 more)

### Community 3 - "Pipeline"
Cohesion: 0.02
Nodes (126): Create a model instance by name (factory method).          Args:             nam, Reject removed DMTA options without modifying ``options``.      Args:         op, reject_removed_options(), RheoJAX: Unified Rheological Analysis Framework.  A comprehensive rheological an, _ensure_all_registered(), __getattr__(), Rheological models package.  This package contains 53 rheological models organiz, Eagerly import all model submodules to trigger @ModelRegistry.register decorator (+118 more)

### Community 4 - "DataService"
Cohesion: 0.01
Nodes (248): Enum, Application Core Components ===========================  Main window, menu bar,, Main Application Window =======================  Central window coordinating pag, # TODO: Implement project serialization (state → JSON/HDF5)., # NOTE: This guard assumes single-threaded (GUI main thread) access., Menu Bar ========  Application menu bar with File, Edit, View, Data, Models, Tra, Status Bar ==========  Application status bar with progress indicators, JAX devi, # NOTE: deliberately NOT calling super().showMessage(message, timeout) -- (+240 more)

### Community 5 - "actions.py"
Cohesion: 0.01
Nodes (277): add_pipeline_step(), add_transform_record(), bayesian_completed(), bayesian_failed(), cache_step_result(), clear_pipeline(), fitting_completed(), fitting_failed() (+269 more)

### Community 6 - "ModelRegistry"
Cohesion: 0.11
Nodes (12): _FailingBayesianModel, Guard: _test_mode must persist after successful fit_bayesian., After successful fit_bayesian, _test_mode must NOT be deleted., After failed fit_bayesian, state must be reverted., Guard: params with equal bounds → numpyro.deterministic, not crash., Param with bounds (5.0, 5.0) must be treated as deterministic., Param with bounds (0, 1e-6) must NOT be treated as fixed.          The equal-b, Minimal model for Bayesian regression tests. (+4 more)

### Community 7 - "get_logger"
Cohesion: 0.04
Nodes (39): FigureCanvasQTAgg, Open MultiView dialog overlaying fit curves for the active dataset., MultiView, PlotPanel, Any, Figure, Multi-View Widget ================  Multiple synchronized plot panels for compar, Set panel title.          Parameters         ----------         title : str (+31 more)

### Community 8 - "QWidget"
Cohesion: 0.04
Nodes (48): QLayout, QPushButton, QSplitter, QStackedWidget, QVBoxLayout, QWidget, Set up user interface., Set up user interface. (+40 more)

### Community 9 - "SGRConventional"
Cohesion: 0.02
Nodes (52): Initialize SGR Conventional Model.          Creates ParameterSet with:         -, Determine material phase regime from noise temperature x.          The SGR model, Compute steady-state effective temperature x_ss(gamma_dot).          The steady-, Enable thixotropy modeling with structural parameter lambda(t).          Adds th, Soft Glassy Rheology (SGR) Conventional Model.      Statistical mechanics model, SGRConventional, All predictions are finite for valid parameter combinations., Test SGR model can compute credible intervals from mock posterior samples. (+44 more)

### Community 10 - "ParameterSet"
Cohesion: 0.01
Nodes (434): ABC, Standard NLSQ fitting pipeline for models with a stateless model_fn.          Ha, Initialize base model., _import_numpyro(), Lazy-import NumPyro and its submodules.      Returns all NumPyro symbols needed, lazy_import(), Return a lazy proxy for *module_name*.      The real ``import`` is deferred unti, Parameter (+426 more)

### Community 11 - "ValueError"
Cohesion: 0.02
Nodes (140): Raised when no reader can parse a file.      Subclasses ValueError so downstream, RheoJaxFormatError, auto_load(), _detect_modulus_pair(), _filter_kwargs(), _has_trios_metadata(), _inject_provenance(), _looks_numeric() (+132 more)

### Community 12 - "TNTStickyRouse"
Cohesion: 0.04
Nodes (24): Sticky Rouse model for associative polymers.      Multi-mode Maxwell model where, Number of Rouse modes., Sticker lifetime (s)., TNTStickyRouse, Test effective times are τ_R_k + τ_s (Leibler-Rubinstein-Colby 1991)., When tau_s ≪ all tau_R_k, model reduces to multi-mode Maxwell., Test flow curve approaches Newtonian behavior at low shear rates.          At, Test SAOS prediction returns correct shapes. (+16 more)

### Community 13 - "Maxwell"
Cohesion: 0.01
Nodes (152): Maxwell, Estimate G0 and eta from relaxation data for faster convergence., Maxwell viscoelastic model (spring and dashpot in series).      The Maxwell mode, Get characteristic relaxation time tau = eta/G0.          Returns:             R, String representation of Maxwell model., Initialize Maxwell model with default parameters., Edge case tests using Maxwell as a concrete model., Predict before fit should use default parameters. (+144 more)

### Community 14 - "load_anton_paar"
Cohesion: 0.10
...
### Community 15 - "FIKH"
Cohesion: 0.09
Nodes (23): FIKH, Any, ArrayLike, ndarray, Initialize FIKH model.          Args:             include_thermal: Enable thermo, Fit model parameters using protocol-aware optimization.          Args:, Fit to steady-state flow curve data., Fit using ODE formulation (creep/relaxation). (+15 more)

### Community 16 - "BatchPanel"
Cohesion: 0.01
Nodes (159): QDragEnterEvent, QDropEvent, QTableWidgetItem, ImportWorker, ImportWorkerSignals, Any, Path, QObject (+151 more)

### Community 17 - "WorkspaceWindow"
Cohesion: 0.03
Nodes (96): ColumnMapperDialog, QWidget, Column Mapper Dialog ===================  Simple dialog for column reassignment., Handle dialog accept., Handle dialog reject., Handle dialog show event., Populate combo boxes with column names., Apply current mapping to combo boxes. (+88 more)
...
### Community 20 - "STZConventional"
Cohesion: 0.05
Nodes (43): build_fit_controller(), AppState, _diagnostics_verdict(), NutsStep, Seed the editable PriorsEditor from the NLSQ MAP estimate.          Converts map, Clear a stale skip decision when an upstream NLSQ re-run invalidates         nut, Summarize NUTS convergence diagnostics into a pass/fail verdict.      Per the de, # NOTE: The real implementation must: (+35 more)

### Community 21 - "state.py"
Cohesion: 0.04
Nodes (74): TransformState, SlotSpec, transform_slots(), TransformPickStep, Rebuild slot specs + selector widgets from the current transform_key.          A, Auto-generated parameter form for the current transform.          state.config p, SlotsStep, # NOTE: TransformService has no .run() method. The real implementation must: (+66 more)

### Community 22 - "FluiditySaramitoLocal"
Cohesion: 0.03
Nodes (52): FluiditySaramitoLocal, Any, ndarray, Simulate LAOS response using Diffrax.          Parameters         ----------, Simulate LAOS response.          Parameters         ----------         gamma_0 :, Extract Fourier harmonics from LAOS stress response.          Parameters, NumPyro/BayesianMixin model function.          Routes to appropriate prediction, Predict based on fitted state.          Parameters         ----------         X (+44 more)

### Community 23 - "ExportPage"
Cohesion: 0.06
Nodes (30): Reset the singleton instance (useful for testing)., setup_function(), setup_function(), setup_function(), Any, QApplication, Reset StateStore singleton before each test., Get or create QApplication instance. (+22 more)

### Community 24 - "FitState"
Cohesion: 0.03
Nodes (94): FittingOptionsDialog, Any, QWidget, Fitting Options Dialog =====================  Configure NLSQ optimization parame, Load current options into UI., Fitting configuration dialog.      Options:         - Optimization algorithm, Handle algorithm combo box change., Handle option change. (+86 more)

### Community 25 - "DatasetLibrary"
Cohesion: 0.05
Nodes (76): DatasetLibrary, DatasetRef, Any, pipeline_context_from_library(), pipeline_inputs_from_library(), Any, §11 boundary: feed the legacy pipeline from the new Dataset Library.      Resolv, Seed a PipelineExecutionService.execute_single_step context from a     Workspace (+68 more)

### Community 26 - "Zener"
Cohesion: 0.03
Nodes (52): Classical rheological models.  Contains fundamental spring-dashpot models: - Max, ndarray, Fit Zener model to data.          Args:             X: RheoData object or indepe, Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Predict relaxation modulus G(t).          Theory: G(t) = G_e + G_m * exp(-t/tau), Predict creep compliance J(t).          Theory: J(t) = 1/(G_e+G_m) + (G_m/(G_e*(, Predict complex modulus G*(omega).          Theory:             G'(omega) = G_e (+44 more)
...
### Community 28 - "CoxMerz"
Cohesion: 0.03
Nodes (75): QObject, Signals, _PreviewWorker, Transform Page =============  Data-driven transform application interface with s, Signals for cross-thread preview result delivery., QRunnable that computes a transform preview off the main thread., _WorkerSignals, Transform Service ================  Service for applying rheological transforms (+67 more)

### Community 29 - "StateStore"
Cohesion: 0.02
Nodes (92): Execute all pipeline steps in sequence on a background thread.          Pipeline, _is_qobject_alive(), Check whether a QObject's C++ counterpart is still alive.      Works across PySi, Bayesian Options Dialog ======================  Configure NUTS sampling paramete, Execute MCMC in background thread.          This method runs in a separate threa, BayesianPage, Any, BayesianResult (+84 more)

### Community 30 - "ModelService"
Cohesion: 0.05
Nodes (39): inference_data_from_dict(), Utilities for safely importing optional ArviZ dependency., Build inference data across the ArviZ 0.x and 1.x dictionary APIs.      ``groups, Any, BayesianResult, RheoData, Bayesian Service ===============  Service for Bayesian inference with NumPyro an, Run NUTS sampling for Bayesian inference.          Parameters         ---------- (+31 more)

### Community 31 - "SpringPot"
Cohesion: 0.03
Nodes (49): ndarray, Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Predict relaxation modulus G(t).          Theory: G(t) = c_alpha * t^(-alpha) /, Predict creep compliance J(t).          Theory: J(t) = (1/c_alpha) * t^alpha / G, Predict complex modulus G*(omega).          Theory: G*(omega) = c_alpha * (i*ome, String representation of SpringPot model., SpringPot fractional viscoelastic element.      The SpringPot represents a power (+41 more)

### Community 32 - "load_csv"
Cohesion: 0.02
Nodes (103): Execute the file read in the worker thread., detect_csv_delimiter(), _detect_delimiter(), _get_column_data(), _get_column_header(), load_csv(), DataFrame, ndarray (+95 more)

### Community 33 - "FMLIKH"
Cohesion: 0.09
Nodes (24): FMLIKH, Any, ArrayLike, ndarray, TestMode, Initialize FMLIKH model.          Args:             n_modes: Number of viscoelas, Setup per-mode parameters, replacing single-mode defaults., Number of viscoelastic modes. (+16 more)

### Community 34 - "window.py"
Cohesion: 0.04
Nodes (60): DatasetLibraryNotifier, Qt signal carrier for DatasetLibrary mutations.  DatasetLibrary itself stays a p, Layout helper functions for consistent margins and spacing.  Provides reusable h, Remove all margins from a layout.      Use for container layouts where the paren, set_zero_margins(), FitController, Step, TransformController (+52 more)
...
### Community 38 - "_kernels.py"
Cohesion: 0.20
Nodes (6): Tests for shear banding metrics., Test CV of uniform field is zero., Test CV increases with field heterogeneity., Test banding ratio of uniform field is 1., Test banding ratio increases with fluidity contrast., TestFluidityKernelsBandingMetrics

### Community 39 - "test_initialization.py"
Cohesion: 0.03
Nodes (87): initialize_fractional_burgers(), initialize_fractional_jeffreys(), initialize_fractional_kelvin_voigt(), initialize_fractional_kv_zener(), initialize_fractional_maxwell_gel(), initialize_fractional_maxwell_liquid(), initialize_fractional_maxwell_model(), initialize_fractional_poynting_thomson() (+79 more)

### Community 40 - "DataStep"
Cohesion: 0.07
...
### Community 41 - "test_io_fixes.py"
Cohesion: 0.03
Nodes (72): Index, Raised for unsupported measurement geometry. RheoJAX is shear-only;     tensile/, UnsupportedDataError, check_file_for_unsupported_data(), check_tensile_guard(), Path, Scan headers and units for tensile/E* and other unsupported deformation modes (b, Read the start of the file or sheet headers and raise UnsupportedDataError if te (+64 more)

### Community 42 - "HVNMLocal"
Cohesion: 0.08
Nodes (13): HVNM (Hybrid Vitrimer Nanocomposite Model) package.  Constitutive models for n, HVNMLocal, Create partial vitrimer nanocomposite (G_D=0).          Parameters         -----, Create conventional filled rubber (no E-network, frozen interphase).          Pa, Predict response using fitted parameters., Local (0D) Hybrid Vitrimer Nanocomposite Model.      A constitutive model for NP, default_model(), filled_model() (+5 more)

### Community 43 - "FitPage"
Cohesion: 0.03
Nodes (55): FitPage, Any, Figure, ndarray, Update the Fit page status from a stored FitResult., Replace the plot canvas figure.          Delegates to PlotCanvas.replace_figure(, Forward residuals to the residuals panel., Connect internal signals. (+47 more)

### Community 44 - "._fit"
Cohesion: 0.04
Nodes (33): Editing a completed step bumps revision and re-locks everything downstream., Fit SpringPot model to data.          Args:             X: RheoData object or in, Get characteristic time scale for the material.          For SpringPot, there's, Get characteristic retardation time for creep.          Theory: tau_c = eta * (G, Compute cooperativity length scale.          ξ = √(D_λ · t_eq)          Returns, Initialize EPM base with common parameters.          The `fluidity_form` argumen, Extract parameters as dictionary for kernel calls.          Returns:, RheoData (+25 more)

### Community 45 - "check_model_compatibility"
Cohesion: 0.10
Nodes (27): check_model_compatibility(), DecayType, detect_decay_type(), _detect_from_oscillation(), _detect_from_relaxation(), detect_material_type(), MaterialType, Any (+19 more)

### Community 46 - "FitResult"
Cohesion: 0.03
Nodes (62): FitWorker, FitWorkerSignals, Any, QObject, QRunnable, Fit Worker =========  Background worker for NLSQ model fitting operations., Worker for running NLSQ fitting in background.      Features:         - NLSQ opt, Initialize fit worker.          Parameters         ----------         model_name (+54 more)

### Community 47 - "ITTMCTSchematic"
Cohesion: 0.04
Nodes (31): ITTMCTSchematic, Get the strain decorrelation function form., Get the memory kernel form.          Returns         -------         str, Get the stress computation form.          Returns         -------         str, Initialize F₁₂ model parameters., ITT-MCT Schematic F₁₂ Model.      The F₁₂ model uses a quadratic memory kernel m, Every _fit_* protocol path must hand method='scipy' to fit_with_nlsq., Even when caller asks for method='nlsq', ITT-MCT must override to 'scipy'. (+23 more)

### Community 48 - "TensorialEPM"
Cohesion: 0.01
Nodes (256): EPMBase, _jit_flow_curve_batch(), Base class for Elasto-Plastic Models (EPM).  This module provides the abstract b, Pre-compile JIT kernels for faster Bayesian inference.          Triggers JAX JIT, JIT-compiled flow curve for batch of shear rates.      Args:         shear_rates, Abstract base class for Elasto-Plastic Models.      This class provides common i, Elasto-Plastic Models (EPM) for amorphous solids., LatticeEPM (+248 more)

### Community 49 - "ProcessWorkerAdapter"
Cohesion: 0.04
Nodes (54): Process, bayesian_result_from_dict(), fit_result_from_dict(), ProcessWorkerAdapter, Event, Queue, Run a work function inside a ``multiprocessing.Process``.      The adapter start, Execute the work function in a child process.          Called by QThreadPool.  B (+46 more)

### Community 50 - "test_epm_kernels_tensorial.py"
Cohesion: 0.05
Nodes (73): apply_tensorial_propagator(), compute_hill_stress(), compute_plastic_strain_rate(), compute_von_mises_stress(), get_yield_criterion(), make_tensorial_propagator_q(), Array, Tensorial kernels for Elasto-Plastic Models (EPM).  This module implements the f (+65 more)

### Community 51 - "_kernels.py"
Cohesion: 0.04
Nodes (33): OptimizationResult, Get standard errors for parameters from covariance diagonal.          Returns, Result from optimization with NLSQ 0.6.6 CurveFitResult-compatible properties., Coefficient of determination (R²).          Measures goodness of fit. Range: (-∞, Adjusted R² accounting for number of parameters.          Adj R² = 1 - (1 - R²), Root mean squared error.          RMSE = sqrt(mean(residuals²))          Returns, Mean absolute error.          MAE = mean(abs(residuals))          More robust to, Test that BaseModel stores NLSQ and Bayesian results for later access. (+25 more)

### Community 52 - "EPMBase"
Cohesion: 0.04
Nodes (41): _jit_creep_kernel(), _jit_flow_curve_single(), _jit_oscillation_kernel(), _jit_relaxation_kernel(), _jit_startup_kernel(), Array, RheoData, Stress relaxation: G(t) after step strain.          Args:             data: Rheo (+33 more)

### Community 53 - "DMTLocal"
Cohesion: 0.02
Nodes (143): DMTBase, Base class for de Souza Mendes-Thompson (DMT) models.  Provides shared infrastru, Initialize ParameterSet with model parameters.          Parameters are added con, Get initial structure parameter value (fully structured).          Returns, Get all parameters as a dictionary.          Returns         -------         dic, Build base args dictionary for ODE integration.          Parameters         ----, Get human-readable description of the closure.          Returns         -------, Base class for DMT (de Souza Mendes-Thompson) thixotropic models.      Implement (+135 more)

### Community 54 - "main"
Cohesion: 0.01
Nodes (138): Update JAX status display., Config, Any, Path, Configuration Management =======================  Application configuration and, Reset to default configuration., Application configuration manager.      Features:         - Persistent settings, Initialize configuration manager.          Parameters         ---------- (+130 more)

### Community 55 - "_make_mock_spp_results"
Cohesion: 0.05
...
### Community 56 - "test_project_codec.py"
Cohesion: 0.07
Nodes (67): File, invalidate_downstream(), _escape_hdf5_key(), _is_allowed_member(), load_project_v2(), Any, Path, Versioned .rheojax v2 project persistence.  write_result_arrays()/read_result_ar (+59 more)

### Community 57 - "epm_plots.py"
Cohesion: 0.05
Nodes (54): FuncAnimation, Apply a batch of name→value updates with optional failure tolerance.          Re, animate_stress_evolution(), animate_tensorial_evolution(), _get_figure(), plot_lattice_fields(), plot_normal_stress_field(), plot_normal_stress_ratio() (+46 more)

### Community 58 - "FractionalMaxwellModel"
Cohesion: 0.03
...
### Community 59 - "HVNMBase"
Cohesion: 0.03
Nodes (29): HVNMBase, ndarray, Whether diffusion mode is active., Interphase reinforcement ratio G_I/G_E., Interfacial TST attempt frequency (1/s)., Interfacial activation energy (J/mol)., Interfacial activation volume (m^3/mol)., Mobile interphase thickness (m). (+21 more)

### Community 60 - "VLBLocal"
Cohesion: 0.01
Nodes (96): ndarray, Single transient network VLB model (2 params: G0, k_d).      Implements the VLB, Initialize single-network VLB model., Initialize ParameterSet with VLB local parameters.          Parameters:, Get network modulus G0 (Pa)., Get dissociation rate k_d (1/s)., Get relaxation time t_R = 1/k_d (s)., Get zero-shear viscosity eta_0 = G0/k_d (Pa*s). (+88 more)

### Community 61 - "FluidityNonlocal"
Cohesion: 0.07
Nodes (22): Any, ndarray, NumPyro/BayesianMixin model function.          Accepts protocol-specific kwargs, Predict based on fitted state., Fit Non-Local Fluidity model to data.          Args:             X: Independent, Get initial fluidity field (uniform across gap).          Args:             f_in, Get initial state vector for PDE solver.          State vector: [Σ (or γ for cre, Fit steady-state flow curve.          For homogeneous (non-banding) steady state (+14 more)

### Community 62 - "_execute_notebook"
Cohesion: 0.04
...
### Community 66 - "_kernels_diffrax.py"
Cohesion: 0.01
Nodes (223): Base class for HVM (Hybrid Vitrimer Model).  Provides shared infrastructure fo, _hvm_initial_state(), hvm_solve_creep(), hvm_solve_laos(), hvm_solve_relaxation(), hvm_solve_startup(), _make_creep_vector_field(), _make_k_ber_fn() (+215 more)

### Community 67 - "TestVLBVariantCreation"
Cohesion: 0.05
Nodes (30): Arrhenius temperature shift for dissociation rate.      k_d(T) = k_d_0 · exp(-E_, Temperature scaling of network modulus.      G0(T) = G0_ref · (T/T_ref)      Bas, vlb_arrhenius_shift(), vlb_thermal_modulus(), NumPyro/BayesianMixin model function.          Routes to appropriate prediction, Unit tests for VLBVariant (Bell + FENE-P + Temperature extensions).  Tests cover, Test FENE-P finite extensibility physics., FENE-P prevents divergence in extensional stress. (+22 more)

### Community 68 - "test_multi_file.py"
Cohesion: 0.05
Nodes (70): complexfloating, _expand_glob(), _flatten_result(), load_series(), load_srfs(), load_tts(), Any, Path (+62 more)

### Community 69 - "TestMenuBarActionConnections"
Cohesion: 0.12
Nodes (14): action_has_receivers(), Verify all Data menu actions have handlers., Verify all Models menu actions have handlers., Check if a QAction has any receivers connected to its triggered signal.      In, Verify all Transforms menu actions have handlers., Verify all Analysis menu actions have handlers., Verify all Pipeline menu actions have handlers., Verify all Tools menu actions have handlers. (+6 more)

### Community 70 - "AnalysisExporter"
Cohesion: 0.05
Nodes (37): AnalysisExporter, Any, Path, Export analysis to a single Excel workbook.          Creates sheets:         - S, Collect all exportable state from a Pipeline., List which sections were populated., Write summary.json and summary.txt., Export pipeline analysis results to structured output.      Supports three expor (+29 more)

### Community 71 - "json.py"
Cohesion: 0.06
...
### Community 72 - "RheoJAXMainWindow"
Cohesion: 0.03
Nodes (48): Any, FitResult, Handle save as action., Dispatch a failed import on the main thread (via relay)., Handle preferences action., Handle zoom in action., Handle zoom out action., Handle reset zoom action. (+40 more)

### Community 73 - "ImportWizard"
Cohesion: 0.02
Nodes (83): ImportWizard, Any, Multi-step data import wizard.      Steps:         1. File selection         2., Handle wizard finished., Get import configuration.          Returns         -------         dict[str, Any, qapp(), Regression check: ImportWizard file I/O runs off the Qt GUI thread., Ensure a QApplication exists. (+75 more)

### Community 74 - "__init__.py"
Cohesion: 0.07
Nodes (65): Any, AppState, Bayesian action reducers.  Handles: START_BAYESIAN, BAYESIAN_COMPLETED, BAYESIAN, reduce_bayesian_completed(), reduce_bayesian_failed(), reduce_start_bayesian(), reduce_store_bayesian_result(), Any (+57 more)

### Community 75 - "test_fractional_zener_family.py"
Cohesion: 0.07
Nodes (32): _create_parameters_dataframe(), _create_predictions_dataframe(), _create_quality_dataframe(), _create_residuals_dataframe(), _embed_plots(), Any, ndarray, Path (+24 more)

### Community 76 - "Bingham"
Cohesion: 0.14
...
### Community 77 - "TestFluidityLocalModelFunction"
Cohesion: 0.12
...
### Community 80 - "VLB Model Equation Verification"
Cohesion: 0.05
...
### Community 81 - "CancellationError"
Cohesion: 0.05
Nodes (49): BayesianWorkerSignals, Any, QObject, QRunnable, Bayesian Worker ==============  Background worker for Bayesian inference with NU, Initialize Bayesian worker.          Parameters         ----------         model, Signals for BayesianWorker.      Signals     -------     progress : Signal(int,, Slot: relay staged elapsed-time message on the GUI thread.          Called exclu (+41 more)
...
### Community 85 - "TestModelFitTemplate"
Cohesion: 0.20
Nodes (6): Test model fit plotting template., Test plotting model fit with experimental data., Test plotting model fit without residuals., Test that complex data with residuals produces a 2x2 axes layout., Test that mismatched data and predictions lengths raise ValueError., TestModelFitTemplate

### Community 86 - "DatasetRef"
Cohesion: 0.06
Nodes (29): create_parser(), main(), ArgumentParser, CLI subcommand for Bayesian inference with NUTS sampling.  Usage:     rheojax, Run Bayesian inference from CLI., Create argument parser for bayesian subcommand., BayesianResult, Any (+21 more)

### Community 87 - "run_analyze"
Cohesion: 0.06
Nodes (28): Array, ndarray, JIT-compiled relaxation prediction: G(t).          Computes relaxation modulus w, JIT-compiled creep prediction: J(t).          Computes creep compliance as appro, JIT-compiled steady shear prediction: eta(gamma_dot).          Computes viscosit, Predict based on fitted test mode.          Routes to appropriate prediction met, Predict complex modulus in oscillation mode.          Args:             omega: A, Predict relaxation modulus in relaxation mode.          Args:             t: Tim (+20 more)

### Community 88 - "__init__.py"
Cohesion: 0.08
Nodes (62): Unified fit visualization for NLSQ and Bayesian results.  This module provides t, configure_matplotlib(), Unified plotting and visualization utilities for rheological data.  This module, Configure matplotlib for rheological plotting with proper font handling.      Th, _apply_style(), compute_uncertainty_band(), _filter_positive(), _modulus_labels() (+54 more)
...
### Community 90 - "FitResult"
Cohesion: 0.04
Nodes (33): Exception, Build a :class:`FitResult` that records a failed fit attempt., FitResult, Any, ndarray, Root mean squared error, delegated to OptimizationResult., Mean absolute error, delegated to OptimizationResult., Akaike Information Criterion, delegated to OptimizationResult. (+25 more)

### Community 91 - "ArvizCanvas"
Cohesion: 0.04
Nodes (44): ArvizCanvas, _filter_degenerate_vars(), Any, Figure, ArviZ Canvas Widget ==================  ArviZ diagnostic plot integration for Ba, Connect internal signals., Scale the figure to the viewport width, preserving aspect ratio.          Instea, Handle plot type change.          Parameters         ----------         index : (+36 more)

### Community 92 - "PipelineBuilder"
Cohesion: 0.03
Nodes (48): PipelineBuilder, Any, Path, Add prediction step.          Args:             store_as: Optional name to store, Add plotting step.          Args:             show: Whether to display plot, Add Bayesian inference step (NUTS sampling).          Args:             num_warm, Add analysis export step.          Args:             output_path: Output directo, Add data saving step.          Args:             file_path: Output file path (+40 more)
...
### Community 95 - "ResidualsPanel"
Cohesion: 0.05
Nodes (30): Figure, ndarray, Cancel pending matplotlib draws before the widget is closed.          Only fires, Set up the user interface., Connect internal signals., Prompt for a file path and export the current figure (Export button)., Handle plot type change.          Parameters         ----------         index :, Set data and plot residuals.          Parameters         ----------         y_tr (+22 more)

### Community 96 - "_kernels.py"
Cohesion: 0.11
Nodes (16): QGroupBox, QTableWidget, Set parameter value with validation., Set up user interface., Initialize column mapping page., QWidget, Create general settings tab., Create JAX settings tab. (+8 more)

### Community 97 - "config_to_builder"
Cohesion: 0.10
Nodes (15): apply_overrides(), _coerce_value(), config_to_builder(), _nested_set(), Any, Apply CLI ``--override key=value`` pairs to a :class:`PipelineConfig`.      Over, Attempt to coerce a string override value to a Python scalar., Set a value in a nested dict via a list of key segments.      When the first key (+7 more)

### Community 98 - "SPPDecomposer"
Cohesion: 0.19
...
### Community 99 - "_make_model"
Cohesion: 0.13
Nodes (13): LinearModel, A non-array y (Python list) is coerced without error (real branch)., Minimal BayesianMixin model: y = a * X + b (accepts protocol kwargs)., A beta prior spec draws within bounds and skews away from uniform., precompile_bayesian accepts RheoData and default (None) inputs., A parameter with bounds=None is skipped (not sampled), no error., RheoData with test_mode=None triggers detect_test_mode., test_precompile_bayesian_with_rheodata_default_shape() (+5 more)

### Community 100 - "__init__.py"
Cohesion: 0.11
Nodes (33): Reset logging configuration to defaults.      Primarily useful for testing., reset_config(), log_bayesian(), log_gui_action(), log_io(), log_operation(), log_pipeline_stage(), log_transform() (+25 more)

### Community 101 - "FFTAnalysis"
Cohesion: 0.06
...
### Community 104 - "test_window_chrome.py"
Cohesion: 0.06
Nodes (41): PreferencesDialog, Any, Preferences Dialog =================  Application settings and preferences., Handle dialog accept., Handle dialog reject., Handle dialog show event., Application preferences dialog.      Settings organized in tabs:         - Gener, Handle auto-save checkbox change. (+33 more)

### Community 105 - "_translate_y2_col"
Cohesion: 0.03
Nodes (80): VariantType, Base class for STZ models.  Provides shared infrastructure for: 1. Parameter ini, Base class for Shear Transformation Zone (STZ) models.      Implements the core, Initialize STZ Base Model.          Args:             variant: Complexity varian, Initialize ParameterSet based on selected variant., STZBase, Any, ndarray (+72 more)

### Community 106 - "build_transform_controller"
Cohesion: 0.10
Nodes (11): Add a shared parameter.          Args:             name: Parameter name, Link a parameter set to a shared parameter.          Args:             param_set, Set shared parameter value.          Args:             name: Parameter name, Validate value against all constraints.          Args:             value: Value, Add a parameter to the set.          Args:             name: Parameter name, Set parameter value.          Args:             name: Parameter name, Set bounds for a parameter.          Args:             name: Parameter name, Get all parameter values as array.          Returns:             Array of parame (+3 more)

### Community 107 - "Carreau"
Cohesion: 0.04
Nodes (45): Carreau, ndarray, RheoData, TestMode, Fit Carreau parameters to data.          Args:             X: Shear rate data (g, Predict viscosity for given shear rates.          Args:             X: Shear rat, Model function for Bayesian inference.          This method is required by Bayes, Compute viscosity using Carreau model.          Args:             gamma_dot: She (+37 more)

### Community 108 - "ITTMCTBase"
Cohesion: 0.02
Nodes (95): CubicSpline, Interpolator1D, ITTMCTBase, ndarray, Base class for ITT-MCT (Integration Through Transients Mode-Coupling Theory) mod, Initialize ITT-MCT base model.          Parameters         ----------         in, Initialize model parameters.          Subclasses must implement this to add para, Compute equilibrium (quiescent) correlator Φ_eq(t).          Parameters (+87 more)

### Community 109 - "extract_frequency_features"
Cohesion: 0.05
...
### Community 110 - "check_r_hat"
Cohesion: 0.05
Nodes (39): check_divergences(), check_ess(), check_posterior_accuracy(), check_r_hat(), creep_maxwell_data(), oscillation_maxwell_data(), Bayesian mode-aware validation tests.  This module validates that Bayesian infer, Synthetic Maxwell creep compliance data.      Uses Maxwell parameters: G0=1e5 Pa (+31 more)
...
### Community 112 - "PreprocessingResult"
Cohesion: 0.16
...
### Community 113 - "structure_factor.py"
Cohesion: 0.67
Nodes (3): percus_yevick_sk_jax(), Array, JAX-compatible Percus-Yevick S(k) computation.      Parameters     ----------

### Community 114 - "test_column_mapping.py"
Cohesion: 0.06
Nodes (50): CanonicalField, match_column(), match_columns(), Consolidated canonical column field registry for all I/O readers.  Merges patter, Canonical field descriptor for a rheological measurement column., Match a column header string to a CanonicalField.      Uses :func:`~rheojax.io.r, Match a list of column headers to canonical fields.      Parameters     --------, _get_column_data() (+42 more)

### Community 115 - "spp_kernels.py"
Cohesion: 0.06
...
### Community 117 - "PronyConversion"
Cohesion: 0.08
Nodes (26): _fit_prony_oscillation(), _fit_prony_relaxation(), _prony_to_frequency(), _prony_to_frequency_jax(), PronyConversion, Any, ndarray, RheoData (+18 more)

### Community 118 - "test_fluidity_nlsq_nuts_pipeline.py"
Cohesion: 0.05
...
### Community 119 - "RheoJaxValidationWarning"
Cohesion: 0.09
Nodes (50): Custom exceptions and warnings for the RheoJAX package.  This module defines the, Emitted for data quality issues detected during loading or validation.      Subc, Raised for unrecoverable fit failures.      Examples include optimizer divergenc, Emitted when an optimizer converges but with caveats.      Examples: maximum ite, RheoJaxConvergenceWarning, RheoJaxFitError, RheoJaxValidationWarning, _check_creep() (+42 more)

### Community 120 - "HVMBase"
Cohesion: 0.05
...
### Community 121 - "ProtocolModelStep"
Cohesion: 0.10
...
### Community 122 - "test_schematic.py"
Cohesion: 0.05
Nodes (26): Tests for ITTMCTSchematic (F₁₂) model.  Tests cover: - Parameter initialization, Tests for SAOS (G', G'') predictions., Test that oscillation returns valid moduli., Test that glass shows plateau modulus., Tests for model fitting., Test fitting to flow curve data., Direct exercise of the quiescent correlator Φ_eq(t)., Glass correlator retains a non-ergodic plateau (Φ_∞ > Φ_fluid_∞). (+18 more)

### Community 123 - ".fit_bayesian"
Cohesion: 0.09
Nodes (21): Any, Array, ArrayLike, ndarray, RheoData, TestMode, Perform Bayesian inference using NumPyro NUTS sampler.          Runs NUTS (No-U-, Validate that required attributes exist for Bayesian inference.          R12-B-0 (+13 more)

### Community 124 - "SGRGeneric"
Cohesion: 0.04
Nodes (26): Initialize SGR GENERIC Model.          Creates ParameterSet with:         - x (n, Determine material phase regime from noise temperature x.          Returns:, Initialize parameters for dynamic noise temperature evolution.          Adds par, Enable thixotropy modeling with structural parameter lambda(t).          Adds th, Soft Glassy Rheology (SGR) GENERIC Thermodynamic Framework Model.      This mode, SGRGeneric, Test SGRGeneric thermodynamic consistency per Fuereder & Ilg 2013., Test energy conservation: dE/dt = power input for reversible part. (+18 more)
...
### Community 126 - "preprocess_for_protocol"
Cohesion: 0.07
Nodes (25): Automatically detect or retrieve test mode.          The test mode is detected b, Auto-populate a newly-added pipeline step's config from current UI state., Execute file import in background thread., Export all datasets in state to the selected directory (data format only)., Convert DatasetState into RheoData for export., Any, Figure, Path (+17 more)

### Community 127 - "FitWorker"
Cohesion: 0.05
Nodes (49): BayesianWorker, Worker for running MCMC sampling in background.      Features:         - NUTS sa, Check if job should be cancelled.          Raises         ------         Cancell, _bayesian_work_entry(), _extract_data(), _fit_work_entry(), make_bayesian_worker(), make_fit_worker() (+41 more)
...
### Community 130 - "SpectrumInversion"
Cohesion: 0.19
...
### Community 131 - "TestMIKH"
Cohesion: 0.05
Nodes (29): MIKH, r"""Maxwell-Isotropic-Kinematic Hardening (MIKH) Model.      A thixotropic elast, Test NLSQ fitting for MIKH., NLSQ fitting for flow curve should converge., NLSQ fitting for startup should converge., NLSQ should recover parameters within reasonable bounds., Test Bayesian inference for MIKH., Smoke test for Bayesian inference on MIKH. (+21 more)

### Community 132 - "Envelope"
Cohesion: 0.07
Nodes (23): create_data_envelope(), create_fit_envelope(), Envelope, _get_version(), Any, JSON envelope dataclass for stdin/stdout piping between CLI commands.  RheoJAX C, Read an envelope from stdin if stdin is not a terminal.          Returns:, Write the envelope as JSON to stdout.          The newline ensures downstream pr (+15 more)

### Community 133 - "_PreviewWorker"
Cohesion: 0.06
...
### Community 136 - "TransformPlotter"
Cohesion: 0.11
...
### Community 138 - "_kernels_diffrax.py"
Cohesion: 0.11
Nodes (15): Whether the optimizer converged successfully., Execute fitting in background thread.          This method runs in a separate th, _is_placeholder_model(), Any, FitResult, ndarray, RheoData, Generate model predictions.          Parameters         ----------         model (+7 more)

### Community 139 - "LogCapture"
Cohesion: 0.07
...
### Community 141 - "load_trios_chunked"
Cohesion: 0.08
...
### Community 143 - "_kernels.py"
Cohesion: 0.05
Nodes (49): _compute_steady_dimensionless_stresses(), giesekus_complex_viscosity(), giesekus_creep_ode_rhs(), giesekus_multimode_ode_rhs(), giesekus_multimode_saos_moduli(), giesekus_ode_rhs(), giesekus_ode_rhs_laos(), giesekus_relaxation_ode_rhs() (+41 more)

### Community 144 - "test_spp_kernels.py"
Cohesion: 0.03
...
### Community 145 - "FluiditySaramitoNonlocal"
Cohesion: 0.02
Nodes (112): Fluidity Models for yield-stress fluids.  This package provides fluidity-based c, FluiditySaramitoBase, ndarray, Base class for Fluidity-Saramito Elastoviscoplastic Models.  This module provide, Get initial fluidity value based on waiting time.          For aged samples (t_w, Get all parameters as a dictionary.          Returns         -------         dic, Get effective yield stress based on coupling mode.          Parameters         -, Build args dictionary for ODE integration.          Parameters         --------- (+104 more)

### Community 146 - "PipelineSidebar"
Cohesion: 0.04
Nodes (43): QPainter, QSize, QStyledItemDelegate, QToolBar, get_icon(), MainToolBar, QIcon, QWidget (+35 more)

### Community 147 - "load_npz"
Cohesion: 0.10
Nodes (38): _decode_str(), _encode_str(), load_npz(), Any, ndarray, Path, RheoData, NumPy .npz writer/reader for RheoData objects. (+30 more)

### Community 148 - "LogFormat"
Cohesion: 0.08
...
### Community 152 - "TestFractionalZenerSolidLiquid"
Cohesion: 0.05
...
### Community 163 - "TNTMultiSpecies"
Cohesion: 0.02
Nodes (51): FluidityNonlocal, Add non-local specific parameters., Get grid-related arguments for PDE solver.          Args:             params: Op, Non-Local (1D PDE) Fluidity Model for yield-stress fluids.      Implements the C, Initialize Non-Local Fluidity Model.          Args:             N_y: Number of s, Test Nonlocal has additional xi parameter., Test both models can export parameter dict., Test Nonlocal fit raises without test_mode. (+43 more)
...
### Community 165 - "test_fikh_thermal.py"
Cohesion: 0.04
Nodes (63): Any, Get current parameters as dictionary., Get initial state vector for ODE integration.          Always returns 5-componen, Simulate transient response using Diffrax ODE integration.          Args:, Update history buffer with new value using ring buffer pattern.      Shifts buff, update_history_buffer(), fikh_return_step_isothermal(), fikh_return_step_thermal() (+55 more)

### Community 166 - "test_registry_consistency.py"
Cohesion: 0.15
...
### Community 168 - "mittag_leffler_e"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (34): adapt_prior(), map_centered_priors(), Prior format conversion utilities.  Converts between PriorsEditor's ``{"distribu, Convert one PriorsEditor entry to the ``prior_dict_to_dist`` format.      Parame, Build LogNormal priors centered on MAP values plus a HalfNormal sigma prior., Tests for rheojax.gui.foundation.priors., Negative MAP value gets a Normal prior, not LogNormal.      Regression: LogNorma, Empty MAP estimate → only sigma key. (+26 more)

### Community 170 - "BayesianOptionsDialog"
Cohesion: 0.13
...
### Community 171 - "RheoJAX GUI Smoke Tests"
Cohesion: 0.06
...
### Community 172 - "_make_fit_result"
Cohesion: 0.09
...
### Community 173 - "PreferencesDialog"
Cohesion: 0.06
Nodes (24): load_anton_paar(), Load RheoCompass CSV export file and return RheoData object(s).      Handles int, Tests for oscillatory test loading (US3: T028-T030)., T028: Test oscillatory loading returns complex G*., Test complex modulus G* = G' + i*G'' is computed., T030: Test G'/G'' accessible via properties., T029: Test Hz to rad/s conversion., Tests for test type auto-detection (US5: T035-T040). (+16 more)

### Community 174 - "FitOrchestrator"
Cohesion: 0.12
Nodes (11): ArrayLike, RuntimeError, Auto-detect optimization strategy based on data range.          Args:, Check model-data compatibility and return result.          Args:             X:, Enhance optimization error with compatibility information.          Args:, Fit the model to data using NLSQ optimization.          This method uses NLSQ (G, Precompile NLSQ residual functions to eliminate JIT cold-start.          Trigger, Internal fit implementation to be overridden by subclasses.          Args: (+3 more)

### Community 175 - "MultiView"
Cohesion: 0.07
Nodes (23): QPoint, QTreeWidget, QTreeWidgetItem, DatasetTree, Path, QWidget, Create the root project item., Add dataset to tree.          Parameters         ----------         dataset_stat (+15 more)

### Community 176 - "PriorsEditor"
Cohesion: 0.07
Nodes (22): QFrame, PriorsEditor, Any, ndarray, Set up the user interface., Connect internal signals., Set model parameters to configure priors for.          Parameters         ------, Rebuild the parameter table. (+14 more)

### Community 177 - "compute_plastic_strain_rate"
Cohesion: 0.16
...
Cohesion: 0.08
Nodes (17): _make_model(), Helper: SGRGeneric with power-law-fluid parameters., Fitting in creep, steady-shear, and startup protocols (noiseless data)., is_stress=True divides applied stress by gamma_dot before fitting., LAOS fitting via the public fit() API.      Regression coverage for a bug where, Direct JIT predictors and the LAOS predict route., Prediction-side error handling., Reversible / irreversible / full GENERIC dynamics. (+9 more)

### Community 179 - "FractionalMaxwellGel"
Cohesion: 0.09
...
### Community 180 - "GeneralizedMaxwell"
Cohesion: 0.14
...
### Community 182 - "._steady_state_conformation"
Cohesion: 0.07
...
### Community 184 - "test_transform_plotter.py"
Cohesion: 0.03
...
### Community 186 - "test_visual_regression.py"
Cohesion: 0.18
Nodes (19): compare_figures(), Any, ndarray, Path, QApplication, Render widget_code's figure in an isolated subprocess and save it as     the gol, Render widget_code's figure in an isolated subprocess and compare it     against, Test basic line plot rendering. (+11 more)
...
### Community 188 - "FractionalPoyntingThomson"
Cohesion: 0.09
Nodes (17): __getattr__(), Lazy-load top-level subpackages on first access.      This avoids the 270ms star, FractionalPoyntingThomson, ndarray, Initialize Fractional Poynting-Thomson model., Predict creep compliance J(t).          J(t) = 1/G_e + (1/G_k) * (1 - E_α(-(t/τ), Predict relaxation modulus G(t).          G(t) exhibits stress relaxation from i, Predict complex modulus G*(ω).          Convert from complex compliance: (+9 more)

### Community 189 - "test_hvm.py"
Cohesion: 0.08
Nodes (19): Create Zener/SLS model (G_E=0).          Parameters         ----------         G, Create partial vitrimer (G_D=0, Meng 2019).          Parameters         --------, Create neo-Hookean elastic solid (G_E=0, G_D=0).          Parameters         ---, Create single Maxwell fluid (G_P=0, G_E=0).          Parameters         --------, hvm_maxwell(), hvm_partial(), hvm_zener(), Recovery of known models as limiting cases. (+11 more)

### Community 190 - "SPPYieldStress"
Cohesion: 0.08
Nodes (24): Distribution, Array, ndarray, RheoData, TestMode, Fit SPP yield stress model to data.          The fitting strategy depends on the, Fit to amplitude sweep data (oscillation mode).          Uses power-law scaling:, Fit to steady shear flow curve (rotation mode).          Uses Herschel-Bulkley-l (+16 more)

### Community 191 - "MockBayesianModel"
Cohesion: 0.05
Nodes (22): fitted_pipeline(), MockBayesianModel, Test fit_nlsq with model instance., Test that fit_nlsq stores NLSQ result., Test fit_bayesian with warm-start from NLSQ., Test get_diagnostics returns correct structure., Test complete workflow with method chaining., Test complete workflow: load → fit_nlsq → fit_bayesian → diagnostics. (+14 more)

### Community 192 - "BayesianMixin"
Cohesion: 0.20
...
### Community 193 - "RheoJAX Architecture Overview"
Cohesion: 0.06
...
### Community 194 - "Hebraud-Lequeux (HL) Model: Equations and Physics"
Cohesion: 0.06
...
### Community 197 - "get_default_workers"
Cohesion: 0.09
...
### Community 198 - "Test Data Fixtures for RheoJAX v0.4.0"
Cohesion: 0.06
...
### Community 202 - "get_template"
Cohesion: 0.06
Nodes (28): Write a template YAML pipeline config., run_init(), get_template(), list_templates(), Path, YAML pipeline templates for ``rheojax pipeline init``.  Each template is a compl, Return the YAML string for a named template.      Args:         name: Template i, Return metadata for all available templates.      Returns:         List of dicts (+20 more)

### Community 203 - "TestParameterClass"
Cohesion: 0.13
Nodes (11): Test Parameter class for parameter management., Test creating a parameter., Test parameter value validation., Test parameter without bounds., Test Parameter class for parameter management., Test creating a parameter., Test parameter value validation., Test parameter serialization to dict. (+3 more)
...
### Community 206 - "._predict"
Cohesion: 0.09
Nodes (18): ndarray, Internal creep prediction for optimization.          Args:             t: Time a, Predict based on fitted test mode.          Args:             X: Independent var, JIT-compiled relaxation prediction.          Args:             t: Time array, Predict relaxation modulus E(t).          Args:             t: Time array, JIT-compiled oscillation prediction.          Args:             omega: Angular f, Predict complex modulus in oscillation mode.          Args:             omega: A, JIT-compiled creep prediction via backward-Euler.          Args:             t: (+10 more)

### Community 207 - "TNTLoopBridge"
Cohesion: 0.05
Nodes (23): Loop-bridge kinetics model for telechelic polymer networks.      Implements reve, Get loop attachment time τ_a (s)., Get Bell force sensitivity ν (dimensionless)., Get zero-shear viscosity η₀ = f_B_eq·G·τ_b + η_s (Pa·s)., TNTLoopBridge, Test flow curve prediction via predict()., Test direct predict_flow_curve method., Test flow curve with viscosity and N1. (+15 more)

### Community 208 - "SPPAmplitudeSweepPipeline"
Cohesion: 0.08
...
### Community 209 - "hebraud_lequeux.py"
Cohesion: 0.09
Nodes (42): Hébraud–Lequeux (HL) Model implementation.  This module implements the Hébraud–L, Model function for Bayesian inference (NumPyro NUTS).          Args:, Predict response using fitted parameters and stored test_mode., _compute_dt_and_steps_for_rate(), creep_kernel(), flow_curve_kernel(), HLGrid, HLState (+34 more)

### Community 210 - "Mastercurve"
Cohesion: 0.04
...
### Community 211 - "test_migrated_notebooks.py"
Cohesion: 0.09
...
### Community 212 - "run_fit_isolated"
Cohesion: 0.16
...
### Community 213 - "PipelineConfigureRunStep"
Cohesion: 0.13
...
### Community 214 - "FractionalKelvinVoigt"
Cohesion: 0.11
...
### Community 216 - "lattice.py"
Cohesion: 0.18
Nodes (17): _compute_y_band(), _posterior_draw_indices(), _posterior_params_at_index(), Any, ndarray, Subprocess Bayesian ==================  Pure function for NUTS Bayesian sampling, Select evenly spaced draw indices, consistent across parameters., Extract a single posterior draw as a parameter dict. (+9 more)

### Community 217 - "sgr_population_balance.py"
Cohesion: 0.12
...
### Community 218 - "EPM (Elasto-Plastic Models) Comprehensive Validation Report"
Cohesion: 0.07
...
### Community 219 - "test_unit_conversion.py"
Cohesion: 0.12
Nodes (13): Manages parameters shared across multiple models., Initialize shared parameter set., Create a parameter group.          Args:             group_name: Name for the gr, Check if shared parameter exists., SharedParameterSet, Tests for parameter management system.  This test suite ensures proper parameter, Test shared parameter management across models., Test creating shared parameters. (+5 more)

### Community 220 - "Background Job System - Implementation Summary"
Cohesion: 0.07
...
### Community 221 - "TestFIKHPredictions"
Cohesion: 0.03
Nodes (104): detect_trios_format(), load_trios(), _log_parse_result(), Any, Path, RheoData, Load TRIOS file with automatic format detection.      Detects format from file e, Log parse completion with record count. (+96 more)

### Community 222 - "test_dmt.py"
Cohesion: 0.08
...
### Community 223 - "TestDiffraxCompilation"
Cohesion: 0.04
Nodes (58): advected_correlator(), advected_memory_decorrelation(), compute_microscopic_stress(), f12_memory_kernel_derivative(), get_microscopic_stress_prefactor(), prony_decompose_memory(), _prony_leastsq_robust(), _prony_log_spacing() (+50 more)

### Community 224 - "test_protocols.py"
Cohesion: 0.07
Nodes (19): Cross-protocol tests for ITT-MCT models.  Tests cover: - Protocol consistency ac, Tests for edge cases and boundary conditions., Test behavior at t=0., Test prediction for single data point., Test numerical stability at extreme shear rates., Tests for consistency across protocols., Tests comparing F₁₂ and ISM models., Test qualitative agreement between F₁₂ and ISM for flow curves. (+11 more)

### Community 225 - "TestMLIKHProtocols"
Cohesion: 0.12
...
### Community 229 - "PersistentProcessPool"
Cohesion: 0.12
...
### Community 230 - "run_profiling.py"
Cohesion: 0.11
...
### Community 231 - "test_phase2_performance.py"
Cohesion: 0.16
...
### Community 232 - "RheoJAX v0.4.0 Task Group 1 - Baseline Test Report"
Cohesion: 0.07
...
### Community 234 - "RheoJAX Tech Stack"
Cohesion: 0.07
...
### Community 235 - "HVMLocal"
Cohesion: 0.06
Nodes (21): HVM (Hybrid Vitrimer Model) package.  Constitutive models for vitrimers with p, HVMLocal, ndarray, Get parameters as dict with defaults for optional params., Compute zero-stress BER rate from current parameters., Predict steady-state flow curve.          At steady state, mu^E → mu^E_nat, so s, Predict SAOS storage and loss moduli.          Two Maxwell modes (E, D) plus per, Simulate stress relaxation after step strain.          Parameters         ------ (+13 more)

### Community 236 - "ModelComparison"
Cohesion: 0.11
...
### Community 237 - "FIKHBase"
Cohesion: 0.29
Nodes (5): ArrayLike, ndarray, Compute the static substep count for return-mapping stabilization.          The, Densify (times, strains) onto a stable-dt grid for the scan kernel.          Use, Extract time and strain arrays from input.          Args:             X: Input d

### Community 238 - "TestHVNMLimitingCases"
Cohesion: 0.11
...
### Community 239 - "compute_fit_quality"
Cohesion: 0.12
...
### Community 240 - "solve_linear_creep_compliance"
Cohesion: 0.13
...
### Community 241 - "test_physics.py"
Cohesion: 0.01
Nodes (111): GiesekusSingleMode, ndarray, Internal LAOS simulation for model_function., Simulate Large-Amplitude Oscillatory Shear (LAOS).          The Giesekus model p, Extract Fourier harmonics from LAOS stress response.          The nonlinear stre, Compute stress overshoot ratio in startup flow.          The overshoot ratio is, Get effective relaxation spectrum G(t).          Note: For single-mode Giesekus,, Initialize single-mode Giesekus model. (+103 more)

### Community 242 - "TestBayesianNotebooks"
Cohesion: 0.07
...
### Community 243 - "FractionalModelMixin"
Cohesion: 0.09
Nodes (23): MockFractionalModel, MockFZSS, Unit tests for FractionalModelMixin.  Tests verify: - Smart initialization deleg, Test validation of alpha parameter., Test validation of modulus parameters., Test validation of time scale parameters., Mock fractional model for testing mixin functionality., Test that all 11 fractional models have initializer mappings. (+15 more)

### Community 244 - "handlers.py"
Cohesion: 0.10
...
### Community 249 - "RheoJAX GUI Stylesheets"
Cohesion: 0.07
...
### Community 250 - "test_fikh_caputo.py"
Cohesion: 0.21
...
### Community 251 - ".predict_normal_stresses"
Cohesion: 0.16
Nodes (9): find_test_mode_patterns(), Test the introspection helper functions themselves., Test detection of == patterns., Test detection of 'in [...]' patterns., Test detection of 'mode ==' shorthand patterns., Test getting source from a real model., Test detection of dedicated predict_* methods., Find test_mode values referenced in source code.      Searches for patterns li (+1 more)

### Community 252 - "BayesianPipeline"
Cohesion: 0.06
Nodes (21): BayesianPipeline, DataFrame, Reset pipeline to initial state.          Clears all data, models, and results i, String representation of Bayesian pipeline., Perform Bayesian inference using NumPyro NUTS sampler.          This method runs, Specialized pipeline for Bayesian rheological analysis workflows.      This clas, Get formatted posterior summary statistics.          Returns a pandas DataFrame, Plot posterior distributions.          Generates histogram plots of posterior di (+13 more)

### Community 253 - "detect_data_range_decades"
Cohesion: 0.12
...
### Community 254 - "Hybrid Vitrimer Model (HVM) -- Literature Review & Equations"
Cohesion: 0.08
...
### Community 258 - "test_protocol_preprocessing.py"
Cohesion: 0.14
Nodes (8): Test _get_mode_params extracts correct values., Test FMLIKH parameter handling., Test per-mode parameters are created., Test single-mode G, eta, C, gamma_dyn are removed., Test shared_alpha=True gives single alpha parameter., Test shared_alpha=False gives per-mode alpha., Test shared parameters are preserved., TestFMLIKHParameters

### Community 259 - "TestProcessExitVerification"
Cohesion: 0.10
Nodes (16): preprocess_for_protocol(), Apply protocol-aware preprocessing and diagnostics.      This function dispatche, Tests for _preprocess_creep via the dispatcher., Linearly growing J(t) at long times flags viscous flow., Saturating compliance does not flag viscous flow., Many decreasing steps trigger the non-monotonic warning., len(t) <= 20 skips the viscous-flow block but still checks monotonicity., Tests for _preprocess_flow_curve via the dispatcher. (+8 more)

### Community 260 - "._predict"
Cohesion: 0.11
...
### Community 262 - "TestPlotLissajous"
Cohesion: 0.17
...
### Community 264 - "Functional Requirements"
Cohesion: 0.08
...
### Community 265 - "cmd_transform.py"
Cohesion: 0.12
...
### Community 266 - "FractionalBurgersModel"
Cohesion: 0.08
...
### Community 267 - "FractionalJeffreysModel"
Cohesion: 0.13
...
### Community 268 - "FractionalKelvinVoigtZener"
Cohesion: 0.08
...
### Community 269 - "FractionalZenerLiquidLiquid"
Cohesion: 0.08
Nodes (17): FractionalZenerLiquidLiquid, ndarray, Predict complex modulus G*(ω).          G*(ω) = c_1 * (iω)^α / (1 + (iωτ)^β) + c, Predict relaxation modulus G(t).          Approximate form (no exact closed-form, Predict creep compliance J(t).          Note: Analytical creep compliance is com, Derive heuristic starting values from relaxation data.          For FZLL, estima, Predict response for given input.          Parameters         ----------, Model function for Bayesian inference.          This method is required by Bayes (+9 more)

### Community 270 - "ArrayLike"
Cohesion: 0.10
Nodes (15): ArrayLike, ndarray, Predict steady-state flow curve.          Args:             gamma_dot: Array of, Predict startup shear response.          Args:             t: Time array, Predict stress relaxation after step strain.          Args:             t: Time, Predict creep response under constant stress.          Args:             t: Time, Predict large amplitude oscillatory shear response.          Args:             t, Predict response with protocol-aware dispatch.          Args:             X: Inp (+7 more)

### Community 271 - "validate_model_doc"
Cohesion: 0.12
...
### Community 272 - "test_gmm_element_search.py"
Cohesion: 0.09
...
### Community 275 - "TestMLIKHModelFunction"
Cohesion: 0.11
...
### Community 276 - "configure_logging"
Cohesion: 0.08
Nodes (27): Configure application logging.      Parameters     ----------     verbose : bool, setup_logging(), _apply_config(), configure_logging(), get_config(), is_configured(), LogFormat, RheoJAX Logging Configuration.  Centralized configuration management for the Rhe (+19 more)

### Community 277 - "compute_l1_coefficients"
Cohesion: 0.14
...
### Community 278 - "TestPhysicalConsistency"
Cohesion: 0.14
...
### Community 279 - "G0"
Cohesion: 0.27
Nodes (13): Runs `worker` (FitWorker or ProcessWorkerAdapter) synchronously, capturing its, DatasetArtifact, FileArtifact, FitArtifact, FitStepResult, PhaseResult, PipelineRunResult, Runtime result/artifact shapes for Pipeline mode execution.  Distinct from the p (+5 more)

### Community 280 - "run_single_notebook_96h.py"
Cohesion: 0.17
...
### Community 282 - "_compute_y_band"
Cohesion: 0.13
Nodes (8): Test utility methods., Test get_result method., Test get_result without data raises error., Test get_last_model method., Test get_all_models method., Test pipeline cloning., Test string representation., TestPipelineUtilities

### Community 283 - "test_dmta_removal.py"
Cohesion: 0.14
...
### Community 284 - "OptimizationResult"
Cohesion: 0.09
...
### Community 285 - "check_kramers_kronig"
Cohesion: 0.14
...
### Community 286 - "test_isotropic.py"
Cohesion: 0.16
...
### Community 287 - "ColumnMappingPage"
Cohesion: 0.04
Nodes (39): QRunnable, QWizard, QWizardPage, ColumnMappingPage, _FileReadWorker, FileSelectionPage, PreviewConfirmPage, DataFrame (+31 more)

### Community 288 - "Background Job System"
Cohesion: 0.09
...
### Community 289 - "JAXStatusWidget"
Cohesion: 0.22
Nodes (6): QLabel, Apply themed badge styling to a QLabel.          Parameters         ----------, Set float64 enabled indicator.          Parameters         ----------         en, Update JIT cache count.          Parameters         ----------         count : i, Show compiling indicator., Initialize JAX status widget.          Parameters         ----------         par

### Community 290 - "TestPreprocessLaos"
Cohesion: 0.14
...
### Community 293 - "SimpleModel"
Cohesion: 0.02
Nodes (49): Pipeline, Get the last fitted model.          Returns:             Last fitted BaseModel o, Get all fitted models from pipeline.          Returns:             List of all f, Get fitted parameters from the last model as a dictionary.          This is a co, Create a copy of the pipeline.          Returns:             New Pipeline with c, Reset pipeline to initial state.          Returns:             self for method c, String representation of pipeline., Apply a transform to the data.          Args:             transform: Transform n (+41 more)

### Community 294 - "._get_mode_arrays"
Cohesion: 0.20
...
### Community 296 - "PipelineTemplateDialog"
Cohesion: 0.15
Nodes (11): QDialog, PipelineTemplateDialog, QListWidgetItem, QWidget, Populate the list widget from the CLI template registry., Update the YAML preview and description when selection changes., Store selected template name and close with Accepted result., Close with Rejected result; selected_template remains None. (+3 more)

### Community 297 - "estimate_eta0"
Cohesion: 0.03
Nodes (35): _coerce_ndarray(), ArrayLike, ndarray, Ensure data is a proper array., Validate data for common issues., Convert arrays to JAX arrays.          Returns cached result on subsequent calls, Convert arrays to NumPy arrays.          Uses np.asarray() for zero-copy convers, Create a copy of the RheoData.          Returns:             Copy of the RheoDat (+27 more)

### Community 298 - "TestFMLIKHPredictions"
Cohesion: 0.09
...
### Community 299 - "TestCarreauYasudaBasics"
Cohesion: 0.06
Nodes (25): CarreauYasuda, ndarray, RheoData, TestMode, Fit Carreau-Yasuda parameters to data.          Args:             X: Shear rate, Predict viscosity for given shear rates.          Args:             X: Shear rat, Model function for Bayesian inference.          This method is required by Bayes, Compute viscosity using Carreau-Yasuda model.          Args:             gamma_d (+17 more)

### Community 300 - "PowerLaw"
Cohesion: 0.25
...
### Community 301 - "FluidityLocal"
Cohesion: 0.03
Nodes (47): fluidity_local_steady_state(), Compute steady-state flow curve for Local Fluidity model.      At steady state:, FluidityLocal, Any, ndarray, Predict steady-state flow curve (compatibility wrapper)., Fit transient response.          Args:             t: Time array (s), Simulate transient response using Diffrax ODE integration.          Args: (+39 more)

### Community 302 - "TestPhysicalConsistency"
Cohesion: 0.05
Nodes (21): Get number of bond species N., Multi-species Transient Network Theory model.      Implements a network with N i, TNTMultiSpecies, Single species (N=1) should behave identically to single Maxwell mode., Test flow curve prediction returns correct shape, positive, finite., Test direct predict_flow_curve method., Test flow curve with viscosity and N1., Multi-mode with constant breakage should be Newtonian (constant viscosity). (+13 more)

### Community 303 - "test_transform_page_redesign.py"
Cohesion: 0.11
...
### Community 304 - "create_rheo_data_creep"
Cohesion: 0.13
Nodes (22): create_rheo_data_creep(), create_rheo_data_oscillation(), create_rheo_data_relaxation(), generate_creep_reference_data(), generate_oscillation_reference_data(), generate_relaxation_reference_data(), generate_synthetic_trios_file(), generate_trios_files_batch() (+14 more)

### Community 305 - "TestBayesianInterface"
Cohesion: 0.06
...
### Community 306 - "TestFluidityNonlocalModelFunction"
Cohesion: 0.23
...
### Community 307 - "TestHebraudLequeux"
Cohesion: 0.10
...
### Community 308 - "TestCreepSimulation"
Cohesion: 0.03
Nodes (33): Single-mode Transient Network Theory model.      Implements the Green-Tobolsky /, Get network modulus G (Pa)., Get bond lifetime τ_b (s)., Get solvent viscosity η_s (Pa·s)., Get zero-shear viscosity η₀ = G·τ_b + η_s (Pa·s)., Get slip parameter ξ., Whether this is the basic (constant/linear/UC) variant., TNTSingleMode (+25 more)

### Community 309 - "TestVLBMultiNetworkAnalytical"
Cohesion: 0.09
...
### Community 310 - "parse_args"
Cohesion: 0.15
Nodes (19): CompletedProcess, parse_args(), Namespace, Parse command line arguments.      Parameters     ----------     argv : list[str, The --workspace flag exists and defaults to False., Run a main()-invoking scenario in a fresh subprocess.      Each of these tests e, _run_isolated(), test_default_launch_constructs_workspace_window() (+11 more)

### Community 311 - "LogDockWidget"
Cohesion: 0.16
...
### Community 314 - "ExportOptionsDialog"
Cohesion: 0.10
...
### Community 315 - "get_jax_info"
Cohesion: 0.23
Nodes (7): CancelWorkerRunnable, Any, Dispatches a worker's .cancel() off the GUI thread.  ProcessWorkerAdapter.cancel, _FakeWorker, test_cancel_worker_runnable_calls_cancel(), test_cancel_worker_runnable_runs_via_threadpool(), test_phase_worker_ready_updates_only_its_own_dataset()

### Community 316 - "TestISMProtocols"
Cohesion: 0.11
...
### Community 317 - "TNTCates"
Cohesion: 0.05
Nodes (21): Return string representation., Get plateau modulus G₀ (Pa)., Get reptation time τ_rep (s)., Get solvent viscosity η_s (Pa·s)., Get effective relaxation time τ_d = √(τ_rep · τ_break) (s)., Cates living polymer (wormlike micelle) model.      Implements the Cates theory, TNTCates, Test SAOS prediction. (+13 more)

### Community 318 - "ndarray"
Cohesion: 0.14
...
### Community 321 - "TestBasicNotebooks"
Cohesion: 0.09
...
### Community 322 - "1. Dullaert-Mewis Model (2006) -- Literature Equations"
Cohesion: 0.10
...
### Community 326 - "TestFluidityEvolution"
Cohesion: 0.17
...
### Community 327 - "TestHLValidation"
Cohesion: 0.09
...
### Community 328 - "TestPlotHarmonicSpectrum"
Cohesion: 0.11
Nodes (10): Tests for plot_harmonic_spectrum., Bar chart creates figure with odd-harmonic labels., Normalized amplitudes: I_n/I_1 ylabel., Unnormalized: I_n ylabel., n_harmonics limits displayed bars., Empty amplitudes returns figure with 'empty' title., n_harmonics=0 returns early with empty figure., Negative n_harmonics raises ValueError. (+2 more)

### Community 329 - "test_sticky_rouse.py"
Cohesion: 0.10
...
### Community 330 - "When Analytical SAOS Breaks Down for Transient Network Models and Vitrimers"
Cohesion: 0.14
...
### Community 331 - "test_generalized_maxwell_warm_start.py"
Cohesion: 0.33
...
### Community 333 - "test_unsaved_changes_guard.py"
Cohesion: 0.04
Nodes (32): fitted_maxwell(), fitted_maxwell_oscillation(), _maxwell_data(), _maxwell_oscillation_data(), ndarray, The optimal parameter value must lie within its CI., Tighter alpha should produce wider intervals (more conservative)., hessian_ci works on models fitted to complex G* data. (+24 more)

### Community 334 - "spp.py"
Cohesion: 0.11
Nodes (21): main(), Namespace, Path, SPP (Sequence of Physical Processes) CLI commands.  This module provides command, Run SPP analysis on a single file., Run SPP analysis on multiple files., Save SPP results to file., Main entry point for SPP CLI. (+13 more)

### Community 335 - "compute_diagnostics"
Cohesion: 0.12
Nodes (18): compute_diagnostics(), compute_per_param_diagnostic(), _import_numpyro_diagnostics(), MCMC, ndarray, Bayesian convergence diagnostics: R-hat, ESS, divergence counting.  This module, Compute convergence diagnostics from MCMC samples.      Args:         mcmc: NumP, Lazy-import NumPyro diagnostics functions. (+10 more)

### Community 336 - "RheoJAX GUI Package"
Cohesion: 0.11
...
### Community 337 - "test_trios_chunked.py"
Cohesion: 0.10
Nodes (13): Number of data points used in the fit., _attach_y_data_from_objective(), attach_y_data_to_result(), Any, Create OptimizationResult from NLSQ result dictionary.          Args:, Attach raw y_data and n_data to an OptimizationResult, if missing.      Public h, Attach y_data, n_data, and _use_log_residuals to an OptimizationResult.      Res, OptimizationResult.from_nlsq extraction branches. (+5 more)

### Community 338 - "TestHVNMInterphase"
Cohesion: 0.15
...
### Community 339 - "._predict_from_params"
Cohesion: 0.22
...
### Community 340 - ".result"
Cohesion: 0.08
Nodes (17): _atexit_kill_pools(), PoolFuture, Any, Queue, Persistent process pool for JAX-safe parallel execution.  Long-lived subprocesse, Future-like object for pool task results., Block until result is available, then return it., Check if any worker processes are still running. (+9 more)

### Community 341 - "TestPlotModuliEvolution"
Cohesion: 0.20
...
### Community 342 - "test_spp_golden_parity.py"
Cohesion: 0.15
...
### Community 343 - "TestParameterSet"
Cohesion: 0.07
...
### Community 344 - "MockBayesianModel"
Cohesion: 0.12
Nodes (11): fitted_pipeline(), MockBayesianModel, Simple exponential decay model for testing., Test ArviZ integration with complete workflows., Test complete workflow: load → fit_nlsq → fit_bayesian → plot_*., Test that all plotting methods require Bayesian fit., Test that plot methods return self for chaining., Test that ArviZ plots can be saved to files.          The figure render + savefi (+3 more)

### Community 345 - "TestModeEnum"
Cohesion: 0.07
Nodes (24): HebraudLequeux, Any, ndarray, Return the phase state based on alpha., Get grid parameters based on current or provided sigma_c., Compute adaptive dt and n_steps to cap scan length.          The CFL sub-steppin, Fit HL model parameters to data.          Args:             X: Independent varia, Fit flow curve using derivative-free optimization.          The HL PDE solver ha (+16 more)

### Community 346 - "RheoJAX Architecture Review — 2026-04-06"
Cohesion: 0.07
...
### Community 347 - "TestFMLIKHParameters"
Cohesion: 0.15
Nodes (10): Tests for Carreau-Yasuda model.  This module tests the Carreau-Yasuda model with, Test prediction with RheoData., Test error for wrong test mode., Test numerical stability., Test parameter fitting for CarreauYasuda model., Test model_function for Bayesian inference compatibility., TestCarreauYasudaFitting, TestCarreauYasudaModelFunction (+2 more)

### Community 348 - "TestGMMBayesianInference"
Cohesion: 0.23
...
Cohesion: 0.08
Nodes (18): Apply QSS theme to the QApplication.          When *theme* is ``"auto"``, the re, Map UI theme to default plot style., Detect the current OS color scheme.          Tries ``QStyleHints.colorScheme()``, Handle OS color scheme change.          Re-applies the theme only when the user, Connect View menu actions., main(), RheoJAX GUI Package ==================  Qt-based graphical user interface for Rh, Launch the RheoJAX GUI application.      This is a convenience wrapper that impo (+10 more)

### Community 350 - "PreviewWorker"
Cohesion: 0.14
...
### Community 352 - "TestThermodynamicConsistency"
Cohesion: 0.11
Nodes (11): ndarray, Get parameters as dict with defaults for optional params., Build complete ODE args dict with derived quantities., Predict steady-state flow curve.          At steady state, mu^E -> mu^E_nat and, Predict SAOS storage and loss moduli.          Three Maxwell modes (E, D, I) plu, Simulate startup shear flow with dual TST feedback.          Parameters, Simulate stress relaxation after step strain.          Parameters         ------, Simulate creep under constant stress.          Parameters         ---------- (+3 more)

### Community 353 - "TestModelFunctionCompleteness"
Cohesion: 0.15
...
### Community 354 - "TestShearBandingMetrics"
Cohesion: 0.17
...
### Community 355 - "TestPreprocessRelaxation"
Cohesion: 0.17
...
### Community 356 - "._simulate_laos_internal"
Cohesion: 0.20
...
### Community 358 - "test_optimization_validation.py"
Cohesion: 0.11
...
### Community 359 - "TestStressFormParameter"
Cohesion: 0.11
...
### Community 360 - "TestLAOSAnalysis"
Cohesion: 0.11
...
### Community 362 - "TestProjectStructure"
Cohesion: 0.17
...
### Community 365 - "test_dataset_preview.py"
Cohesion: 0.17
...
### Community 367 - "TestHLModelFunction"
Cohesion: 0.15
Nodes (11): ndarray, Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Predict relaxation modulus G(t).          Theory: G(t) = G0 * exp(-t/tau) where, Predict creep compliance J(t).          Theory: J(t) = 1/G0 + t/eta          Arg, Predict complex modulus G*(omega).          Theory:             G'(omega) = G0 *, Predict steady shear stress sigma(gamma_dot).          Theory: sigma = eta * gam, Test JAX-specific functionality. (+3 more)

### Community 368 - "test_kernels.py"
Cohesion: 0.08
Nodes (30): Array, ndarray, RheoData, Compute mask for selected cycles from time series data.          Parameters, SPP decomposition transform for LAOS stress analysis.      Applies the Sequence, Get computed SPP analysis results.          Returns         -------         dict, Get static and dynamic yield stresses.          Returns         -------, Get nonlinearity quantification metrics.          Returns         ------- (+22 more)

### Community 369 - "._predict"
Cohesion: 0.04
...
### Community 371 - "FractionalZenerSolidLiquid"
Cohesion: 0.19
Nodes (10): FractionalZenerSolidLiquid, ndarray, Initialize Fractional Zener Solid-Liquid model., Predict relaxation modulus G(t).          G(t) = G_e + c_α * t^(-α) * E_{1-α,1}(, Predict creep compliance J(t).          Note: Analytical creep compliance for FZ, Predict complex modulus G*(ω).          G*(ω) = G_e + c_α * (iω)^α / (1 + (iωτ)^, Fit model to data using NLSQ TRF optimization.          Parameters         -----, Predict response for given input.          Parameters         ---------- (+2 more)

### Community 372 - "GiesekusMultiMode"
Cohesion: 0.09
Nodes (12): GiesekusMultiMode, Get solvent viscosity η_s (Pa·s)., Set parameters for a specific mode.          Parameters         ----------, Multi-mode Giesekus nonlinear viscoelastic model.      This model extends the si, Test SAOS prediction., Test startup simulation runs.          Note: Multi-mode ODE has JIT compatibil, Test instantiation with custom number of modes., Test model_function output matches predict_saos for oscillation.          Dive (+4 more)

### Community 373 - "TestVLBTemperature"
Cohesion: 0.17
...
### Community 375 - "check_gpu_availability"
Cohesion: 0.15
...
### Community 376 - "TestVLBVariantRegression"
Cohesion: 0.21
...
### Community 378 - "import_worker.py"
Cohesion: 0.14
Nodes (12): fit_gel_point(), Fit gel strength S and relaxation exponent n from G(t) = S · t^(−n).      Uses l, Tests for rheojax.utils.protocol_preprocessing., Edge cases for gel-point fitting., Without opt-in cleaning, X/y are returned unchanged (diagnostics-only)., Numeric diagnostics stay finite on well-formed inputs., Tests for gel-point fitting., G(t) = S * t^(-n) with known S and n. (+4 more)

### Community 380 - ".predict_rheo"
Cohesion: 0.14
...
### Community 381 - "TestBaseTransform"
Cohesion: 0.08
...
### Community 382 - "TestMLIKHProtocolFitting"
Cohesion: 0.12
...
### Community 384 - "test_loop_bridge.py"
Cohesion: 0.24
...
### Community 386 - "TestComposedVariants"
Cohesion: 0.12
...
### Community 387 - "get_recommended_package"
Cohesion: 0.11
...
### Community 388 - "Fractional Viscoelastic Models: Equation Verification Report"
Cohesion: 0.08
...
### Community 389 - "ProcessCancellationToken"
Cohesion: 0.05
Nodes (26): BaseContext, Exception, ProcessCancellationToken, Event, Store an error that occurred during execution.          Parameters         -----, Get any error that occurred.          Returns         -------         Exception, Wait for cancellation.          Parameters         ----------         timeout :, Cancellation token using multiprocessing.Event for cross-process signaling. (+18 more)

### Community 390 - "create_global_parser"
Cohesion: 0.16
...
### Community 392 - "style_helpers.py"
Cohesion: 0.23
...
### Community 395 - "TestPlotPipkinDiagram"
Cohesion: 0.21
...
### Community 396 - "create_spp_report"
Cohesion: 0.19
...
### Community 399 - "_mittag_leffler_hybrid"
Cohesion: 0.11
...
### Community 402 - "Notebook Validation Tests - Tiered Testing Strategy"
Cohesion: 0.13
...
### Community 404 - "When Analytical SAOS Breaks Down for Transient Network Models and Vitrimers"
Cohesion: 0.11
...
### Community 405 - "export_worker.py"
Cohesion: 0.11
...
### Community 406 - "TestFMLIKHInitialization"
Cohesion: 0.13
...
### Community 407 - "TestFluidityLocalFitting"
Cohesion: 0.18
Nodes (6): ClickableWidget, Path, A QWidget subclass that emits a signal on click and handles keyboard activation., (Re)build the recent projects list from current store state., Refresh recent projects list when the store notifies of a state change., Create a recent project item.

### Community 408 - ".model_function"
Cohesion: 0.14
...
### Community 409 - "pool.py"
Cohesion: 0.20
Nodes (7): PlotWidget, Any, Clear all plot content., Update the plot theme.          Parameters         ----------         theme : st, Thin wrapper holding either a PlotCanvas or PyQtGraphCanvas.      Exposes a unif, Plot data and optional fit result.          Dispatches to the appropriate backen, Get the underlying PlotWidget for advanced customization.

### Community 410 - "TestPlotColeCole"
Cohesion: 0.14
Nodes (8): Tests for plot_cole_cole., Cole-Cole diagram creates single-axis figure., Trajectory mode with time coloring., Scatter mode (show_trajectory=False)., Mismatched G'/G'' lengths raise ValueError., Empty arrays produce a 'No data' text instead of crash., JAX arrays are accepted., TestPlotColeCole

### Community 413 - "TestFractionalZenerSolidSolid"
Cohesion: 0.15
...
### Community 414 - "TestFractionalKelvinVoigtZener"
Cohesion: 0.12
Nodes (14): figure_to_array(), golden_dir(), RheoJAX GUI Visual Regression Tests.  Image-based regression tests for GUI plot, Visual regression tests for MultiView widget., Get or create QApplication instance., Get or create golden images directory., Generate sample sine wave data for plots., Generate sample Maxwell model data. (+6 more)

### Community 415 - "TestLogOperation"
Cohesion: 0.14
...
### Community 416 - "TestLoggerMethods"
Cohesion: 0.14
...
### Community 417 - "TestDMTLocalCreation"
Cohesion: 0.14
...
### Community 418 - "TestDMTLocalCreep"
Cohesion: 0.14
...
### Community 419 - "TestFitPredictRoundtrip"
Cohesion: 0.17
Nodes (7): Test fit->predict roundtrip for transient protocols (TC-005)., Test flow_curve fit -> predict roundtrip., Test startup predict roundtrip with known parameters.          Sets internal sta, Test creep predict roundtrip with known parameters.          Sets internal state, Regression: predict(test_mode='relaxation') must start at sigma_0, not tau_y0., simulate_relaxation → predict roundtrip with sigma_0 kwarg., TestFitPredictRoundtrip

### Community 420 - "TestFluidityNonlocalShearBanding"
Cohesion: 0.09
Nodes (21): Tests for FluidityNonlocal model.  Tests cover instantiation, registry, paramete, Tests for FluidityNonlocal flow curve (steady-state) protocol., Tests for shear banding analysis functionality., Tests for FluidityNonlocal oscillation protocols., Tests for FluidityNonlocal fitting capability., Construction guards and error paths., Direct tests for SAOS fitting and the data-driven seed., Prediction-path error branches and mode routing. (+13 more)

### Community 421 - "TestHVMStartup"
Cohesion: 0.14
...
### Community 423 - "TestGMMCreepMode"
Cohesion: 0.17
...
### Community 424 - "TestGMMOscillationMode"
Cohesion: 0.14
...
### Community 425 - "TestGMMBayesianPipelineBugs"
Cohesion: 0.25
...
### Community 426 - "TestThixotropy"
Cohesion: 0.14
Nodes (10): Tests for Generalized Maxwell Model (GMM).  Test coverage: - Task Group 1.2: GMM, Test GMM steady-shear (flow curve) protocol., Linear GMM steady-shear fit yields constant η = η₀ = ΣGᵢτᵢ., Predicting with test_mode='flow_curve' uses the steady-shear path., Test GMM startup flow (stress growth) protocol., η⁺(t) prediction matches Σ Gᵢτᵢ(1-exp(-t/τᵢ)) closed form., Fitting startup data runs and yields a physical η⁺(t) response.          The lin, Element minimization runs for over-parameterized startup fit. (+2 more)

### Community 428 - "TestInstantiation"
Cohesion: 0.07
Nodes (27): Tests for TNTMultiSpecies model.  Tests cover: - Instantiation and parameter, Verify TNTMultiSpecies recovers multi-mode Maxwell (generalized UCM).      For, Tests for flow curve (steady shear) predictions., Tests for model instantiation and parameters., Tests for SAOS predictions., Tests for startup flow simulation., Tests for stress relaxation simulation., Tests for LAOS simulation. (+19 more)

### Community 429 - "TestMittagLefflerComplexArguments"
Cohesion: 0.15
...
### Community 430 - "TestISMCreepVolterra"
Cohesion: 0.22
...
### Community 431 - "TestCreepSimulation"
Cohesion: 0.17
...
### Community 432 - "TestPreprocessOscillation"
Cohesion: 0.06
Nodes (22): AboutDialog, QWidget, Handle dialog show event., Handle link clicks.          Parameters         ----------         url : QUrl, About dialog with version info.      Content:         - RheoJAX version and logo, Initialize about dialog.          Parameters         ----------         parent :, Set up user interface., RheoJAX GUI Menu Actions Tests.  Regression tests ensuring all menu bar actions (+14 more)

### Community 433 - "TestTensorialAnimation"
Cohesion: 0.18
Nodes (8): Unit tests for BayesianMixin internal helpers and orchestration wiring.  These t, A model-provided _validate_test_mode hook handles special strings., Missing 'parameters' attribute raises a clear AttributeError., Has 'parameters' but no 'model_function' raises AttributeError., test_resolve_test_mode_uses_validate_hook(), test_sample_prior_missing_parameters_raises(), test_validate_requirements_missing_model_function(), test_validate_requirements_missing_parameters()

### Community 434 - ".confidence_intervals"
Cohesion: 0.12
Nodes (8): Simulate stress relaxation after cessation of steady shear.          Analytical, Get relaxation modulus G(t).          For multi-species TNT: G(t) = Σ G_i·exp(-t, Return string representation., Get G_modes and tau_modes as JAX arrays.          Returns         -------, Get total modulus G_total = Σ G_i (Pa)., Get zero-shear viscosity η₀ = Σ G_i·τ_b_i + η_s (Pa·s)., Predict SAOS storage and loss moduli.          Analytical superposition:, Predict first and second normal stress differences.          For multi-mode UCM

### Community 435 - "._apply_theme"
Cohesion: 0.12
...
### Community 437 - "plot_3d_trajectory"
Cohesion: 0.19
...
### Community 438 - "micro_benchmarks.py"
Cohesion: 0.24
...
### Community 440 - "TestIdentifiabilityAPI"
Cohesion: 0.15
...
### Community 441 - "TestFluidityPredictWithoutFit"
Cohesion: 0.24
...
### Community 444 - "TestVLBNonlocalCreation"
Cohesion: 0.15
...
### Community 445 - "Giesekus Model Mathematical Verification Report"
Cohesion: 0.17
...
### Community 446 - "CancelWorkerRunnable"
Cohesion: 0.17
Nodes (9): estimate_eta0(), Estimate zero-shear viscosity from the Newtonian plateau.      Uses the lowest 1, Edge cases for zero-shear viscosity estimation., When both eta and sigma given, eta is used., n_low clamps to array length for tiny inputs., Lowest shear rates selected regardless of input order., Tests for zero-shear viscosity estimation., TestEstimateEta0 (+1 more)

### Community 447 - "compute_gl_weights"
Cohesion: 0.20
Nodes (5): Bayesian Information Criterion.          BIC = k*ln(n) + n*ln(RSS/n)          wh, Compute parameter confidence intervals.          Parameters         ----------, Compute prediction intervals for new x values.          Prediction intervals acc, Resolve the true observation count N.          Priority: n_data > len(y_data) >, Akaike Information Criterion.          AIC = 2k + n*ln(RSS/n)          where k i

### Community 448 - "TestPlasticityAlpha"
Cohesion: 0.12
...
### Community 449 - "TestVLBNonlocalHomogeneous"
Cohesion: 0.20
...
### Community 451 - "f12_memory_kernel"
Cohesion: 0.12
...
### Community 454 - "TestRheoJAXLogger"
Cohesion: 0.17
Nodes (7): Tests for RheoJAXLogger class., Test basic logger creation., Test logger with default extra context., Test bind creates new logger with merged context., Test bind overwrites existing context keys., Test process extracts non-standard kwargs to extra., TestRheoJAXLogger

### Community 455 - "TestDMTLocalStartup"
Cohesion: 0.17
...
### Community 456 - "TestF002KwargsCache"
Cohesion: 0.17
...
### Community 457 - "TestFluidityLocalOscillation"
Cohesion: 0.17
...
### Community 458 - "TestFluidityNonlocalSmoke"
Cohesion: 0.17
...
### Community 459 - "giesekus_steady_normal_stresses"
Cohesion: 0.17
...
### Community 460 - "test_multi_mode.py"
Cohesion: 0.08
...
### Community 462 - "TestFractionalBurgersModel"
Cohesion: 0.14
Nodes (10): PlotMetrics, Any, Clear all collected metrics., Track plot rendering performance metrics.      This class collects timing data f, Execute a render function with timing.          Parameters         ----------, Record a plot rendering duration.          Parameters         ----------, Get statistics for a plot type.          Parameters         ----------         p, Get statistics for all plot types.          Returns         -------         dict (+2 more)

### Community 463 - "TestHVMFlowCurve"
Cohesion: 0.17
...
### Community 464 - "TestFractionalPoyntingThomson"
Cohesion: 0.17
...
### Community 465 - "TestISMOscillationAnalytic"
Cohesion: 0.17
...
### Community 466 - "TestITTMCTSchematicInitialization"
Cohesion: 0.17
...
### Community 467 - "TestGMMRelaxationMode"
Cohesion: 0.17
...
### Community 468 - "TestGMMElementMinimization"
Cohesion: 0.17
...
### Community 469 - "TestShearBandingDetection"
Cohesion: 0.20
...
### Community 473 - "TestPhysicalConsistency"
Cohesion: 0.19
...
### Community 475 - "TestFENEVariant"
Cohesion: 0.11
Nodes (17): Tests for TNTSingleMode model.  Tests cover: - Instantiation and parameter ma, Tests for flow curve (steady shear) predictions., Tests for SAOS predictions., Tests for stress relaxation simulation., Tests for LAOS simulation., Tests for BayesianMixin compatibility., Tests for model fitting., Tests for analysis helper methods. (+9 more)

### Community 476 - "TestFractionalJeffreysModel"
Cohesion: 0.13
...
### Community 477 - "TestTriosChunkedBasic"
Cohesion: 0.13
...
### Community 478 - "TestHerschelBulkleyNumericalStability"
Cohesion: 0.14
...
### Community 479 - "Material Classification"
Cohesion: 0.18
...
### Community 480 - "NamedTuple"
Cohesion: 0.20
Nodes (6): Test Arrhenius viscosity calculation., Test η(T_ref) = η_ref., Test viscosity decreases with temperature., Test E_a = 0 gives constant viscosity., Test with typical polymer melt parameters., TestArrheniusViscosity

### Community 481 - "TestModelInfo"
Cohesion: 0.14
...
### Community 482 - "._confirm_unsaved_changes"
Cohesion: 0.18
Nodes (6): QCloseEvent, Handle new file action., Handle open file action., Handle save file action.          Returns         -------         bool, Prompt to save/discard/cancel when there are unsaved changes.          Shared by, Handle window close event with cleanup.          Parameters         ----------

### Community 483 - "TestFlowCurveFitting"
Cohesion: 0.22
Nodes (6): ndarray, Detect and remove outliers (first point) if it improves fit.          Following, Compute shift factor between two adjacent curves via intersection.          Uses, Compute automatic shift factors via sequential pairwise power-law intersection., Get automatic shift factors as arrays for plotting.          Returns         ---, Get shift factors as arrays for plotting and analysis.          Parameters

### Community 484 - "TestModelInstantiation"
Cohesion: 0.14
...
### Community 485 - "TestFluidityLocalTransient"
Cohesion: 0.14
...
### Community 489 - "TestStartupSimulation"
Cohesion: 0.20
...
### Community 490 - "test_window_file_menu.py"
Cohesion: 0.35
Nodes (10): test_maybe_confirm_unsaved_clean_state_proceeds_without_dialog(), test_maybe_confirm_unsaved_discard_still_proceeds(), test_maybe_confirm_unsaved_save_blocked_by_active_jobs_warns_and_aborts(), test_maybe_confirm_unsaved_save_cancelled_does_not_proceed(), test_maybe_confirm_unsaved_save_success_proceeds(), test_on_close_reaches_confirmed_close_after_discarding_unsaved_changes(), test_on_open_shows_critical_dialog_on_value_error(), test_on_save_as_shows_critical_dialog_on_os_error() (+2 more)

### Community 491 - "TestRelaxationSimulation"
Cohesion: 0.14
Nodes (13): Regression tests for the shared unsaved-changes guard on File>New/Open/Open Rece, LOAD_PROJECT's reducer never restores datasets/results in this legacy     window, SAVE_PROJECT's reducer only clears is_modified -- it writes nothing to     disk, File>New must NOT dispatch NEW_PROJECT if the user picks Save and it fails., File>New dispatches NEW_PROJECT once the chosen Save actually succeeds., File>Open must prompt for unsaved changes before replacing the project., Open Recent must prompt for unsaved changes before replacing the project., test_auto_save_does_not_dispatch_save_project() (+5 more)

### Community 492 - "TestGetLogger"
Cohesion: 0.17
...
### Community 493 - "TestBayesianInterface"
Cohesion: 0.14
...
### Community 495 - "TestHVNMFlowCurve"
Cohesion: 0.18
...
### Community 496 - "TestHVNMRelaxation"
Cohesion: 0.18
...
### Community 497 - "TestVLBUtilities"
Cohesion: 0.20
...
### Community 498 - "TestDerivedProperties"
Cohesion: 0.20
Nodes (6): Tests for local fluidity calculation., Test fluidity is very small below yield stress., Test fluidity is positive above yield stress., Test fluidity increases with stress above yield., Test fluidity is symmetric for positive/negative stress., TestFluidityKernelsFLoc
...
### Community 500 - "Classical Linear Viscoelastic Model Equations -- Verification Reference"
Cohesion: 0.20
...
### Community 501 - "RheoJAX Documentation Structure"
Cohesion: 0.20
...
### Community 502 - "TestSPPPlotEdgeCases"
Cohesion: 0.20
...
### Community 503 - "TestUpperConvected"
Cohesion: 0.20
...
### Community 504 - "TestYieldStressCoupling"
Cohesion: 0.20
...
### Community 505 - "TestVonMisesStress"
Cohesion: 0.20
...
### Community 507 - "run_all_notebooks.py"
Cohesion: 0.29
...
### Community 508 - "TestTemplateStyles"
Cohesion: 0.20
Nodes (6): Test template style application., Test applying default style., Test applying publication style., Test applying presentation style., Test that invalid style falls back to default., TestTemplateStyles

### Community 509 - ".get_dataframe"
Cohesion: 0.14
...
### Community 510 - "._predict_stress"
Cohesion: 0.08
Nodes (25): Tests for TNTStickyRouse model.  Tests cover: - Instantiation and parameter m, Tests for sticker floor constraint: tau_eff_k = max(tau_R_k, tau_s)., Tests for flow curve (steady shear) predictions., Tests for SAOS predictions., Tests for startup flow simulation., Tests for stress relaxation simulation., Tests for creep simulation., Tests for LAOS simulation. (+17 more)
...
### Community 512 - ".from_json"
Cohesion: 0.33
Nodes (4): Create OptimizationResult from NLSQ 0.6.6 CurveFitResult.          This factory, OptimizationResult.from_curve_fit_result factory branches., _Stub, TestFromCurveFitResult

### Community 513 - "TestDMTLocalRelaxation"
Cohesion: 0.07
Nodes (23): Any, RheoData, Validate data for transform.          Parameters         ----------         name, Get configurable parameters for transform.          Parameters         ---------, Return display metadata for all transforms.          Returns         -------, Apply transform and return new data.          Parameters         ----------, Compute transform and return plot data for preview.          Parameters, Recover relaxation spectrum H(τ) from viscoelastic data.      Args:         meth (+15 more)

### Community 514 - "TestDMTLocalLAOS"
Cohesion: 0.20
...
### Community 516 - "TestHelperMethods"
Cohesion: 0.14
...
### Community 518 - "TestFluidityLocalSmoke"
Cohesion: 0.24
Nodes (7): check_plugin_conflicts(), _print_gpu_warning(), GPU detection and warning utilities for RheoJAX (System CUDA version).  This mod, Check for known JAX CUDA plugin conflicts.      Returns     -------     list[str, Print warning about GPU acceleration availability., Plugin-conflict detection with mocked importlib.metadata., TestCheckPluginConflicts

### Community 519 - "TestFluidityLocalFlowCurve"
Cohesion: 0.25
Nodes (5): F-IO-012: detect_test_mode should tolerate small noise in monotonic data., Relaxation data with 2% noise should still be detected., Creep data with a few non-monotonic points should still be detected.          Th, Strictly monotonic data should still be detected correctly., TestMonotonicDetectionWithNoise

### Community 520 - "TestFluidityNonlocalTransient"
Cohesion: 0.20
...
### Community 521 - "TestFluidityNonlocalGrid"
Cohesion: 0.25
...
### Community 522 - "giesekus_steady_shear_viscosity"
Cohesion: 0.20
...
### Community 523 - "giesekus_saos_moduli"
Cohesion: 0.20
...
### Community 527 - "TestDMTLocalFlowCurve"
Cohesion: 0.17
...
### Community 528 - "TestHVMRelaxation"
Cohesion: 0.17
...
### Community 529 - "TestBinghamStability"
Cohesion: 0.20
...
### Community 531 - "TestISMInitialization"
Cohesion: 0.20
...
### Community 532 - "TestTieredPriorConstruction"
Cohesion: 0.20
...
### Community 533 - "TestCatesMaxwellLimit"
Cohesion: 0.20
...
### Community 535 - "TestStartupSimulation"
Cohesion: 0.20
...
### Community 536 - "TestCreepSimulation"
Cohesion: 0.20
...
### Community 538 - "TestPhysicalConsistency"
Cohesion: 0.20
...
### Community 541 - "TestHerschelBulkleyRheoData"
Cohesion: 0.08
Nodes (24): _cleanup_jit_caches(), Tests for TNTLoopBridge model.  Tests cover: - Instantiation and parameter ma, Tests for flow curve (steady shear) predictions., Tests for SAOS predictions., Free JIT caches after each test to prevent xdist worker OOM.      TNT loop_bri, Tests for stress relaxation simulation., Tests for model instantiation and parameters., Tests for BayesianMixin compatibility. (+16 more)

### Community 542 - "TestCreepSimulation"
Cohesion: 0.20
...
### Community 543 - "TestLAOSSimulation"
Cohesion: 0.20
...
### Community 544 - "TestBayesianInterface"
Cohesion: 0.25
...
### Community 550 - "TestMaxwellLimits"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (5): Test yield stress increases with structure parameter., Test yield stress depends on temperature., Test thermal yield stress calculation., Test σ_y at T_ref with λ=1, m_y=1., TestThermalYieldStress

### Community 553 - "TestVLBNonlocalProtocols"
Cohesion: 0.20
...
### Community 554 - "TestVLBLocalFlowCurve"
Cohesion: 0.25
...
### Community 555 - "TestVLBLocalStartup"
Cohesion: 0.25
...
### Community 556 - "TestVLBLocalSAOS"
Cohesion: 0.25
...
### Community 557 - "TestVLBCrossProtocol"
Cohesion: 0.27
...
### Community 558 - "TestPowerLawRheoData"
Cohesion: 0.20
...
### Community 559 - "TestThixotropicOvershoot"
Cohesion: 0.36
...
### Community 560 - "TestMittagLefflerJAXCompatibility"
Cohesion: 0.20
...
### Community 561 - "TestCreepBifurcation"
Cohesion: 0.25
...
### Community 562 - "TestJAXCompatibility"
Cohesion: 0.20
...
### Community 563 - "TestYieldStressEmergence"
Cohesion: 0.20
...
### Community 564 - "TestNonexponentialRelaxation"
Cohesion: 0.24
...
### Community 565 - "TestFluidityNonlocalOscillation"
Cohesion: 0.25
...
### Community 566 - "TestMIKHBayesian"
Cohesion: 0.17
...
### Community 567 - "TestPlotRheoData"
Cohesion: 0.20
Nodes (6): Test plotting with custom matplotlib kwargs., Test plotting rotation (flow curve) data., Test plot_rheo_data automatic plot type selection., Test plotting time-domain data., Test plotting frequency-domain data., TestPlotRheoData

### Community 568 - "test_spp_plots.py"
Cohesion: 0.14
Nodes (11): laos_signals(), Tests for SPP (Sequence of Physical Processes) visualization module.  Covers a, Render and save a matplotlib figure in a fresh interpreter.      This host's m, Report can be saved to disk., Gap-5: create_spp_report uses strain_rate_normalized when present., When strain_rate_normalized is provided, it overrides computed rate., Generate synthetic LAOS signals (1 cycle)., Generate synthetic SPP analysis results dict. (+3 more)

### Community 569 - "RheoJAX Documentation"
Cohesion: 0.22
...
### Community 570 - "📖 Documentation Structure"
Cohesion: 0.22
...
### Community 571 - "._predict_viscosity"
Cohesion: 0.25
...
### Community 572 - "TestMLIKHSAOSFrequencyFit"
Cohesion: 0.17
...
### Community 573 - "TestFlowCurveProtocol"
Cohesion: 0.16
Nodes (7): ArrayLike, Compute residual sum of squares (RSS).      Handles both real and complex data c, residual_sum_of_squares(), residual_sum_of_squares JAX and NumPy branches., Test that residual_sum_of_squares handles complex data correctly., Test that complex fitting gives same result as manually split real/imag., TestResidualSumOfSquaresBranches

### Community 574 - "TestModulusLabels"
Cohesion: 0.33
...
### Community 575 - "TestGlassTransition"
Cohesion: 0.25
...
### Community 577 - "TestPowerLawPredictions"
Cohesion: 0.20
...
### Community 578 - "_simulate_nonlocal_creep"
Cohesion: 0.25
...
### Community 581 - "TestIKHKernels"
Cohesion: 0.20
Nodes (6): Tests for IKH kernels directly., Test lambda evolution reaches equilibrium., Test return mapping in elastic regime., Test return mapping in plastic regime., Test steady-state flow curve kernel including backstress saturation., TestIKHKernels

### Community 582 - "TestStickerFloorPhysics"
Cohesion: 0.25
Nodes (5): Tests for Laplacian with Neumann boundary conditions., Test Laplacian of constant field is zero., Test Laplacian of linear field is zero in interior., Test Laplacian of quadratic is constant., TestFluidityKernelsLaplacian

### Community 583 - "SPP Parity Reference (MATLAB SPPplus v2.1, R oreo, RheoJAX)"
Cohesion: 0.25
...
### Community 584 - "TestSAOS"
Cohesion: 0.25
Nodes (5): Smoke tests for basic kernel functionality., Test f_loc_herschel_bulkley returns scalar output., Test Laplacian returns same shape as input., Test local ODE RHS returns correct shape., TestFluidityKernelsSmoke

### Community 585 - "build_numpyro_model"
Cohesion: 0.18
...
### Community 586 - "herschel_bulkley_viscosity"
Cohesion: 0.25
...
### Community 587 - "TestLAOSSimulation"
Cohesion: 0.25
...
### Community 589 - ".simulate_steady_shear"
Cohesion: 0.25
...
### Community 591 - "TestMonotonicityChecks"
Cohesion: 0.25
...
### Community 592 - "TestVLBBellFeneCombined"
Cohesion: 0.25
Nodes (5): Test mastercurve plotting template., Test plotting a single mastercurve., Test plotting mastercurve with multiple temperatures., Test that an empty dataset list raises ValueError., TestMastercurveTemplate

### Community 593 - "TestDataIntegrity"
Cohesion: 0.25
...
### Community 594 - "TestVLBVariantBayesian"
Cohesion: 0.29
...
### Community 595 - "TestArviZIntegration"
Cohesion: 0.25
...
### Community 596 - "TestPreprocessForProtocol"
Cohesion: 0.17
...
### Community 597 - "TestEquilibriumStructure"
Cohesion: 0.17
Nodes (7): Tests for ODE right-hand-side functions., Test stress rate is positive when gamma_dot > sigma*f., Test fluidity relaxes toward f_eq at rest., Test strain rate is positive under positive stress., TC-027: Test ODE RHS with realistic (non-trivial) initial stress., TC-027: Test ODE RHS when stress is above equilibrium (should relax)., TestFluidityKernelsODERHS

### Community 598 - "TestDMTLocalSAOS"
Cohesion: 0.25
...
### Community 599 - "TestFitOscillation"
Cohesion: 0.29
...
### Community 600 - "TestThermalYieldStress"
Cohesion: 0.17
...
### Community 601 - "TestTemperatureEvolution"
Cohesion: 0.17
...
### Community 602 - "TestSteadyStateFlowCurve"
Cohesion: 0.33
...
### Community 604 - "TestTensorialFieldPlots"
Cohesion: 0.05
Nodes (20): Comprehensive tests for Fractional Zener Family and Advanced Fractional Models (, Test parameter initialization., Test creep compliance., Test relaxation modulus., Test that FPT and FKVZ have identical mathematical forms., Test parameter initialization., Test relaxation modulus., Test complex modulus. (+12 more)

### Community 605 - "TestNormalStressPlots"
Cohesion: 0.17
Nodes (7): Physics checks for the Volterra (history-integral) creep solver., J(t) is monotone non-decreasing and J(t->0) -> 1/G(0)., Glass: long-time compliance reaches the inverse plateau 1/G_inf., Fluid: late-time J(t) -> t/eta with eta = sum(g_i tau_i) = int G dt., G(t) from Prony modes matches the direct MCT k-integral proxy., Linear-regime compliance does not depend on applied stress., TestISMCreepVolterra

### Community 606 - "TestFluidityNonlocalFlowCurve"
Cohesion: 0.33
...
### Community 607 - "test_bayesian.py"
Cohesion: 0.06
...
### Community 613 - "TestMastercurveTemplate"
Cohesion: 0.33
...
### Community 615 - "._run_nuts_sampling"
Cohesion: 0.17
...
### Community 616 - ".save"
Cohesion: 0.10
Nodes (12): Internal transform implementation to be overridden by subclasses.          Args:, Internal inverse transform implementation.          Args:             data: Tran, Transform the data.          Args:             data: Input data (RheoData or lis, Apply inverse transformation.          Args:             data: Transformed data, Fit the transform to data (learn parameters if needed).          Args:, Fit to data and transform it.          Args:             data: Input data (RheoD, Apply all transforms in sequence.          Args:             data: Input data (R, Apply inverse transforms in reverse order.          Args:             data: Tran (+4 more)

### Community 617 - ".predict_rheo"
Cohesion: 0.25
...
### Community 621 - "TestIKHProtocols"
Cohesion: 0.25
...
### Community 622 - "TestCombinedFeatures"
Cohesion: 0.25
...
### Community 623 - "TestConvergenceClassification"
Cohesion: 0.25
...
### Community 625 - "TestRelaxationSimulation"
Cohesion: 0.33
...
### Community 626 - "TestBayesianInterface"
Cohesion: 0.33
...
### Community 630 - "TestLAOSSimulation"
Cohesion: 0.24
...
### Community 632 - "test_single_mode.py"
Cohesion: 0.33
...
### Community 633 - "TestBayesianInterface"
Cohesion: 0.33
...
### Community 634 - "TestVLBNonlocalBanding"
Cohesion: 0.25
...
### Community 635 - "TestVLBLocalLAOS"
Cohesion: 0.33
...
### Community 636 - "TestVLBLocalExtension"
Cohesion: 0.33
Nodes (4): Test stress-strain plotting template., Test stress relaxation plot., Test creep compliance plot., TestStressStrainTemplate

### Community 637 - "TestInferenceDataConversion"
Cohesion: 0.27
...
### Community 639 - "ModelComparisonPipeline"
Cohesion: 0.07
...
### Community 643 - "._on_state_changed"
Cohesion: 0.29
...
### Community 647 - "print_device_summary"
Cohesion: 0.50
Nodes (3): Tests for log_transform context manager., Test that transform-specific context is logged., TestLogTransform

### Community 648 - "TestDMTRegistry"
Cohesion: 0.07
Nodes (11): Get list of all registered model names.          Returns:             List of mo, List all registered model names (discovery).          Returns:             List, Test listing models when none registered., Verify expected number of models are registered., Test both SGR models are properly registered and can be instantiated., Test SGRConventional can be instantiated and has correct structure., Test DMTLocal is in registry., Test DMTNonlocal is in registry. (+3 more)

### Community 649 - "TestNonlocalModelFunction"
Cohesion: 0.25
...
### Community 650 - "TestNonlocalIdentifiabilityAPI"
Cohesion: 0.29
...
### Community 651 - "TestVLBLocalRelaxation"
Cohesion: 0.50
Nodes (3): Tests for log_io context manager., Test that I/O-specific context is logged., TestLogIO

### Community 652 - "TestVLBLocalCreep"
Cohesion: 0.29
Nodes (4): Test VLBLocal creep compliance., J(t) = (1 + k_d*t) / G0 for Maxwell., dJ/dt = k_d/G0 = 1/eta., TestVLBLocalCreep

### Community 653 - "TestExportFormats"
Cohesion: 0.12
Nodes (11): Test export to different file formats., Test export to PNG format., Render and save a matplotlib figure in a fresh interpreter.      This host's mat, Test export to PDF format., Test export to SVG format., Tests for save_figure function., Test saving a figure to PDF format., Test saving a figure to PNG format. (+3 more)

### Community 654 - "generate_synthetic_trios_file"
Cohesion: 0.50
Nodes (3): Tests for log_pipeline_stage context manager., Test that pipeline-specific context is logged., TestLogPipelineStage

### Community 655 - "SPP Parity Status (MATLAB SPPplus v2.1 / R oreo / RheoJAX)"
Cohesion: 0.33
...
### Community 658 - "TestBinghamRheoData"
Cohesion: 0.50
Nodes (3): Test thermal yield stress fix (F-007)., Verify yield stress doesn't apply λ twice., TestFIKHThermalYieldStress

### Community 659 - ".__init__"
Cohesion: 0.33
Nodes (4): BreakageType, StressType, Initialize VLBNonlocal model., Initialize ParameterSet for nonlocal model.

### Community 660 - "TestModeEnum"
Cohesion: 0.33
Nodes (4): Test TestMode enumeration., Test TestMode enum values., Test converting string to TestMode., TestModeEnum

### Community 661 - "TestMLIKHWeightedSumTransients"
Cohesion: 0.20
...
### Community 662 - "TestPreprocessStartup"
Cohesion: 0.50
...
### Community 663 - "capture_golden_screens.py"
Cohesion: 0.53
...
### Community 664 - "_LazyModule"
Cohesion: 0.67
Nodes (3): QWidget, Apply standard page-level margins (PAGE_MARGIN on all sides).      Use for top-l, set_page_margins()

### Community 665 - "TestYAMLInjection"
Cohesion: 0.33
...
### Community 666 - "TestJSONSerialization"
Cohesion: 0.20
...
### Community 668 - "TestCSVRoundTrip"
Cohesion: 0.20
...
### Community 673 - "._predict_creep_jit"
Cohesion: 0.20
...
### Community 677 - "TestFitRelaxation"
Cohesion: 0.20
...
### Community 678 - "TestSteadyStateTemperature"
Cohesion: 0.20
...
### Community 679 - "TestAdiabaticTemperatureRise"
Cohesion: 0.20
...
### Community 682 - "TestNonlocalFlowCurve"
Cohesion: 0.33
...
### Community 685 - "TestBinghamPhysicalBehavior"
Cohesion: 0.20
...
### Community 686 - "TestHerschelBulkleyBasics"
Cohesion: 0.20
...
### Community 688 - "upper_convected_derivative_2d"
Cohesion: 0.22
...
### Community 693 - "TestStartupFitting"
Cohesion: 0.22
...
### Community 694 - "TestCreepFitting"
Cohesion: 0.28
...
### Community 697 - "TestStartupProtocol"
Cohesion: 0.33
...
### Community 700 - "TestRegistryIntegration"
Cohesion: 0.22
Nodes (4): Test damage behavior., With damage params at zero, result matches damage-off., Matrix and interfacial damage are independent flags., TestHVNMDamage
...
### Community 707 - "TestEarlyTermination"
Cohesion: 0.39
Nodes (3): detect_delimiter(), Detect delimiter (tab vs comma) from file content.      TRIOS CSV files typicall, TestDetectDelimiter

### Community 708 - "TestMultiModeRepresentation"
Cohesion: 0.09
Nodes (27): ArrayLike, Compute post-fit uncertainty estimates.          Args:             model: Fitted, _assert_fitted(), bootstrap_ci(), hessian_ci(), _jacobian_fallback_pcov(), _n_obs(), _param_names() (+19 more)

### Community 709 - "TestPublicAPI"
Cohesion: 0.33
...
### Community 710 - "TestAnalysisMethods"
Cohesion: 0.33
...
### Community 714 - "TestPlotFrequencyDomain"
Cohesion: 0.33
...
### Community 715 - "TestPlotFlowCurve"
Cohesion: 0.33
...
### Community 716 - "TestPlotResiduals"
Cohesion: 0.33
...
### Community 717 - "TestPublicationQuality"
Cohesion: 0.33
...
### Community 720 - "TestPlotAutocorr"
Cohesion: 0.25
...
### Community 738 - "test_visual_regression_spec_scaffold.py"
Cohesion: 0.50
...
### Community 739 - ".test_conventional_generic_oscillation_match"
Cohesion: 0.50
...
### Community 740 - "._validate_parameter_bounds"
Cohesion: 0.25
...
### Community 744 - "TestBayesianIntegration"
Cohesion: 0.50
...
### Community 745 - "TestNLSQDiagnostics"
Cohesion: 0.50
...
### Community 746 - "_get_simulation_ids"
Cohesion: 0.25
...
### Community 748 - "._make_error_result"
Cohesion: 0.25
...
### Community 749 - "TestCarreauYasudaPredictions"
Cohesion: 0.25
...
### Community 762 - "TestBinghamModelFunction"
Cohesion: 0.25
Nodes (5): Test GMM LAOS protocol (linear model = SAOS response)., LAOS fit on linear model reproduces the oscillation fit., simulate_laos returns consistent t, strain, stress arrays., Linear GMM LAOS response has negligible I_3/I_1 (no nonlinearity)., TestGMMLaosMode

### Community 776 - "TestPowerLawBasics"
Cohesion: 0.25
...
### Community 777 - "TestPowerLawNumericalStability"
Cohesion: 0.25
...
### Community 778 - "TestPowerLawPerformance"
Cohesion: 0.33
...
### Community 794 - "TestVLBBellPhysics"
Cohesion: 0.11
...
### Community 795 - "TestVLBFenePhysics"
Cohesion: 0.25
Nodes (5): Test (N, 2) [G', G''] input format for create_least_squares_objective., (N, 2) real input should produce same residuals as complex G*., (N, 2) input with use_log_residuals=True should work correctly., FIKH/FMLIKH is_stacked branch should handle (N, 2) input., TestStackedInputFormat

### Community 797 - "TestHerschelBulkleyModelFunction"
Cohesion: 0.25
Nodes (5): Tests for the preprocess_for_protocol dispatcher., Unknown test_mode returns data unchanged, no diagnostics., Each known mode returns a PreprocessingResult without raising., Integer X is coerced to float64., TestPreprocessForProtocol

### Community 798 - "TestGMMBayesianPriorSafetyIntegration"
Cohesion: 0.25
...
### Community 801 - "TestAnalysisMethods"
Cohesion: 0.06
Nodes (34): PlotDataItem, is_pyqtgraph_available(), floating, NDArray, PyQtGraphCanvas, PyQtGraph Canvas Widget for GPU-Accelerated Plotting.  This module provides GPU-, Handle scale selection change., Set logarithmic scale for axes.          Parameters         ----------         x (+26 more)

### Community 802 - "conftest.py"
Cohesion: 0.29
...
### Community 819 - "TestArviZAvailability"
Cohesion: 0.33
Nodes (4): BayesianResult, RheoData, Perform Bayesian inference using NumPyro NUTS sampler.          This method dele, Get stored Bayesian inference result.          Returns:             BayesianResu

### Community 893 - "TestFractionalModelsRelaxation"
Cohesion: 0.29
Nodes (4): Initialize F₁₂ Schematic Model.          Parameters         ----------         e, Get critical v₂ value for glass transition.          Parameters         --------, Get separation parameter ε = (v₂ - v₂_c)/v₂_c., Set separation parameter and update v₂ accordingly.

### Community 894 - "TestSimulationProtocols"
Cohesion: 0.38
...
### Community 901 - "TestLegacyNamesRejected"
Cohesion: 0.38
...
### Community 903 - ".get_credible_intervals"
Cohesion: 0.38
...
### Community 2049 - ".test_export_directory_summary_content"
Cohesion: 0.33
...
### Community 2051 - ".test_export_directory_with_figures"
Cohesion: 0.33
...
### Community 2052 - ".test_export_directory_npz_format"
Cohesion: 0.33
Nodes (5): contains_emoji(), emoji_checker(), Check if text contains emoji characters.      Parameters     ----------     text, Provide emoji detection function.      Returns     -------     Callable, Verify emoji detection function correctly identifies emoji.

### Community 2053 - ".test_summary_txt_content"
Cohesion: 0.33
Nodes (4): Visual regression tests for PlotCanvas widget., Get or create QApplication instance., cleanup() must still close the Figure when the C++ canvas widget         is alre, TestPlotCanvasVisual

### Community 2054 - ".test_export_excel_basic"
Cohesion: 0.33
...
### Community 2056 - ".test_export_excel_parameters_content"
Cohesion: 0.14
Nodes (9): Unit tests for FMLIKH (multi-layer FIKH) model.  Tests cover: - Multi-mode initi, Test FMLIKH mode information utilities., Test get_mode_info returns correct structure., Test get_mode_info with per-mode alpha., Test FMLIKH model_function for Bayesian inference., Test model_function for startup., Test model_function for flow curve., TestFMLIKHModeInfo (+1 more)

### Community 2057 - ".test_export_excel_with_transforms"
Cohesion: 0.33
...
### Community 2058 - ".test_plot_autocorr_without_bayesian_fit_raises_error"
Cohesion: 0.33
...
### Community 2059 - ".test_fit_nlsq_with_model_instance"
Cohesion: 0.33
...
### Community 2060 - ".test_fit_bayesian_after_nlsq"
Cohesion: 0.33
...
### Community 2061 - ".test_fit_bayesian_without_nlsq_raises_error"
Cohesion: 0.33
...
### Community 2062 - ".test_complete_workflow_chaining"
Cohesion: 0.33
...
### Community 2064 - ".test_multichain_improves_rhat"
Cohesion: 0.33
...
### Community 2065 - "test_numerical_derivative_second_order_sinusoid"
Cohesion: 0.33
...
### Community 2066 - "test_numerical_derivative_periodic_matches_analytic"
Cohesion: 0.33
...
### Community 2067 - "test_spp_numerical_analysis_linear_material"
Cohesion: 0.33
...
### Community 2070 - "test_compute_phase_offset_zero_for_pure_sine"
Cohesion: 0.33
...
### Community 2072 - "test_spp_numerical_analysis_includes_moduli_rates"
Cohesion: 0.33
...
### Community 2081 - "EPMBase"
Cohesion: 0.50
Nodes (3): Create unfilled vitrimer (phi=0, recovers HVM exactly).          Parameters, HVNM with phi=0 (should recover HVM)., unfilled_model()

### Community 2088 - "HVNMBase"
Cohesion: 0.50
Nodes (3): Generate performance_benchmarks.md report., Create markdown table with performance benchmark results., TestGeneratePerformanceReport

### Community 2090 - "ITTMCTBase"
Cohesion: 0.50
Nodes (3): Visual regression tests for ArvizCanvas widget.      Note: Full ArviZ plots requ, Get or create QApplication instance., TestArvizCanvasVisual

### Community 2091 - "STZBase"
Cohesion: 0.50
...
### Community 2093 - "TestGMMBayesianPriorSafetyIntegration"
Cohesion: 0.50
...
### Community 2212 - ".test_simulate_creep"
Cohesion: 0.20
...
## Knowledge Gaps
- **636 isolated node(s):** `$schema`, `title`, `description`, `type`, `type` (+631 more)
...
- **Why does `ModelRegistry` connect `OWChirp` to `safe_import_jax`, `RheoData`, `TestDMTLocalLAOS`, `Pipeline`, `DataService`, `TRIOSResult`, `TestDMTNonlocal`, `TestFluidityNonlocalTransient`, `SGRConventional`, `ParameterSet`, `TestFluidityNonlocalGrid`, `TNTStickyRouse`, `Maxwell`, `FIKH`, `TestHVMRelaxation`, `TestBinghamStability`, `TestHVNMCreep`, `TestCatesMaxwellLimit`, `FluiditySaramitoLocal`, `TestFlowCurve`, `FitState`, `TestCreepSimulation`, `Zener`, `TestLAOSSimulation`, `test_convert_units_stress`, `StateStore`, `TestPhysicalConsistency`, `SpringPot`, `TestStartupSimulation`, `FMLIKH`, `TestHerschelBulkleyRheoData`, `TestCreepSimulation`, `TestLAOSSimulation`, `TestStartupSimulation`, `TestCreepSimulation`, `TestNonAffineVariant`, `DataStep`, `load_csv`, `HVNMLocal`, `FitPage`, `FitResult`, `ITTMCTSchematic`, `TensorialEPM`, `DMTLocal`, `FractionalMaxwellModel`, `VLBLocal`, `_kernels_diffrax.py`, `TestVLBVariantCreation`, `TestHVNMLAOS`, `TestFluidityLocalModelFunction`, `CancellationError`, `DatasetRef`, `TestDMTLocalSAOS`, `TestThermalYieldStress`, `TestFitOscillation`, `FitResult`, `PipelineBuilder`, `load_trios`, `_translate_y2_col`, `.predict_rheo`, `Carreau`, `ITTMCTBase`, `SGRGeneric`, `ModelComparisonPipeline`, `Cross`, `MLIKH`, `FitWorker`, `TestMIKH`, `.__init__`, `HerschelBulkley`, `TestDMTRegistry`, `TestVLBLocalCreep`, `load_trios_chunked`, `FluiditySaramitoNonlocal`, `TNTSingleMode`, `TNTMultiSpecies`, `.test_simulate_creep`, `TestFitRelaxation`, `.generate`, `ndarray`, `FractionalMaxwellGel`, `VLBVariant`, `TestLAOSKwargsRegression`, `FractionalPoyntingThomson`, `test_hvm.py`, `SPPYieldStress`, `TestRegistryIntegration`, `TNTLoopBridge`, `SPPAmplitudeSweepPipeline`, `hebraud_lequeux.py`, `test_convert_units_angle`, `PipelineConfigureRunStep`, `FractionalKelvinVoigt`, `TestMLIKHProtocols`, `VLB Model Equation Verification`, `HVMLocal`, `ModelComparison`, `TestHVNMLimitingCases`, `test_physics.py`, `main`, `.predict_normal_stresses`, `BayesianPipeline`, `tensor.py`, `FractionalBurgersModel`, `FractionalJeffreysModel`, `FractionalKelvinVoigtZener`, `FractionalZenerLiquidLiquid`, `TestVLBBellPhysics`, `_compute_y_band`, `SimpleModel`, `TestCarreauYasudaBasics`, `PowerLaw`, `FluidityLocal`, `TestPhysicalConsistency`, `TestCreepSimulation`, `TestVLBMultiNetworkAnalytical`, `TNTCates`, `TestHVNMInterphase`, `TestModeEnum`, `TestProjectStructure`, `TestHLModelFunction`, `._predict`, `FractionalZenerSolidLiquid`, `GiesekusMultiMode`, `._transform`, `TestVLBVariantRegression`, `TestComposedVariants`, `.get_credible_intervals`, `VLBNonlocal`, `_mittag_leffler_hybrid`, `TestDMTBayesian`, `TestHVNMSAOS`, `TestJAXSupport`, `When Analytical SAOS Breaks Down for Transient Network Models and Vitrimers`, `export_worker.py`, `TestDMTLocalCreation`, `TestDMTLocalCreep`, `TestFitPredictRoundtrip`, `TestFluidityNonlocalShearBanding`, `TestHVMStartup`, `TestInstantiation`, `TestFluidityPredictWithoutFit`, `TestHVMCreep`, `TestHVNMStartup`, `f12_memory_kernel`, `TestDMTLocalStartup`, `TestF002KwargsCache`, `TestFluidityLocalOscillation`, `TestFluidityNonlocalSmoke`, `TestHVMFlowCurve`, `TestFractionalPoyntingThomson`, `TestShearBandingDetection`, `TestStartupSimulation`, `TestBellVariant`, `TestFENEVariant`, `TestHVNMFlowCurve`, `TestHVNMRelaxation`, `TestSPPPlotEdgeCases`, `TestUpperConvected`, `._predict_stress`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `RheoData` connect `RheoData` to `safe_import_jax`, `TestDMTLocalRelaxation`, `OWChirp`, `Pipeline`, `DataService`, `TRIOSResult`, `TestFluidityLocalFlowCurve`, `.test_export_excel_with_transforms`, `ParameterSet`, `ValueError`, `.test_plot_autocorr_without_bayesian_fit_raises_error`, `Maxwell`, `load_anton_paar`, `TestGENERICThermodynamics`, `BatchPanel`, `WorkspaceWindow`, `.test_fit_nlsq_with_model_instance`, `txt.py`, `.test_fit_bayesian_after_nlsq`, `.test_fit_bayesian_without_nlsq_raises_error`, `.test_complete_workflow_chaining`, `DatasetLibrary`, `Zener`, `CoxMerz`, `StateStore`, `ModelService`, `SpringPot`, `load_csv`, `test_convert_units_angle`, `DataStep`, `test_io_fixes.py`, `HVNMBase`, `FitPage`, `._fit`, `TestVLBLocalFlowCurve`, `TensorialEPM`, `.__init__`, `TestPlotRheoData`, `test_project_codec.py`, `FractionalMaxwellModel`, `TestModulusLabels`, `LatticeEPM`, `TestPowerLawPredictions`, `test_multi_file.py`, `AnalysisExporter`, `json.py`, `RheoJAXMainWindow`, `ImportWizard`, `herschel_bulkley_viscosity`, `test_fractional_zener_family.py`, `TestMonotonicityChecks`, `VLB Model Equation Verification`, `TestDataIntegrity`, `MutationNumber`, `TestArviZIntegration`, `TestVLBBellFeneCombined`, `TestModelFitTemplate`, `DatasetRef`, `__init__.py`, `FitResult`, `PipelineBuilder`, `_make_model`, `FFTAnalysis`, `load_trios`, `.save`, `TestVLBLocalLAOS`, `.predict_rheo`, `Carreau`, `TestMIKHNLSQ`, `TestIKHProtocols`, `TestMLIKHFitting`, `check_r_hat`, `TestSAOS`, `test_column_mapping.py`, `TestSAOS`, `PronyConversion`, `TestLAOSSimulation`, `RheoJaxValidationWarning`, `ProtocolModelStep`, `.test_export_directory_npz_format`, `.fit_bayesian`, `.test_export_directory_no_fit`, `TestBayesianInterface`, `preprocess_for_protocol`, `ModelComparisonPipeline`, `Cross`, `FitWorker`, `._get_initial_stress_state`, `TestMIKH`, `.__init__`, `TestPlotESS`, `TestVLBLocalExtension`, `HerschelBulkley`, `TransformPlotter`, `TestExportFormats`, `test_spp_kernels.py`, `load_npz`, `TestModeEnum`, `TestJSONSerialization`, `TestHDF5Support`, `TestCSVRoundTrip`, `.free_energy`, `.generate`, `PreferencesDialog`, `FitOrchestrator`, `TestBinghamPhysicalBehavior`, `upper_convected_derivative_2d`, `FractionalMaxwellGel`, `TestStartupFitting`, `TestCreepFitting`, `test_transform_plotter.py`, `SPPYieldStress`, `MockBayesianModel`, `TestEarlyTermination`, `TestAnalysisMethods`, `TestPlotFrequencyDomain`, `TestPlotFlowCurve`, `TestPlotResiduals`, `TestPublicationQuality`, `SPPAmplitudeSweepPipeline`, `Mastercurve`, `run_fit_isolated`, `FractionalKelvinVoigt`, `lattice.py`, `TestFIKHPredictions`, `TestModulusFrequencyTemplate`, `._validate_parameter_bounds`, `._epm_step`, `run_profiling.py`, `test_spp_integration.py`, `_get_simulation_ids`, `ModelComparison`, `.get_diagnostics`, `_synthetic_laos`, `test_fikh_caputo.py`, `BayesianPipeline`, `tensor.py`, `percus_yevick_sk`, `._predict`, `_kernels.py`, `TestPowerLawBasics`, `cmd_transform.py`, `TestPowerLawNumericalStability`, `TestPowerLawPerformance`, `TestMLIKHModelFunction`, `_compute_y_band`, `SimpleModel`, `estimate_eta0`, `TestCarreauYasudaBasics`, `PowerLaw`, `create_rheo_data_creep`, `TestArviZAvailability`, `main`, `.slice`, `RheoDataTableModel`, `TestFluidityEvolution`, `test_jobs.py`, `test_spp_golden_parity.py`, `MockBayesianModel`, `TestFMLIKHParameters`, `TestGMMBayesianInference`, `main`, `TestHLModelFunction`, `test_kernels.py`, `._predict`, `._predict`, `check_gpu_availability`, `._predict_viscosity`, `TestMLIKHProtocolFitting`, `get_recommended_package`, `TestTensorialAnimation`, `TestFluidityPredictWithoutFit`, `_FakeProc`, `TestBayesianInterface`, `TestTemplateStyles`, `.plot`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `safe_import_jax` to `OWChirp`, `Pipeline`, `Envelope`, `DataService`, `actions.py`, `get_logger`, `TestFluidityLocalSmoke`, `cmd_transform.py`, `ParameterSet`, `ValueError`, `PipelineConfig`, `__init__.py`, `load_anton_paar`, `TestPlotPipkinDiagram`, `BatchPanel`, `WorkspaceWindow`, `test_fractional_initializers.py`, `txt.py`, `load_npz`, `FitState`, `CoxMerz`, `StateStore`, `_yaml_runner.py`, `ModelService`, `load_csv`, `TestAnalysisMethods`, `window.py`, `auto_p0.py`, `test_io_fixes.py`, `check_model_compatibility`, `FitResult`, `TensorialEPM`, `TestBayesianInterface`, `compute_plastic_strain_rate`, `DMTLocal`, `main`, `_make_mock_spp_results`, `main`, `epm_plots.py`, `ExportOptionsDialog`, `LogCapture`, `TRIOSDataSet`, `create_parser`, `test_multi_file.py`, `json.py`, `get_template`, `__init__.py`, `test_fractional_zener_family.py`, `spp.py`, `compute_diagnostics`, `CancellationError`, `hebraud_lequeux.py`, `DatasetRef`, `lattice.py`, `sgr_population_balance.py`, `__init__.py`, `ArvizCanvas`, `main`, `PreviewWorker`, `WorkerPool`, `TestDiffraxCompilation`, `SPPDecomposer`, `main`, `__init__.py`, `test_window_chrome.py`, `_translate_y2_col`, `apply_globals`, `ITTMCTBase`, `TestGetLogger`, `PreprocessingResult`, `test_column_mapping.py`, `spp_kernels.py`, `main`, `RheoJaxValidationWarning`, `detect_data_range_decades`, `FitWorker`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Are the 564 inferred relationships involving `RheoData` (e.g. with `BaseModel` and `._detect_optimization_strategy()`) actually correct?**
  _`RheoData` has 564 INFERRED edges - model-reasoned connections that need verification._
- **Are the 468 inferred relationships involving `ModelRegistry` (e.g. with `FitResult` and `ModelComparison`) actually correct?**
  _`ModelRegistry` has 468 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 440 inferred relationships involving `ValueError` (e.g. with `_fit_single()` and `_load_from_envelope()`) actually correct?**
  _`ValueError` has 440 INFERRED edges - model-reasoned connections that need verification._