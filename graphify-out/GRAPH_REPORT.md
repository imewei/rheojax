...
## Corpus Check
- 59 files · ~1,734,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24173 nodes · 41755 edges · 2852 communities (2728 shown, 124 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 3808 edges (avg confidence: 0.58)
...
1. `RheoData` - 1057 edges
2. `ModelRegistry` - 548 edges
3. `ParameterSet` - 395 edges
4. `safe_import_jax()` - 307 edges
5. `BaseModel` - 262 edges
6. `get_logger()` - 242 edges
7. `StateStore` - 213 edges
8. `nlsq_optimize()` - 183 edges
9. `RheoJAXMainWindow` - 181 edges
10. `Pipeline` - 142 edges
...
- `TestDryRunPipeline` --uses--> `PipelineConfig`  [INFERRED]
  tests/cli/test_yaml_runner.py → rheojax/cli/_yaml_schema.py
- `TestLoadConfig` --uses--> `PipelineConfig`  [INFERRED]
  tests/cli/test_yaml_schema.py → rheojax/cli/_yaml_schema.py

## Import Cycles
- None detected.

## Communities (2852 total, 124 thin omitted)

### Community 0 - "Core NLSQ & Bayesian Base"
Cohesion: 0.01
Nodes (464): ABC, Base classes for models and transforms with JAX support.  This module provides a, Standard NLSQ fitting pipeline for models with a stateless model_fn.          Ha, Bayesian inference infrastructure using NumPyro NUTS sampling.  This module prov, # NOTE: Precompilation cache is stored per-instance (set in precompile_bayesian), RheoData class - JAX-native rheological data container.  This module provides th, FitOrchestrator: encapsulates the full fit() workflow.  Extracted from BaseModel, Protocol (+456 more)

### Community 1 - "RheoData & Data Layer"
Cohesion: 0.01
Nodes (378): Automatically detect or retrieve test mode.          The test mode is detected b, Get storage modulus label. Always returns "G'" (shear)., Get loss modulus label. Always returns 'G"' (shear)., JAX-native container for rheological data with NumPy/JAX array support.      Thi, RheoData, Unified analysis exporter for Pipeline results.  Bundles data, model parameters,, CarreauYasuda, Carreau-Yasuda model for non-Newtonian flow (ROTATION only).      The Carreau-Ya (+370 more)

### Community 2 - "BaseModel API & Methods"
Cohesion: 0.01
Nodes (336): BaseModel, BaseTransform, ArrayLike, BayesianResult, RuntimeError, Abstract base class for all data transforms.      This class defines the standar, Initialize base transform., Fit the transform to data (learn parameters if needed).          Args: (+328 more)

### Community 3 - "GUI Bayesian Page & Jobs"
Cohesion: 0.01
Nodes (270): _is_qobject_alive(), Check whether a QObject's C++ counterpart is still alive.      Works across PySi, BayesianPage, Bayesian Page ============  Bayesian inference interface with prior specificatio, Handle error during inference.          Parameters         ----------         er, Handle bayesian_failed signal from state store.          This slot catches Bayes, Handle Bayesian started signal from state., Handle Bayesian completed signal from state. (+262 more)

### Community 4 - "GUI App & Main Window"
Cohesion: 0.01
Nodes (277): Enum, __getattr__(), Application Core Components ===========================  Main window, menu bar,, Lazy import for application components., Main Application Window =======================  Central window coordinating pag, # TODO: Implement project serialization (state → JSON/HDF5)., # NOTE: This guard assumes single-threaded (GUI main thread) access., Menu Bar ========  Application menu bar with File, Edit, View, Data, Models, Tra (+269 more)

### Community 5 - "Model Registry & Inventory"
Cohesion: 0.01
Nodes (150): Categories of data transformation operations.      Transforms are classified by, TransformType, PluginInfo, PluginType, Any, Unregister a transform.          Args:             name: Name of the transform t, Register a plugin in the registry.          Args:             name: Unique name, Validate that a plugin implements the required interface.          Args: (+142 more)

### Community 6 - "VLB Viscoelastic Models"
Cohesion: 0.01
Nodes (162): Compute stretch ratio from distribution tensor.          stretch = sqrt(tr(mu)/3, Compute Weissenberg number Wi = t_R * gamma_dot.          Parameters         ---, Compute Deborah number De = t_R * omega.          Parameters         ----------, Get all parameters as a dictionary.          Returns         -------         dic, Set parameters from a dictionary.          Parameters         ----------, Compute dissociation rate (possibly state-dependent).          Base implementati, Base class for VLB transient network models.      Provides shared infrastructure, Initialize ParameterSet. Must be implemented by subclasses. (+154 more)

### Community 7 - "Anton Paar IO Reader"
Cohesion: 0.02
Nodes (157): _compute_complex_modulus(), _compute_compliance(), _compute_relaxation_modulus(), _convert_unit(), _create_interval_dataframe(), _create_metadata_sheet(), _detect_decimal_separator(), _detect_encoding() (+149 more)

### Community 8 - "CLI SPP Analysis"
Cohesion: 0.02
Nodes (143): _add_analyze_args(), _add_batch_args(), create_parser(), main(), ArgumentParser, Namespace, Path, SPP (Sequence of Physical Processes) CLI commands.  This module provides command (+135 more)

### Community 9 - "Import Wizard Dialog"
Cohesion: 0.02
Nodes (128): ImportWizard, Any, Multi-step data import wizard.      Steps:         1. File selection         2., Handle wizard finished., Get import configuration.          Returns         -------         dict[str, Any, DataService, Get list of supported file formats.          Returns         -------         lis, Service for rheological data operations.      Features:         - Multi-format d (+120 more)

### Community 10 - "GUI Import Worker & Drop Zone"
Cohesion: 0.01
Nodes (110): QDragEnterEvent, QDropEvent, ImportWorker, ImportWorkerSignals, Any, Path, QObject, QRunnable (+102 more)

### Community 11 - "Saramito Fluidity Models"
Cohesion: 0.02
Nodes (89): FluiditySaramitoLocal, Any, ndarray, Simulate LAOS response using Diffrax.          Parameters         ----------, Simulate LAOS response.          Parameters         ----------         gamma_0 :, Extract Fourier harmonics from LAOS stress response.          Parameters, NumPyro/BayesianMixin model function.          Routes to appropriate prediction, Predict based on fitted state.          Parameters         ----------         X (+81 more)

### Community 12 - "ArviZ Utils & Bayesian Results"
Cohesion: 0.02
Nodes (97): BayesianResult, DatasetState, ModuleType, QLayout, arviz_figure(), _arviz_major_version(), arviz_plot_kwargs(), import_arviz() (+89 more)

### Community 13 - "GUI Icons & Utils"
Cohesion: 0.02
Nodes (90): emoji_safe(), get_icon_provider(), get_standard_icon(), IconProvider, is_macos(), is_macos_arm64(), QIcon, Platform-Safe Icon Utilities ============================  Centralized icon hand (+82 more)

### Community 14 - "Initialization Base"
Cohesion: 0.03
Nodes (100): BaseInitializer, Base initializer abstract class for fractional model initialization.  This modul, Abstract base class for fractional model parameter initialization.      Implemen, Safely set a parameter if it exists in ParameterSet.          This helper method, FractionalBurgersInitializer, Initializer for FractionalBurgers model from oscillation data.  Model equation (, Set FractionalBurgers parameters in ParameterSet.          Parameters         --, Smart initialization for FractionalBurgers from oscillation data. (+92 more)

### Community 15 - "Transform Page & Worker"
Cohesion: 0.02
Nodes (91): QObject, QRunnable, _PreviewWorker, Transform Page =============  Data-driven transform application interface with s, Signals for cross-thread preview result delivery., QRunnable that computes a transform preview off the main thread., _WorkerSignals, PipelineExecutionService (+83 more)

### Community 16 - "Bayesian Pipeline"
Cohesion: 0.02
Nodes (74): BayesianPipeline, Reset pipeline to initial state.          Clears all data, models, and results i, String representation of Bayesian pipeline., Specialized pipeline for Bayesian rheological analysis workflows.      This clas, Initialize Bayesian pipeline.          Args:             data: Optional initial, Integration smoke tests for SPP pipeline workflow., _spp_dataset(), test_pipeline_bayesian_warm_start() (+66 more)

### Community 17 - "Giesekus Single-Mode Model"
Cohesion: 0.02
Nodes (72): GiesekusSingleMode, Initialize single-mode Giesekus model., Single-mode Giesekus nonlinear viscoelastic model.      The Giesekus model exten, Fast smoke tests for Bayesian pipeline (FAST_MODE compatible)., Verify Bayesian pipeline completes with minimal samples.          Uses 10 warm, Verify Bayesian SAOS pipeline completes with minimal samples., TestBayesianSmoke, Tests for physical diagnostic relationships. (+64 more)

### Community 18 - "CSV Reader & IO"
Cohesion: 0.03
Nodes (90): complexfloating, Index, detect_csv_delimiter(), _detect_delimiter(), _get_column_data(), _get_column_header(), load_csv(), DataFrame (+82 more)

### Community 19 - "Qt Widgets"
Cohesion: 0.04
Nodes (55): QGroupBox, QPushButton, QSplitter, QStackedWidget, QTableWidget, QVBoxLayout, QWidget, Set up user interface. (+47 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (59): FittingOptionsDialog, Fitting configuration dialog.      Options:         - Optimization algorithm, Handle algorithm combo box change., Handle multi-start checkbox change., Reset all options to defaults., Handle dialog accepted., Handle dialog rejected., FitPage (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (64): FIKH, Any, ArrayLike, ndarray, Initialize FIKH model.          Args:             include_thermal: Enable thermo, Fit model parameters using protocol-aware optimization.          Args:, Fit to steady-state flow curve data., Fit using ODE formulation (creep/relaxation). (+56 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (65): _display_name(), from_pipeline_builder(), from_yaml(), _get_yaml(), _make_step(), Any, Import and return the ``yaml`` module, raising a clear error if absent.      Ret, Convert GUI pipeline steps to a YAML string.      The resulting string is compat (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (55): FluidityLocal, Local (0D) Fluidity Model for yield-stress fluids.      Implements a homogeneous, Extract Fourier harmonics from LAOS stress response.          Args:, Initialize Local Fluidity Model., Test Nonlocal has additional xi parameter., Test parameters.get_values() returns array of values., Test Local fit raises without test_mode., Test Local fit sets fitted_ attribute. (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (56): ITTMCTSchematic, Any, ndarray, Predict stress relaxation after flow cessation.          Parameters         ----, Predict LAOS stress response.          Parameters         ----------         t :, Extract Fourier harmonics from LAOS response.          Parameters         ------, Static model function for Bayesian inference.          NOTE: Bayesian inference, Invalidate Prony cache if physics parameters changed.          Tracks (v1, v2, G (+48 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (59): GiesekusMultiMode, Initialize multi-mode Giesekus model.          Parameters         ----------, Initialize ParameterSet with multi-mode parameters.          Creates parameters:, Get solvent viscosity η_s (Pa·s)., Get zero-shear viscosity η₀ = η_s + Σ η_p,i (Pa·s)., Get parameters for a specific mode.          Parameters         ----------, Set parameters for a specific mode.          Parameters         ----------, Multi-mode Giesekus nonlinear viscoelastic model.      This model extends the si (+51 more)

### Community 26 - "Community 26"
Cohesion: 0.03
Nodes (56): ITTMCTIsotropic, Any, ndarray, Predict stress relaxation after flow cessation.          Parameters         ----, Predict LAOS stress response.          Parameters         ----------         t :, Extract Fourier harmonics from LAOS response.          Parameters         ------, Static model function for Bayesian inference.          NOTE: Bayesian inference, Return string representation. (+48 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (45): PipelineBuilder, Any, Path, Add prediction step.          Args:             store_as: Optional name to store, Add plotting step.          Args:             show: Whether to display plot, Add Bayesian inference step (NUTS sampling).          Args:             num_warm, Add analysis export step.          Args:             output_path: Output directo, Add data saving step.          Args:             file_path: Output file path (+37 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (64): Custom exceptions and warnings for the RheoJAX package.  This module defines the, Raised for unrecoverable fit failures.      Examples include optimizer divergenc, RheoJaxFitError, load_hdf5(), _normalize_hdf5_geometry_marker(), Any, Path, RheoData (+56 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (85): _hvm_initial_state(), hvm_solve_creep(), hvm_solve_laos(), hvm_solve_relaxation(), hvm_solve_startup(), _make_creep_vector_field(), _make_k_ber_fn(), _make_laos_vector_field() (+77 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (44): HVNM (Hybrid Vitrimer Nanocomposite Model) package.  Constitutive models for n, HVNMLocal, Create unfilled vitrimer (phi=0, recovers HVM exactly).          Parameters, Create partial vitrimer nanocomposite (G_D=0).          Parameters         -----, Create conventional filled rubber (no E-network, frozen interphase).          Pa, Get parameters as dict with defaults for optional params., Predict steady-state flow curve.          At steady state, mu^E -> mu^E_nat and, Predict steady-state normal stress differences.          At steady state, E and (+36 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (67): _filter_positive(), plot_fit_with_uncertainty(), plot_flow_curve(), plot_frequency_domain(), plot_residuals(), plot_rheo_data(), plot_time_domain(), Any (+59 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (53): Get characteristic time scale for the material.          For SpringPot, there's, String representation of SpringPot model., SpringPot fractional viscoelastic element.      The SpringPot represents a power, Initialize SpringPot model with default parameters., SpringPot, Comprehensive tests for SpringPot fractional viscoelastic element.  This test su, Test string representation., Test SpringPot relaxation modulus predictions. (+45 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (76): Base class for HVNM (Hybrid Vitrimer Nanocomposite Model).  Provides shared in, _compute_k_ber_interphase(), _default_hvnm_args(), _hvnm_initial_state(), _hvnm_relaxation_initial_state(), hvnm_solve_creep(), hvnm_solve_laos(), hvnm_solve_relaxation() (+68 more)
...
Cohesion: 0.04
Nodes (68): initialize_fractional_burgers(), initialize_fractional_jeffreys(), initialize_fractional_kelvin_voigt(), initialize_fractional_kv_zener(), initialize_fractional_maxwell_gel(), initialize_fractional_maxwell_liquid(), initialize_fractional_maxwell_model(), initialize_fractional_poynting_thomson() (+60 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (58): AppState, main(), RheoJAX GUI Package ==================  Qt-based graphical user interface for Rh, Launch the RheoJAX GUI application.      This is a convenience wrapper that impo, check_dependencies(), _create_workspace_window(), main(), RheoJAX GUI Application Entry Point.  This module provides the main entry point (+50 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (45): Emitted when auto_p0 estimation partially fails.      Some parameters may have b, RheoJaxInitWarning, FractionalMaxwellModel, Fractional Maxwell Model: Two SpringPots in series with independent orders., Initialize Fractional Maxwell Model., auto_p0(), Estimate initial parameter values from experimental data.      Analyzes the stru, Test creep compliance. (+37 more)

### Community 38 - "Community 38"
Cohesion: 0.03
Nodes (46): FluidityNonlocal, Add non-local specific parameters., Get grid-related arguments for PDE solver.          Args:             params: Op, Non-Local (1D PDE) Fluidity Model for yield-stress fluids.      Implements the C, Initialize Non-Local Fluidity Model.          Args:             N_y: Number of s, Test Local and Nonlocal share common parameters., Test both models can export parameter dict., Test Nonlocal fit raises without test_mode. (+38 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (44): DatasetLibrary, Any, JobsState, ProjectState, TransformState, ExportStep, FitState, Path (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.02
Nodes (41): Pipeline, Get the last fitted model.          Returns:             Last fitted BaseModel o, Get all fitted models from pipeline.          Returns:             List of all f, Get fitted parameters from the last model as a dictionary.          This is a co, Create a copy of the pipeline.          Returns:             New Pipeline with c, Reset pipeline to initial state.          Returns:             self for method c, String representation of pipeline., Apply a transform to the data.          Args:             transform: Transform n (+33 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (52): ndarray, Handle plot type change.          Parameters         ----------         index :, Set data and plot residuals.          Parameters         ----------         y_tr, Set residuals directly.          Parameters         ----------         residuals, Update statistics display., Refresh the current plot., Plot residuals vs fitted values., Plot histogram of residuals. (+44 more)
...
Cohesion: 0.03
Nodes (41): Initialize SGR Conventional Model.          Creates ParameterSet with:         -, Determine material phase regime from noise temperature x.          The SGR model, Compute steady-state effective temperature x_ss(gamma_dot).          The steady-, Enable thixotropy modeling with structural parameter lambda(t).          Adds th, Soft Glassy Rheology (SGR) Conventional Model.      Statistical mechanics model, SGRConventional, Test SGR model can compute credible intervals from mock posterior samples., Test that SGRConventional and SGRGeneric give similar predictions in linear regi (+33 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (36): Any, Handle open file action., Handle save as action., Handle zoom in action., Handle reset zoom action., Auto-populate a newly-added pipeline step's config from current UI state., Clear the current visual pipeline state., Update the selected pipeline step's config when model selection changes. (+28 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (41): DMTBase, Initialize ParameterSet with model parameters.          Parameters are added con, Get initial structure parameter value (fully structured).          Returns, Get all parameters as a dictionary.          Returns         -------         dic, Build base args dictionary for ODE integration.          Parameters         ----, Get human-readable description of the closure.          Returns         -------, Base class for DMT (de Souza Mendes-Thompson) thixotropic models.      Implement, Get human-readable description of elasticity setting.          Returns         - (+33 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (53): banding_ratio(), f_loc_herschel_bulkley(), fluidity_local_creep_ode_rhs(), fluidity_local_ode_rhs(), fluidity_local_steady_state(), fluidity_nonlocal_creep_pde_rhs(), fluidity_nonlocal_pde_rhs(), laplacian_1d_neumann() (+45 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (63): check_gpu_availability(), check_plugin_conflicts(), get_device_info(), get_gpu_info(), get_gpu_memory_info(), get_recommended_package(), get_system_cuda_version(), print_device_summary() (+55 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (44): Maxwell, ndarray, Estimate G0 and eta from relaxation data for faster convergence., Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Maxwell viscoelastic model (spring and dashpot in series).      The Maxwell mode, Predict relaxation modulus G(t).          Theory: G(t) = G0 * exp(-t/tau) where, Predict creep compliance J(t).          Theory: J(t) = 1/G0 + t/eta          Arg (+36 more)
...
Cohesion: 0.05
Nodes (54): FuncAnimation, animate_stress_evolution(), animate_tensorial_evolution(), plot_lattice_fields(), plot_normal_stress_field(), plot_normal_stress_ratio(), _plot_scalar_lattice(), plot_tensorial_fields() (+46 more)
...
Cohesion: 0.04
Nodes (44): Config, Any, Path, Configuration Management =======================  Application configuration and, Application configuration manager.      Features:         - Persistent settings, Initialize configuration manager.          Parameters         ----------, Get configuration value.          Parameters         ----------         key : st, Save configuration to file. (+36 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (38): BatchPipeline, Any, DataFrame, Exception, Path, RheoData, Process all files in directory matching pattern.          Args:             dire, Pre-load files in parallel using threads (I/O only, thread-safe).          Retur (+30 more)
...
Cohesion: 0.04
Nodes (64): Check if this is a scalar (not tensorial) EPM.          Returns False for Tensor, 3-Component Tensorial Lattice EPM.      A mesoscopic model for amorphous solids, Fit tensorial-EPM parameters to shear-stress data.          Currently supports *, Initialize the Tensorial EPM.          Args:             L: Lattice size (LxL gr, TensorialEPM, Tests for Tensorial EPM model.  This module tests the full tensorial (3-componen, Test fitting to 1D shear stress data (backward compatible).      When y is 1D, s, Test fitting to 2D data [σ_xy, N₁] simultaneously.      When y has shape (2, n), (+56 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (36): ndarray, Soft Glassy Rheology (SGR) GENERIC Thermodynamic Framework Model.  This module i, Full Monte Carlo-based LAOS fitting.          Runs MC simulations within optimiz, Determine material phase regime from noise temperature x.          Returns:, Enable thixotropy modeling with structural parameter lambda(t).          Adds th, Evolve structural parameter lambda(t) for given shear history.          Integrat, Predict stress response with thixotropic modulus.          The effective modulus, Predict stress transient (overshoot/undershoot) for shear step protocol. (+28 more)
...
Cohesion: 0.05
Nodes (45): check_model_compatibility(), DecayType, detect_decay_type(), _detect_from_oscillation(), _detect_from_relaxation(), format_compatibility_message(), MaterialType, Any (+37 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (44): mittag_leffler_e(), mittag_leffler_e2(), _mittag_leffler_hybrid(), _ml_asymptotic_neg(), _ml_asymptotic_pos(), _ml_taylor(), _ml_taylor_complex(), ndarray (+36 more)
...
Cohesion: 0.06
Nodes (41): BayesianWorkerSignals, Any, QObject, Initialize Bayesian worker.          Parameters         ----------         model, Signals for BayesianWorker.      Signals     -------     progress : Signal(int,, Slot: relay staged elapsed-time message on the GUI thread.          Called exclu, Signal, CancellationError (+33 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (53): LatticeEPM, Array, RheoData, Perform one scalar EPM time step.          Delegates to the `epm_step` kernel fr, Simulate the model for the given protocol.          Args:             X: Input d, 2D Lattice Elasto-Plastic Model (EPM).      A mesoscopic model for amorphous sol, Initialize scalar stress field.          Args:             key: PRNG key (unused, Test that LatticeEPM can be instantiated and has correct defaults. (+45 more)

### Community 66 - "Community 66"
Cohesion: 0.04
Nodes (24): Comprehensive tests for Fractional Zener Family and Advanced Fractional Models (, Test creep compliance., Test complex modulus (primary mode for FZLL)., Test model with three different fractional orders., Tests for FKVZ model., Test creep compliance (primary mode)., Test complex modulus via compliance., Test creep compliance with viscous flow. (+16 more)

### Community 67 - "Community 67"
Cohesion: 0.03
Nodes (44): complex_data(), mock_bayesian_result(), mock_fit_result(), mock_model(), plotter(), Tests for the FitPlotter class and Bayesian visualization primitives., Mock FitResult with covariance., Mock BayesianResult with posterior samples. (+36 more)

### Community 68 - "Community 68"
Cohesion: 0.03
Nodes (42): complex_data(), freq_data(), plotter(), Tests for the TransformPlotter class., Tests for mastercurve visualization., Mastercurve plot with shift factors dict., Mastercurve plot without input datasets., Mutation number plot shows bar with value. (+34 more)
...
Cohesion: 0.05
Nodes (34): Mastercurve, Time-Temperature Superposition (TTS) mastercurve generation.  This module implem, Initialize Mastercurve transform.          Parameters         ----------, Set manual shift factors for each temperature.          Parameters         -----, Get WLF parameters.          Returns         -------         dict             Di, Get Arrhenius parameters.          Returns         -------         dict, ShiftMethod, Test 2: Power-law fitting produces reasonable parameters.      Verifies that pow (+26 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (46): Reset logging configuration to defaults.      Primarily useful for testing., reset_config(), log_bayesian(), log_gui_action(), log_io(), log_operation(), log_pipeline_stage(), log_transform() (+38 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (40): compute_credible_band(), FitPlotter, generate_diagnostic_suite(), Any, Axes, Figure, ndarray, Path (+32 more)

### Community 74 - "Community 74"
Cohesion: 0.04
Nodes (34): Execute all pipeline steps in sequence on a background thread.          Pipeline, Execute a single pipeline step with accumulated context.          Builds context, Qt, QThreadPool, Worker Pool ==========  Thread pool for executing background jobs with progress, Any, BayesianResult, ndarray (+26 more)
...
Cohesion: 0.05
Nodes (36): Bingham, String representation., Bingham model for linear viscoplastic flow (ROTATION only).      The Bingham mod, Initialize Bingham model., Tests for Bingham model.  This module tests the Bingham model for linear viscopl, Test that this is Herschel-Bulkley with n=1., Test prediction with RheoData (stress output)., Test prediction with RheoData (viscosity output). (+28 more)
...
Cohesion: 0.05
Nodes (35): PlotService, Any, Figure, RheoData, Get Wong colorblind-safe palette.          Returns         -------         list[, Get dark-theme-friendly palette., Apply matplotlib style to figure.          Parameters         ----------, Apply publication style (IEEE, Nature, etc.). (+27 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (38): BayesianWorker, Worker for running MCMC sampling in background.      Features:         - NUTS sa, Check if job should be cancelled.          Raises         ------         Cancell, FitWorker, Execute fitting in background thread.          This method runs in a separate th, Check if job should be cancelled.          Raises         ------         Cancell, Worker for running NLSQ fitting in background.      Features:         - NLSQ opt, _bayesian_work_entry() (+30 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (37): BayesianMixin, compute_diagnostics(), compute_per_param_diagnostic(), _import_numpyro_diagnostics(), MCMC, ndarray, Compute convergence diagnostics from MCMC samples.      Args:         mcmc: NumP, Lazy-import NumPyro diagnostics functions. (+29 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (41): get_compatible_test_modes(), TestMode, Enumeration of rheological test modes.      Note: Named TestModeEnum (not TestMo, Validate and convert test mode to TestMode enum.      Args:         test_mode: T, Get compatible test modes for a given model.      Queries the ModelRegistry to d, Suggest appropriate models for a given test mode.      Queries the ModelRegistry, Return string representation., Convert inventory Protocol to TestModeEnum. (+33 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (26): Any, QObject, QRunnable, Create or return singleton instance., Get the singleton WorkerPool instance.          Parameters         ----------, Reset the singleton instance (useful for testing)., Initialize worker pool.          Parameters         ----------         max_threa, Submit a worker to the pool.          Parameters         ----------         work (+18 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (35): Carreau, Carreau model for non-Newtonian flow (ROTATION only).      The Carreau model des, String representation., Initialize Carreau model., Tests for Carreau model.  This module tests the Carreau model for non-Newtonian, Test stress prediction: σ = η(γ̇) * γ̇., Test Newtonian limit when λ → 0., Test Newtonian limit when n = 1. (+27 more)

### Community 84 - "Community 84"
Cohesion: 0.05
Nodes (39): CubicSpline, Interpolator1D, Initialize k-grid and compute/interpolate S(k)., Compute MCT vertex function V(k,q)., create_sk_interpolator(), create_sk_interpolator_jax(), hard_sphere_properties(), interpolate_sk() (+31 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (28): FigureCanvasQTAgg, MultiView, PlotPanel, Any, Figure, Get matplotlib figure.          Returns         -------         Figure, Get matplotlib canvas.          Returns         -------         FigureCanvasQTAg, Multi-panel plot viewer for comparison and analysis.      Features:         - Co (+20 more)

### Community 86 - "Community 86"
Cohesion: 0.07
Nodes (28): ArvizCanvas, _filter_degenerate_vars(), Any, Figure, Scale the figure to the viewport width, preserving aspect ratio.          Instea, Handle plot type change.          Parameters         ----------         index :, Refresh the current plot with performance tracking., Set ArviZ InferenceData object.          Parameters         ----------         i (+20 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (51): breakage_bell(), breakage_constant(), breakage_power_law(), build_tnt_creep_ode_rhs(), build_tnt_laos_ode_rhs(), build_tnt_ode_rhs(), build_tnt_relaxation_ode_rhs(), gordon_schowalter_2d() (+43 more)

### Community 88 - "Community 88"
Cohesion: 0.07
Nodes (25): CLI subcommand for pipeline management (init, validate, show).  Provides utiliti, Write a template YAML pipeline config., run_init(), get_template(), list_templates(), Path, YAML pipeline templates for ``rheojax pipeline init``.  Each template is a compl, Return the YAML string for a named template.      Args:         name: Template i (+17 more)
...
Cohesion: 0.05
Nodes (24): Any, Create from dictionary representation.          Uses Parameter.from_dict() to pr, Link a model to a shared parameter.          Args:             model: Model to l, Set shared parameter value.          Args:             name: Parameter name, Get models linked to a parameter.          Args:             param_name: Paramet, Get parameters in a group.          Args:             group_name: Group name, Get optimization history.          Returns:             List of history dictiona, Validate value against all constraints.          Args:             value: Value (+16 more)
...
Cohesion: 0.06
Nodes (25): FractionalZenerSolidSolid, ndarray, Predict relaxation modulus G(t) using JAX.          G(t) = G_e + G_m * E_α(-(t/τ, Predict relaxation modulus G(t).          Wrapper for JIT-compiled implementatio, Predict creep compliance J(t) using JAX.          For FZSS, creep compliance is:, Predict creep compliance J(t).          Wrapper for JIT-compiled implementation., Predict complex modulus G*(ω) using JAX.          G*(ω) = G_e + G_m / (1 + (iωτ_, Predict complex modulus G*(ω).          Wrapper for JIT-compiled implementation. (+17 more)
...
Cohesion: 0.06
Nodes (41): advected_correlator(), advected_memory_decorrelation(), compute_microscopic_stress(), f12_memory_kernel_derivative(), glass_transition_criterion(), prony_decompose_memory(), _prony_leastsq_robust(), _prony_log_spacing() (+33 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (35): ParameterTable, build_fit_controller(), _make_fit_fn(), _make_sample_fn(), AppState, _r2_sort_key(), Build the real (synchronous) sample_fn NutsStep.run() calls., Multi-start restart-selection key: treat missing/NaN r_squared as the     worst (+27 more)

### Community 98 - "Community 98"
Cohesion: 0.05
Nodes (27): QWizard, QWizardPage, ColumnMappingPage, FileSelectionPage, PreviewConfirmPage, DataFrame, QWidget, Check if page is complete. (+19 more)

### Community 99 - "Community 99"
Cohesion: 0.10
Nodes (19): Print a human-readable summary of a pipeline config., run_show(), PipelineConfig, YAML pipeline config schema definition and validation.  A pipeline config YAML f, Validated representation of a YAML pipeline config file.      Attributes:, Validate a :class:`PipelineConfig`, returning error messages.      An empty list, validate_config(), Regression tests for removed DMTA-specific CLI and YAML options. (+11 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (35): transform_slots(), # NOTE: TransformService has no .run() method. The real implementation must:, RunStep, build_transform_controller(), _infer_protocol_type(), _is_same_domain(), _make_run_fn(), AppState (+27 more)
...
Cohesion: 0.08
Nodes (41): CanonicalField, match_column(), match_columns(), Consolidated canonical column field registry for all I/O readers.  Merges patter, Canonical field descriptor for a rheological measurement column., Match a column header string to a CanonicalField.      Uses :func:`~rheojax.io.r, Match a list of column headers to canonical fields.      Parameters     --------, Tests for the consolidated canonical column field registry. (+33 more)

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (25): MIKH, ArrayLike, ndarray, Fit model parameters to data using protocol-aware optimization.          Args:, Fit to steady-state flow curve data., Fit using ODE formulation (for creep/relaxation)., Fit using return mapping formulation (for startup/LAOS)., Fit to oscillatory data (SAOS).          Supports two modes:         1. Frequenc (+17 more)
...
Cohesion: 0.08
Nodes (26): QMainWindow, AppState, QWidget, WorkspaceWindow, StepperCanvas, _RheoData, test_config_widget_edit_survives_invalidation_cascade(), test_controller_gating_and_invalidation() (+18 more)

### Community 110 - "Community 110"
Cohesion: 0.05
Nodes (26): ExportWorker, ExportWorkerSignals, Any, QObject, QRunnable, Export Worker =============  Background worker for export operations (R13-GUI-00, Signals for ExportWorker.      Signals     -------     completed : Signal(list), Worker for performing exports in a background thread.      Parameters     ------ (+18 more)

### Community 111 - "Community 111"
Cohesion: 0.06
Nodes (24): ndarray, Simulate startup flow at constant shear rate.          Parameters         ------, Simulate stress relaxation after cessation of steady shear.          Analytical, Simulate creep deformation under constant stress.          Parameters         --, Simulate Large-Amplitude Oscillatory Shear (LAOS).          Parameters         -, Get relaxation modulus G(t).          For multi-species TNT: G(t) = Σ G_i·exp(-t, Extract Fourier harmonics from LAOS stress response.          Parameters, Return string representation. (+16 more)

### Community 112 - "Community 112"
Cohesion: 0.05
Nodes (33): flow_curve_data(), oscillation_data(), Validation tests for NLSQ → NUTS pipeline for Fluidity models.  This module vali, Generate synthetic SAOS data (G', G'')., Test NLSQ fitting for FluidityLocal., NLSQ fitting for flow curve should converge., NLSQ fitting for SAOS should converge., Test Bayesian inference for FluidityLocal. (+25 more)

### Community 113 - "Community 113"
Cohesion: 0.04
Nodes (45): array_pair_numpy_jax(), clean_registries(), complex_array_pair_numpy_jax(), creep_data_simple(), csv_file_data(), flow_data_bingham(), flow_data_power_law(), json_file_data() (+37 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (21): create_data_envelope(), create_fit_envelope(), Envelope, _get_version(), Any, JSON envelope dataclass for stdin/stdout piping between CLI commands.  RheoJAX C, Read an envelope from stdin if stdin is not a terminal.          Returns:, Create a ``"data"`` envelope from x/y arrays.      Args:         x: Independent (+13 more)
...
Cohesion: 0.06
Nodes (20): MLIKH, Number of structural modes., Yield formulation mode ('per_mode' or 'weighted_sum')., Initialize parameters based on yield_mode., Create parameters for per-mode yield formulation., Create parameters for weighted-sum yield formulation., Multi-Lambda Isotropic-Kinematic Hardening (ML-IKH) Model.      Extends MIKH to, Tests for ML-IKH protocol implementations. (+12 more)

### Community 117 - "Community 117"
Cohesion: 0.05
Nodes (20): FitResult, Root mean squared error, delegated to OptimizationResult., Mean absolute error, delegated to OptimizationResult., Akaike Information Criterion, delegated to OptimizationResult., Bayesian Information Criterion, delegated to OptimizationResult., Whether the optimizer converged successfully., Number of data points used in the fit., Alias for :attr:`success` (spec compatibility). (+12 more)

### Community 118 - "Community 118"
Cohesion: 0.07
Nodes (24): fluidity_nonlocal_steady_state(), Compute steady-state flow curve for Non-Local Fluidity model.      For homogeneo, Any, ndarray, NumPyro/BayesianMixin model function.          Accepts protocol-specific kwargs, Predict based on fitted state., Fit Non-Local Fluidity model to data.          Args:             X: Independent, Get initial fluidity field (uniform across gap).          Args:             f_in (+16 more)
...
Cohesion: 0.08
Nodes (33): ndarray, Get initial state vector based on variant.          Args:             stress_ini, ODE vector field wrapper for Diffrax.          Delegates to the JAX-compiled ker, chi_evolution_langer2008(), lambda_evolution(), m_evolution(), plastic_rate(), ndarray (+25 more)

### Community 122 - "Community 122"
Cohesion: 0.05
Nodes (30): log_capture(), LogCapture, LogRecord, Integration tests for RheoJAX logging with actual model fitting.  Tests the logg, Test logging with RheoJAX pipeline workflows., Test that pipeline stages are properly logged., Test JAX-specific logging utilities with real JAX operations., Test log_operation with JAX computation. (+22 more)
...
Cohesion: 0.05
Nodes (28): QDialog, BayesianOptionsDialog, Handle sampler combo box change., Handle target accept rate slider change., Handle priors text change., Generate random seed., Bayesian inference configuration.      Options:         - Sampler selection (NUT, Handle dialog accepted. (+20 more)

### Community 125 - "Community 125"
Cohesion: 0.07
Nodes (25): _coerce_array(), ParameterOptimizer, ArrayLike, ndarray, Optimizer for parameter fitting., Initialize parameter optimizer.          Args:             parameters: Parameter, Get current parameter values., Set objective function to minimize.          Args:             objective: Functi (+17 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (38): Emitted for post-fit physics violations.      Examples: negative moduli, fractio, Emitted when an optimizer converges but with caveats.      Examples: maximum ite, RheoJaxConvergenceWarning, RheoJaxPhysicsWarning, _build_param_map(), _check_chebyshev_e1(), check_fit_physics(), _check_fractional_orders() (+30 more)

### Community 127 - "Community 127"
Cohesion: 0.05
Nodes (28): Initialize F₁₂ Schematic Model.          Parameters         ----------         e, Get critical v₂ value for glass transition.          Parameters         --------, Get separation parameter ε = (v₂ - v₂_c)/v₂_c., Set separation parameter and update v₂ accordingly., get_microscopic_stress_prefactor(), Compute two-time strain decorrelation for full ITT-MCT memory kernel.      The f, Pre-compute weights for microscopic stress integration.      The microscopic MCT, Get total microscopic stress prefactor for schematic models.      For F₁₂ schema (+20 more)

### Community 128 - "Community 128"
Cohesion: 0.07
Nodes (22): ndarray, Internal relaxation simulation for model_function.          For constant breakag, Internal creep simulation for model_function.          Returns accumulated strai, Internal LAOS simulation for model_function.          Returns (strain, stress) a, Simulate startup flow at constant shear rate.          Parameters         ------, Simulate stress relaxation after cessation of steady shear.          For constan, Simulate creep deformation under constant stress.          Parameters         --, Simulate Large-Amplitude Oscillatory Shear (LAOS).          Parameters         - (+14 more)

### Community 129 - "Community 129"
Cohesion: 0.07
Nodes (31): _fit_prony_oscillation(), _fit_prony_relaxation(), _prony_to_frequency(), _prony_to_frequency_jax(), _prony_to_time(), _prony_to_time_jax(), PronyConversion, Any (+23 more)
...
Cohesion: 0.07
Nodes (27): Reset the singleton instance (useful for testing)., setup_function(), setup_function(), Any, QApplication, Reset StateStore singleton before each test., Get or create QApplication instance., Test FitPage can be instantiated and models loaded. (+19 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (27): PriorsEditor, _diagnostics_verdict(), NutsStep, FitState, Seed the editable PriorsEditor from the NLSQ MAP estimate.          Converts map, Clear a stale skip decision when an upstream NLSQ re-run invalidates         nut, Summarize NUTS convergence diagnostics into a pass/fail verdict.      Per the de, # NOTE: The real implementation must: (+19 more)

### Community 134 - "Community 134"
Cohesion: 0.07
Nodes (23): QTableWidgetItem, Handle successful preview load (called on main thread via signal)., Detect the file format for user feedback., DiagnosticsPage, Any, BayesianResult, FitResult, Populate the per-parameter R-hat/ESS table from a BayesianResult. (+15 more)

### Community 135 - "Community 135"
Cohesion: 0.06
Nodes (30): available_plot_styles(), get_icon_path(), load_plot_style(), Path, GUI Resources ============  Loader helpers for stylesheets, plot styles, and ico, Return the list of bundled matplotlib style names., Load a matplotlib style file bundled with the GUI.      Falls back to the defaul, Return the path to an SVG icon bundled with the GUI.      Parameters     ------- (+22 more)
...
Cohesion: 0.07
Nodes (19): BaseContext, Exception, ProcessCancellationToken, Event, Store an error that occurred during execution.          Parameters         -----, Get any error that occurred.          Returns         -------         Exception, Wait for cancellation.          Parameters         ----------         timeout :, Reset cancellation state.          Clears both the cancellation flag and any sto (+11 more)

### Community 140 - "Community 140"
Cohesion: 0.08
Nodes (23): Process, ProcessWorkerAdapter, Queue, Run a work function inside a ``multiprocessing.Process``.      The adapter start, Execute the work function in a child process.          Called by QThreadPool.  B, Request cancellation with escalation to SIGTERM/SIGKILL., Poll *result_queue* until a terminal message arrives or the         child dies u, Drain any remaining messages after the process has exited.          If a termina (+15 more)
...
Cohesion: 0.11
Nodes (23): DataStep, FitState, Shape/NaN/monotonicity checks against a loaded RheoData. Empty = valid., Execute the Hz -> rad/s (x2pi) conversion flagged by needs_hz_conversion()., Derive (contract, label text) from the current state's protocol/model_key., Rebuild contract/label/combo from current state (call after Step 1 edits)., _validate_shape_and_values(), _ref() (+15 more)
...
Cohesion: 0.06
Nodes (21): Single-mode Transient Network Theory model.      Implements the Green-Tobolsky /, Compute stress overshoot ratio in startup flow.          For constant breakage,, Get network modulus G (Pa)., Get bond lifetime τ_b (s)., Get solvent viscosity η_s (Pa·s)., Get zero-shear viscosity η₀ = G·τ_b + η_s (Pa·s)., Get slip parameter ξ., Whether this is the basic (constant/linear/UC) variant. (+13 more)
...
Cohesion: 0.09
Nodes (38): _add_sample_to_buffers(), _build_segment_metadata(), convert_units(), _create_rheodata_chunk(), _determine_xy_columns(), _infer_domain_and_mode(), _parse_headers_and_units(), _parse_row_values() (+30 more)

### Community 148 - "Community 148"
Cohesion: 0.07
Nodes (20): MastercurvePipeline, RheoData, Execute SPP analysis on amplitude sweep data.          Args:             stress_, Load datasets sequentially., Load datasets in parallel using threads (I/O-safe)., Merge multiple datasets with temperature metadata.          Args:             da, Apply horizontal shift to create mastercurve.          This implements a simplif, Get computed shift factors.          Returns:             Dictionary mapping tem (+12 more)
...
Cohesion: 0.09
Nodes (37): compute_complex_modulus_from_correlator(), compute_adaptive_t_max(), FlowCurveParams, make_flow_curve_vector_field(), make_flow_curve_with_stress_vector_field(), ndarray, Compute physics-based adaptive integration time.      The relaxation timescale d, Create vector field that also integrates stress.      The stress is the time int (+29 more)
...
Cohesion: 0.07
Nodes (30): get_model_protocol_ids(), _get_simulation_ids(), _get_simulation_pairs(), ProtocolDataFactory, Any, ndarray, Protocol validation tests for all registered models.  This module validates th, Generate minimal test data for a given protocol.          Args:             p (+22 more)

### Community 154 - "Community 154"
Cohesion: 0.07
Nodes (19): Get list of all registered model names.          Returns:             List of mo, Get list of all registered transform names.          Returns:             List o, Get all registered plugins with their types.          Returns:             Dicti, Clear all registered plugins., Get total number of registered plugins.          Returns:             Total coun, Check if a plugin name is registered.          Args:             name: Plugin na, Get registration statistics.          Returns:             Dictionary with count, Export registry state for serialization.          Returns:             Dictionar (+11 more)

### Community 155 - "Community 155"
Cohesion: 0.07
Nodes (24): _load_schema(), parse_trios_json(), Any, Path, Low-level JSON parser returning TRIOSExperiment and metadata.      Args:, Load the bundled TRIOS JSON schema.      Returns:         Schema dictionary or N, Validate JSON data against bundled TRIOS schema.      Args:         data: Parsed, validate_schema() (+16 more)
...
Cohesion: 0.11
Nodes (36): _bounds_midpoint(), _clamp_to_bounds(), _compute_data_features(), _est_eta_0(), _est_modulus(), _est_prony_modulus(), _est_prony_tau(), _est_tau() (+28 more)
...
Cohesion: 0.07
Nodes (19): Handle batch fit action — opens the BatchPanel dialog., BatchPanel, Open a directory picker and populate the directory field., Scan the directory for files matching the pattern., Emit batch_requested with the current directory, pattern, and file list., Cancel an in-progress batch run., Update the status cell for a single file row.          Parameters         ------, Update the progress bar and status label.          Parameters         ---------- (+11 more)
...
Cohesion: 0.06
Nodes (31): PlotMetrics, Clear all collected metrics., Track plot rendering performance metrics.      This class collects timing data f, Get statistics for a plot type.          Parameters         ----------         p, Get statistics for all plot types.          Returns         -------         dict, app_state_instance(), contains_emoji(), emoji_checker() (+23 more)

### Community 162 - "Community 162"
Cohesion: 0.08
Nodes (25): Colors, DetailedFormatter, get_formatter(), JSONFormatter, Any, Formatter, LogRecord, RheoJAX Log Formatters.  Custom formatters for human-readable, detailed, JSON, a (+17 more)
...
Cohesion: 0.12
Nodes (33): Hébraud–Lequeux (HL) Model implementation.  This module implements the Hébraud–L, Model function for Bayesian inference (NumPyro NUTS).          Args:, _compute_dt_and_steps_for_rate(), creep_kernel(), flow_curve_kernel(), HLState, laos_kernel(), _physics_step() (+25 more)
...
Cohesion: 0.07
Nodes (22): GeneralizedMaxwell, Initialize Generalized Maxwell Model.          Args:             n_modes: Number, Extract diagnostics from NLSQ OptimizationResult.          Args:             nls, Classify NLSQ convergence quality.          Args:             diagnostics: Dicti, Construct Bayesian priors based on NLSQ convergence classification.          Arg, Get discrete relaxation spectrum (G_i, τ_i).          Returns:             Dicti, Get element minimization diagnostics.          Returns:             Dictionary w, Generalized Maxwell Model with N exponential relaxation modes.      The GMM uses (+14 more)
...
Cohesion: 0.07
Nodes (22): _G0_compute(), _G0_integrand(), Integrand for G0(x) equilibrium modulus integral.      G0(x) = integral_0^inf rh, Compute G0(x) using numerical quadrature (internal).      Parameters     -------, Exponential trap distribution for SGR model.      The trap energy distribution i, rho_trap(), Trap distribution rho(E) >= 0 for all E >= 0., Trap distribution rho(E) <= 1 for all E >= 0. (+14 more)
...
Cohesion: 0.08
Nodes (23): Figure, Any, Path, RheoData, Export Service =============  Service for exporting results to various formats (, Export figure to file.          Parameters         ----------         fig : Figu, Convert metadata values to JSON-serializable types., Export posterior samples.          Parameters         ----------         result (+15 more)

### Community 177 - "Community 177"
Cohesion: 0.06
Nodes (19): Parameter, Add a shared parameter.          Args:             name: Parameter name, Single parameter with value, bounds, and metadata.      A Parameter represents a, Get parameter bounds., Set parameter bounds and sync any bounds constraint., Set parameter value with validation., Return True if the last assignment clamped the value., Make Parameter hashable for use as dict keys.          Returns:             Hash (+11 more)
...
Cohesion: 0.07
Nodes (29): bayesian_result_from_dict(), fit_result_from_dict(), Reconstruct a ``FitResult`` dataclass from a subprocess result dict.      Parame, Reconstruct a ``BayesianResult`` dataclass from a subprocess result dict.      P, Tests for subprocess worker isolation., Work function that returns a simple result., Work function that raises ValueError., Work function that raises CancellationError. (+21 more)

### Community 180 - "Community 180"
Cohesion: 0.07
Nodes (21): Any, DataFrame, TRIOS JSON DataSet dataclass.  This module provides the TRIOSDataSet dataclass f, Extract units mapping from column definitions.          Returns:             Dic, Get list of column names., Get number of data rows., Get number of columns., Dataset containing column definitions and values.      Represents a single datas (+13 more)

### Community 181 - "Community 181"
Cohesion: 0.08
Nodes (20): _make_mock_spp_results(), Test that header row matches MATLAB SPPplus format., Test that analysis parameters are written to file., Test Fourier analysis type creates correct filename., Create mock SPP results dict for testing., Tests for MATLAB-compatible dict export., Test that dict contains out_spp key., Test that out_spp has info, headers, and data. (+12 more)
...
Cohesion: 0.08
Nodes (19): Manages parameters shared across multiple models., Initialize shared parameter set., Link a parameter set to a shared parameter.          Args:             param_set, Create a parameter group.          Args:             group_name: Name for the gr, Check if shared parameter exists., SharedParameterSet, Tests for parameter management system.  This test suite ensures proper parameter, Test shared parameter management across models. (+11 more)

### Community 191 - "Community 191"
Cohesion: 0.12
Nodes (20): DatasetRef, pipeline_context_from_library(), pipeline_inputs_from_library(), Any, Seed a PipelineExecutionService.execute_single_step context from a     Workspace, §11 boundary: feed the legacy pipeline from the new Dataset Library.      Resolv, The whole point: a derived dataset (no backing file) must still be     usable as, _ref() (+12 more)

### Community 192 - "Community 192"
Cohesion: 0.08
Nodes (23): Apply element minimization with padded arrays to avoid JIT recompilation., compute_r_squared(), create_prony_parameter_set(), Create ParameterSet for N-mode Prony series.      Dynamically generates paramete, Compute R² coefficient of determination.      R² = 1 - SS_res / SS_tot     where, Select optimal number of modes using R² threshold criterion.      Algorithm:, Compute softmax penalty for negative moduli in Step 1 fitting.      This differe, select_optimal_n() (+15 more)

### Community 193 - "Community 193"
Cohesion: 0.09
Nodes (18): Conventional Shear Transformation Zone (STZ) Model.      Implements STZ plastici, STZConventional, Test model_function uses sigma_0 for relaxation initial condition., Test model_function routes creep mode with sigma_applied kwarg., Test model_function routes LAOS mode with gamma_0 and omega., Test model_function raises when test_mode is not set., Test _predict works after setting test_mode., Test that model maintains float64 precision. (+10 more)

### Community 194 - "Community 194"
Cohesion: 0.07
Nodes (18): Loop-bridge kinetics model for telechelic polymer networks.      Implements reve, Initialize TNT loop-bridge model., Initialize ParameterSet with loop-bridge parameters.          Parameters:, Get network modulus G (Pa)., Get bridge detachment time τ_b (s)., Get loop attachment time τ_a (s)., Get Bell force sensitivity ν (dimensionless)., Get equilibrium bridge fraction f_B_eq (dimensionless). (+10 more)
...
Cohesion: 0.07
Nodes (20): Smoke tests validating the test framework itself., Verify all framework imports work correctly., Verify examples directory structure exists., Verify tolerance levels are reasonable., Test that notebook execution helper functions are callable., Test relative error validation with values that should pass., Test R-hat validation with passing values., Test ESS validation with passing values. (+12 more)

### Community 197 - "Community 197"
Cohesion: 0.08
Nodes (27): NotebookNode, convergence_thresholds(), _enable_custom_models_fast_mode(), examples_dir(), expected_parameter_values(), _extract_cell_output(), _extract_fitted_parameters(), _extract_variable_from_output() (+19 more)
...
Cohesion: 0.06
Nodes (21): Extract Fourier harmonics from LAOS data.          Parameters         ----------, Compute Weissenberg number Wi = t_R * gamma_dot., Compute Deborah number De = t_R * omega., Network modulus (Pa)., Unstressed dissociation rate (1/s)., Force sensitivity parameter (Bell only)., Maximum extensibility (FENE only)., Equilibrium relaxation time t_R = 1/k_d_0 (s). (+13 more)

### Community 200 - "Community 200"
Cohesion: 0.09
Nodes (12): PersistentProcessPool, Process pool with long-lived workers for JAX-safe parallel execution.      Each, Run model fits in parallel subprocesses., _raise_error(), Tests for PersistentProcessPool., Futures submitted but not completed before shutdown get an error., Test persistent process pool lifecycle and task execution., TestPersistentProcessPool (+4 more)
...
Cohesion: 0.11
Nodes (16): Any, FitState, ndarray, Build (or pass through) an ArviZ InferenceData from nuts_result.          Mirror, Fit-workflow step 5: Fit overlay / Residuals / Diagnostics tabs.      ``state.nl, Reshape a flat (chains*draws,) array to (chains, draws) for ArviZ., Re-populate tabs from current state (call after NLSQ/NUTS updates)., VisualizeStep (+8 more)

### Community 205 - "Community 205"
Cohesion: 0.11
Nodes (24): Unified file I/O for rheological data.  This module provides readers and writers, export_spp_csv(), export_spp_hdf5(), export_spp_txt(), _extract_spp_arrays(), ndarray, Path, SPP (Sequence of Physical Processes) data export module.  This module provides e (+16 more)
...
Cohesion: 0.11
Nodes (17): get_default_workers(), get_parallel_config(), is_sequential_mode(), Any, Get full parallel configuration as dict.      Takes a snapshot of _overrides und, Optimal worker count for the current system.      Priority: sequential mode (ret, Check if all parallelism is disabled.      Automatically enabled when running un, _no_xdist_env() (+9 more)
...
Cohesion: 0.09
Nodes (22): check_divergences(), check_ess(), check_posterior_accuracy(), check_r_hat(), Check Gelman-Rubin R-hat convergence diagnostic.      Args:         diagnostics:, Check effective sample size (ESS) diagnostic.      Args:         diagnostics: Di, Check NUTS divergence rate diagnostic.      Args:         diagnostics: Dictionar, Check if posterior mean matches reference within tolerance.      Args:         p (+14 more)
...
Cohesion: 0.10
Nodes (28): 10. Creep Compliance, 11. Bell Model Force-Dependent Dissociation, 12. FENE-P Finite Extensibility, 1. Distribution Tensor Evolution Equation, 2. Cauchy Stress, 3. Free Energy, 4. Dissipation, 5. Simple Shear Flow Components (+20 more)
...
Cohesion: 0.12
Nodes (14): _constructor_params(), _make_config_widget(), ProtocolModelStep, Any, FitState, Test/programmatic helper: apply a config dict to the widgets, then commit it., Introspect a model class's __init__ for configurable constructor kwargs.      Re, Return (widget, getter) for a supported annotation, or (None, None). (+6 more)
...
Cohesion: 0.08
Nodes (22): compute_thixotropic_stress(), evolve_thixotropy_lambda(), ndarray, Compute stress response with thixotropic modulus.      The effective modulus is, Get shift factors as arrays for plotting.          Parameters         ----------, Strain-Rate Frequency Superposition (SRFS) transform.      SRFS collapses flow c, Evolve structural parameter lambda(t) for given shear history.      Integrates t, SRFS (+14 more)
...
Cohesion: 0.07
Nodes (22): dmt_exponential(), dmt_herschel_bulkley(), dmt_nonlocal(), dmt_viscous(), Unit tests for DMT (de Souza Mendes-Thompson) models.  Tests cover: - Model crea, Viscous variant LAOS fit works., Tests for LAOS predict dispatch., model._predict(t, test_mode='laos') should not raise. (+14 more)

### Community 221 - "Community 221"
Cohesion: 0.07
Nodes (21): dynamic_x_model(), fluid_model(), glass_model(), model(), Extended tests for SGRGeneric model with advanced features.  This module conta, Test eig(M) >= 0 for 2D state., Test W >= 0 for 2D state., Test full thermodynamic verification for 2D state. (+13 more)
...
Cohesion: 0.12
Nodes (15): action_has_receivers(), RheoJAX GUI Menu Actions Tests.  Regression tests ensuring all menu bar actions, Check if a QAction has any receivers connected to its triggered signal.      In, Verify all Transforms menu actions have handlers., Verify all Analysis menu actions have handlers., Verify all Pipeline menu actions have handlers., Test that all menu bar actions are connected to handlers.      This test class e, Test that toolbar/menu actions are connected to handlers. (+7 more)

### Community 232 - "Community 232"
Cohesion: 0.07
Nodes (15): Test Bayesian inference notebooks with ArviZ diagnostics, Test model comparison notebook executes without errors., Validate that three models are fitted (Maxwell, Zener, SpringPot)., Validate that ArviZ compare function is used., Validate that WAIC is computed., Test uncertainty propagation notebook executes without errors., Validate that Zener model is used (4 parameters with correlations)., Validate that derived quantities (tau) are computed with uncertainty. (+7 more)
...
Cohesion: 0.10
Nodes (16): ParameterConstraint, Validate parameter after initialization., Constraint on a parameter value., Check if value satisfies the constraint.          Args:             value: Value, Verify score() returns NaN instead of 0.0 for broken predictions., score() should return NaN when predictions contain NaN., TestScoreNaNHandling, Test applying multiple constraints. (+8 more)
...
Cohesion: 0.10
Nodes (15): FractionalZenerSolidLiquid, ndarray, Predict relaxation modulus G(t).          G(t) = G_e + c_α * t^(-α) * E_{1-α,1}(, Predict creep compliance J(t).          Note: Analytical creep compliance for FZ, Predict complex modulus G*(ω).          G*(ω) = G_e + c_α * (iω)^α / (1 + (iωτ)^, Predict response for given input.          Parameters         ----------, Model function for Bayesian inference.          This method is required by Bayes, Fractional Zener Solid-Liquid model.      A fractional viscoelastic model combin (+7 more)

### Community 239 - "Community 239"
Cohesion: 0.11
Nodes (16): Recover relaxation spectrum H(τ) from viscoelastic data.      Args:         meth, SpectrumInversion, Tests for SpectrumInversion transform., Test maximum entropy spectrum inversion., Test Tikhonov-regularized spectrum inversion., MaxEnt should produce non-negative spectrum., Unknown method should raise ValueError., n_tau=1 should raise ValueError (need >=2 for d(ln tau) bins). (+8 more)
...
Cohesion: 0.12
Nodes (22): ikh_scan_kernel(), make_ml_ikh_creep_ode_rhs_per_mode(), make_ml_ikh_creep_ode_rhs_weighted_sum(), make_ml_ikh_maxwell_ode_rhs_per_mode(), make_ml_ikh_maxwell_ode_rhs_weighted_sum(), ml_ikh_creep_ode_rhs_per_mode(), ml_ikh_creep_ode_rhs_weighted_sum(), ml_ikh_flow_curve_steady_state_per_mode() (+14 more)
...
Cohesion: 0.08
Nodes (14): Test FIKH model predictions., Create isothermal FIKH model., Test startup prediction produces valid output., Test startup shows stress overshoot characteristic of EVP., Test steady-state flow curve prediction., Test flow curve shows yield stress behavior., Test LAOS prediction., predict_laos must densify like the fit path.          Regression for the 2026-04 (+6 more)
...
Cohesion: 0.15
Nodes (14): _plot_as_line(), Any, TransformState, Best-effort extraction of (x, y) from a RheoData-like object or dict.      `stat, Rebuild tabs from the current transform_key/result.          Bodies are construc, TransformVisualizeStep, _xy(), test_category_handles_unregistered_transform_key_without_crashing() (+6 more)

### Community 252 - "Community 252"
Cohesion: 0.18
Nodes (24): Run protocol-aware quality checks on loaded rheological data.      Infers the te, validate_protocol(), _creep_data(), _oscillation_data(), RheoData, Tests for rheojax.io.readers._validation.  All tests are marked smoke so they ru, Create synthetic relaxation data., Create synthetic oscillation data spanning n_decades. (+16 more)

### Community 253 - "Community 253"
Cohesion: 0.15
Nodes (22): banding_ratio(), detect_shear_bands(), laplacian_1d_neumann(), ndarray, JAX-accelerated physics kernels for Fluidity-Saramito EVP models.  This module i, Detect shear banding from fluidity profile.      Args:         f_field: Fluidity, Compute steady-state flow curve with minimal coupling (constant τ_y)., Compute steady-state flow curve with full coupling (τ_y depends on f). (+14 more)

### Community 254 - "Community 254"
Cohesion: 0.10
Nodes (19): evolution_lambda(), ikh_creep_ode_rhs(), ikh_maxwell_ode_rhs(), macaulay(), radial_return_step(), radial_return_step_corrected(), ODE RHS for stress-controlled creep.      State: y = [γ, α, λ]     - γ: Total st, Macaulay brackets: max(x, 0). (+11 more)
...
Cohesion: 0.09
Nodes (14): Connect internal signals., Initialize ArviZ canvas.          Parameters         ----------         parent :, BaseArviZWidget, Any, Figure, Base class for widgets that embed ArviZ figures.      Provides a standardized pr, Initialize base widget.          Parameters         ----------         parent :, Release matplotlib resources before Qt widget deletion.          Prevents segfau (+6 more)
...
Cohesion: 0.11
Nodes (17): Any, Fit SPPYieldStress model to extracted yield stresses.          Args:, Get full SPP results for a specific amplitude.          Args:             gamma_, Get fitted SPPYieldStress model.          Returns:             Fitted model or N, Get nonlinearity metrics (I3/I1, S, T) for each amplitude.          Returns:, Get detailed results for a specific model.          Args:             model_name, Pipeline for SPP analysis of amplitude sweep LAOS data.      This pipeline perfo, SPPAmplitudeSweepPipeline (+9 more)
...
Cohesion: 0.08
Nodes (16): Tests for TNTStickyRouse model.  Tests cover: - Instantiation and parameter m, Tests for derived property methods., When tau_s very small, plateau modulus should be near zero.          With no s, When tau_s very large, all modes contribute to plateau., Test η₀ from method matches low-rate flow curve., Test N1 prediction works for both scalar and array input., Tests for model registry integration., Test model creation via registry. (+8 more)
...
Cohesion: 0.09
Nodes (13): Handle preferences action., PreferencesDialog, Any, Handle dialog accept., Handle dialog reject., Handle dialog show event., Application preferences dialog.      Settings organized in tabs:         - Gener, Load current preferences into UI. (+5 more)
...
Cohesion: 0.14
Nodes (11): FractionalZenerLiquidLiquid, ndarray, Predict complex modulus G*(ω).          G*(ω) = c_1 * (iω)^α / (1 + (iωτ)^β) + c, Predict relaxation modulus G(t).          Approximate form (no exact closed-form, Predict creep compliance J(t).          Note: Analytical creep compliance is com, Predict response for given input.          Parameters         ----------, Model function for Bayesian inference.          This method is required by Bayes, Fractional Zener Liquid-Liquid model.      The most general fractional Zener mod (+3 more)

### Community 274 - "Community 274"
Cohesion: 0.12
Nodes (12): ndarray, Get all mode parameters as JAX arrays.          Uses vectorized extraction via g, Predict response.          Parameters         ----------         x : array-like, NumPyro/BayesianMixin model function.          Parameters         ----------, Internal SAOS prediction., Predict SAOS storage and loss moduli.          Parameters         ----------, Internal flow curve prediction (steady shear).          For multi-mode Giesekus,, Predict steady shear stress.          Parameters         ----------         gamm (+4 more)
...
Cohesion: 0.09
Nodes (17): _hits(), The shear-only fit remains numerically identical to the pre-strip fit., Only the central removed-option rejection boundary may name old keys., test_analysis_exporter_does_not_copy_retired_metadata(), test_csv_reader_does_not_create_retired_metadata(), test_excel_reader_does_not_create_retired_metadata(), test_legacy_hdf5_deformation_metadata_is_rejected(), test_maxwell_shear_relaxation_fit_matches_pre_strip_baseline() (+9 more)

### Community 278 - "Community 278"
Cohesion: 0.14
Nodes (5): Get the global registry instance., Get the singleton registry instance.          Returns:             The global Re, Initialize model service., Save and clear registry before each test., Restore registry state after each test.
...
Cohesion: 0.13
Nodes (14): _is_placeholder_model(), Any, FitResult, ndarray, RheoData, Generate model predictions.          Parameters         ----------         model, Return True when the incoming name is a UI placeholder or empty., Map friendly aliases to registered model slugs. (+6 more)

### Community 281 - "Community 281"
Cohesion: 0.11
Nodes (11): Compute 3D Poisson bracket operator L(z) for dynamic x mode.          The 3x3 Po, Compute 3D friction matrix M(z) for dynamic x mode.          Block-diagonal stru, Compute gradient dF/dz of free energy.          The gradient components are:, Compute entropy production rate W at given state.          The entropy productio, Verify all GENERIC thermodynamic consistency conditions.          Checks:, Compute Poisson bracket operator L(z).          The Poisson bracket generates re, Compute friction matrix M(z).          The friction matrix generates irreversibl, Compute reversible (Hamiltonian) part of dynamics.          dz/dt|_rev = L(z) * (+3 more)

### Community 282 - "Community 282"
Cohesion: 0.11
Nodes (13): Initialize multi-species TNT model.          Parameters         ----------, Initialize ParameterSet with 2N+1 parameters.          Parameters are organized, Get number of bond species N., Get solvent viscosity η_s (Pa·s)., Multi-species Transient Network Theory model.      Implements a network with N i, TNTMultiSpecies, Tests for physical correctness and consistency., Test equilibrium conformation for 2 modes is [1,1,1,0, 1,1,1,0]. (+5 more)
...
Cohesion: 0.09
Nodes (14): Tests for HVM (Hybrid Vitrimer Model).  Test organization: - TestHVMCreation:, Stress relaxation after step strain., G(0+) ≈ G_P + G_E + G_D., G(t → inf) → G_P (permanent network plateau)., G(t) decreases monotonically., No NaN in relaxation modulus., NumPyro Bayesian integration., model_function is callable with array params. (+6 more)
...
Cohesion: 0.10
Nodes (10): Convert arrays to JAX arrays.          Returns cached result on subsequent calls, Convert arrays to NumPy arrays.          Uses np.asarray() for zero-copy convers, Create a copy of the RheoData.          Returns:             Copy of the RheoDat, Support indexing and slicing., Add two RheoData objects or scalar., Subtract two RheoData objects or scalar., Multiply by scalar or another RheoData., Compute numerical derivative.          Returns:             RheoData with deriva (+2 more)

### Community 289 - "Community 289"
Cohesion: 0.10
Nodes (12): AboutDialog, QWidget, Handle dialog show event., Handle link clicks.          Parameters         ----------         url : QUrl, About dialog with version info.      Content:         - RheoJAX version and logo, Initialize about dialog.          Parameters         ----------         parent :, Set up user interface., Test that dialogs are properly integrated with menu actions. (+4 more)

### Community 290 - "Community 290"
Cohesion: 0.11
Nodes (12): Path, RheoData, Preprocess data with filtering and smoothing.          Parameters         ------, Extract a scalar temperature from a column in *file_path*.          Reads up to, Extract temperature from a filename like ``foam_dma_-5C.csv``.          Recognis, Load data from file, returning all segments.          Like :meth:`load_file` but, Convert common units to canonical values.          - Frequency: Hz -> rad/s, Auto-detect test mode from data characteristics.          Analyzes column names, (+4 more)

### Community 291 - "Community 291"
Cohesion: 0.15
Nodes (20): Emitted for data quality issues detected during loading or validation.      Subc, RheoJaxValidationWarning, _check_creep(), _check_oscillation(), _check_relaxation(), _check_rotation(), _check_startup(), _infer_protocol() (+12 more)

### Community 292 - "Community 292"
Cohesion: 0.15
Nodes (10): ndarray, Predict homogeneous (no banding) flow curve.          Parameters         -------, Predict flow curve.          Parameters         ----------         gamma_dot : n, Simulate startup with spatial resolution.          Parameters         ----------, Simulate creep with spatial resolution.          Parameters         ----------, Build args dictionary for PDE integration.          Parameters         ---------, Detect shear banding from fluidity profile.          Parameters         --------, NumPyro/BayesianMixin model function.          Accepts protocol-specific kwargs (+2 more)
...
Cohesion: 0.16
Nodes (11): ndarray, Predict SAOS moduli (Maxwell, analytical).          In the linear regime, Bell r, Predict steady-state first normal stress difference N1.          For Bell breaka, Simulate startup shear.          Parameters         ----------         t : np.nd, Simulate stress relaxation after cessation of flow.          Parameters, Simulate creep (stress-controlled).          Parameters         ----------, Simulate Large Amplitude Oscillatory Shear (LAOS).          Parameters         -, Predict steady-state extensional stress.          For FENE-P, extensional stress (+3 more)

### Community 295 - "Community 295"
Cohesion: 0.10
Nodes (11): Test basic model fitting notebooks (Maxwell, Zener, SpringPot, etc.), Verify basic notebooks directory exists and has expected structure., Test Zener model fitting notebook executes without errors., Validate Bayesian inference convergence for Zener model., Test SpringPot model fitting notebook executes without errors., Validate SpringPot alpha parameter is in valid range [0, 1]., Test Bingham model fitting notebook executes without errors., Validate Bingham yield stress is detected and positive. (+3 more)
...
Cohesion: 0.18
Nodes (12): FitController, Editing a completed step bumps revision and re-locks everything downstream., Step, TransformController, WorkflowController, _ctl(), test_advance_gated_by_ready(), test_can_advance_blocked_by_validate() (+4 more)

### Community 301 - "Community 301"
Cohesion: 0.16
Nodes (18): normalize_temperature(), normalize_units(), floating, NDArray, Convert a temperature value to Kelvin.      Args:         value: Temperature val, Convert values to SI units.      Handles both multiplicative conversions (kPa ->, Tests for unified unit normalization (Phase 1)., test_celsius_to_kelvin() (+10 more)
...
Cohesion: 0.13
Nodes (13): Public API for parallel execution.  High-level convenience functions that hide p, configure(), get_worker_isolation(), Adaptive parallelism configuration.  Auto-detects optimal worker count based on, Override default parallel configuration.      Call once at application startup., Get worker isolation mode: 'subprocess' or 'thread'., __getattr__(), Parallel execution layer for RheoJAX.  Provides process-based parallelism for mo (+5 more)
...
Cohesion: 0.11
Nodes (11): QStatusBar, QWidget, Update JAX device and memory status.          Parameters         ----------, Application status bar with progress tracking and system indicators.      Layout, Update memory usage indicator.          Parameters         ----------         us, Update JAX device indicator.          Parameters         ----------         devi, Update float64 status indicator.          Parameters         ----------, Initialize status bar.          Parameters         ----------         parent : Q (+3 more)

### Community 315 - "Community 315"
Cohesion: 0.13
Nodes (8): FractionalMaxwellLiquid, Provide custom priors that stay near realistic data-informed scales., Prefer conservative NUTS settings for the stiff Mittag-Leffler kernel., Fractional Maxwell Liquid model: Spring in series with SpringPot.      This mode, Initialize Fractional Maxwell Liquid model., Test model initialization and parameters., TestFractionalMaxwellLiquidErrorHandling, TestFractionalMaxwellLiquidInitialization

### Community 316 - "Community 316"
Cohesion: 0.13
Nodes (12): plot_moduli_evolution(), Plot time-resolved moduli evolution (G'(t), G''(t), delta(t) vs t).      Paramet, JAX arrays are accepted., Tests for plot_moduli_evolution., Minimal call creates 2 subplots (G', G'')., Adding delta_t creates 3 subplots., Adding delta_t + G_speed creates 4 subplots., Gap-7: plot_moduli_evolution raises ValueError for single Axes with multi-panel. (+4 more)

### Community 317 - "Community 317"
Cohesion: 0.11
Nodes (10): Test adding parameters to set., Test retrieving parameters., Test setting parameter values., Test setting parameter values from array., Test getting parameter bounds., Test serializing parameter set., Test creating parameter set from dict., Test ParameterSet for managing multiple parameters. (+2 more)

### Community 318 - "Community 318"
Cohesion: 0.19
Nodes (17): Additional Observations, ADR-001: BaseModel God Class (1,610 lines, 44cc fit()), ADR-002: _fit() Boilerplate Duplication Across 41 Model Files, ADR-003: BayesianMixin at 2,163 Lines — Mixed Abstraction Levels, ADR-004: predict() Defensive kwargs Stripping (Lines 984-1021), ADR-005: GUI Complexity Hotspots, Consequences, Context (+9 more)
...
Cohesion: 0.12
Nodes (10): FluiditySaramitoBase, Get initial fluidity value based on waiting time.          For aged samples (t_w, Get effective yield stress based on coupling mode.          Parameters         -, Base class for Fluidity-Saramito EVP models.      Implements shared parameter ma, Get characteristic relaxation time λ = 1/(G*f_age).          This is the relaxat, Get Deborah number De = λ * ω (for oscillatory tests).          Returns, Get Weissenberg number Wi = λ * γ̇ (for steady/startup tests).          Returns, Return string representation. (+2 more)

### Community 322 - "Community 322"
Cohesion: 0.14
Nodes (9): Compute total shear stress from distribution tensor components., Return standard diffrax solver and controller., Predict response from fitted model., NumPyro/BayesianMixin model function.          Routes to appropriate prediction, Compute variant flow curve by running ODE to steady state.          For Bell bre, Internal startup simulation. Returns total shear stress sigma_xy(t)., Internal relaxation simulation.          Computes steady-state pre-shear conform, Internal creep simulation. Returns accumulated strain gamma(t). (+1 more)

### Community 323 - "Community 323"
Cohesion: 0.14
Nodes (11): parallel_load(), Any, Path, Load multiple data files in parallel using threads.      Uses ThreadPoolExecutor, Tests for parallel public API., Test parallel_load() for multi-file I/O., TestParallelLoad, Test parallel file loading end-to-end. (+3 more)

### Community 324 - "Community 324"
Cohesion: 0.11
Nodes (10): Any, Path, Generate ArviZ MCMC diagnostic suite (6 plots).          Requires a prior call t, Get pipeline execution history.          Returns:             List of (operation, Construct a FitResult from the last fitted model.          Returns:, Export the full analysis to a directory or file.          This bundles data, par, Save current data to file.          Args:             file_path: Output file pat, Save the most recent plot to file.          Convenience method for exporting plo (+2 more)
...
Cohesion: 0.11
Nodes (12): Tests for TNTMultiSpecies model.  Tests cover: - Instantiation and parameter, Tests for startup flow simulation., Test startup simulation runs and returns correct shape, finite., Startup should approach steady-state stress at long times., Test full conformation tensor return for all modes., Tests for model fitting., Test fitting to flow curve data., Tests for string representation. (+4 more)
...
Cohesion: 0.14
Nodes (10): Event, Queue, Any, ndarray, Subprocess Bayesian ==================  Pure function for NUTS Bayesian sampling, Run NUTS Bayesian sampling in an isolated subprocess.      Returns a serializabl, run_bayesian_isolated(), Task 7: target_accept passthrough — signature-level test, no MCMC runs. (+2 more)

### Community 341 - "Community 341"
Cohesion: 0.14
Nodes (9): RheoData, Stress relaxation: G(t) after step strain.          Args:             data: Rheo, Creep: Strain(t) at constant stress using Adaptive P-Controller.          The co, SAOS/LAOS: Stress(t) for sinusoidal strain.          Args:             data: Rhe, Initialize yield thresholds from Gaussian distribution.          Args:, Initialize stress field (subclass-specific shape).          Args:             ke, Initialize full simulation state.          Args:             key: PRNG key for r, Steady state flow curve: Stress vs Shear Rate.          Args:             data: (+1 more)

### Community 342 - "Community 342"
Cohesion: 0.14
Nodes (9): Any, Predict steady-state flow curve (compatibility wrapper)., Simulate transient response using Diffrax ODE integration.          Args:, Predict transient response.          Protocol inputs (``gamma_dot`` for startup,, SAOS prediction using linear viscoelastic approximation.          In the linear, Simulate LAOS response using Diffrax.          Args:             t: Time array, Simulate LAOS response.          Args:             gamma_0: Strain amplitude, NumPyro/BayesianMixin model function.          Routes to appropriate prediction (+1 more)

### Community 343 - "Community 343"
Cohesion: 0.18
Nodes (10): ndarray, RheoData, Tighten tau bounds based on data scale to avoid pathological samples., Predict relaxation modulus G(t) using JAX.          G(t) = G_m E_{α,1}(-(t/τ)^α), Predict creep compliance J(t) using JAX.          J(t) = (1/G_m) + (t^α)/(G_m τ^, Predict complex modulus G*(ω) using JAX.          G*(ω) = G_m (iωτ_α)^α / (1 + (, Internal predict implementation.          Args:             X: RheoData object o, Model function for Bayesian inference.          This method is required by Bayes (+2 more)

### Community 344 - "Community 344"
Cohesion: 0.14
Nodes (9): Any, Analytical steady-state flow curve prediction.          At steady state (Langer, Simulate transient response using Diffrax ODE integration.          Args:, Predict transient response., SAOS prediction using linear viscoelastic approximation.          In the linear, Simulate LAOS response using Diffrax.          Args:             t: Time array, Simulate LAOS response.          Args:             gamma_0: Strain amplitude, NumPyro/BayesianMixin model function.          Routes to appropriate prediction (+1 more)
...
Cohesion: 0.14
Nodes (10): parallel_map(), Execute a function over items using process-based parallelism.      Each invocat, Test parallel_map() generic fan-out., TestParallelMap, Fit Maxwell to several datasets in parallel., Test parallel model fitting produces correct results., Single-exponential decay — fits Maxwell and Zener well., Parallel_map submits fits to subprocesses, collects results. (+2 more)
...
Cohesion: 0.13
Nodes (13): ndarray, Integrate the relaxation ODE at gamma_dot=0 and return sigma(t).      Uses the s, Numerical proof of the (G, f_eq, f_inf) scale degeneracy at gamma_dot=0., sigma(t) must be invariant (to 1e-6 relative) under the transform         (G, f_, Changing theta (at fixed G, f_eq, f_inf) must change sigma(t) —         theta is, Integrate FluidityNonlocal creep and return strain(t).      Uses a small grid (N, Numerical proof that G, f_inf, a, n_rejuv, xi are inert for the     nonlocal cre, Perturbing an inert parameter must leave creep strain(t) unchanged         to ~1 (+5 more)

### Community 350 - "Community 350"
Cohesion: 0.12
Nodes (9): Test suite for SGRConventional NLSQ fitting (Task Group 3)., Test basic oscillation mode fitting with synthetic data., Test basic creep mode fitting with synthetic data., Test basic steady shear mode fitting with synthetic data., Test oscillation fitting with complex array input., Test that fitting stores test_mode for mode-aware Bayesian inference., Test fitting robustness with noisy data., Test that invalid test_mode raises ValueError. (+1 more)
...
Cohesion: 0.12
Nodes (11): Tests for automatic shift factor calculation via power-law intersection method., Test sequential cumulative shift factor calculation., Test sequential pairwise cumulative shifting., Test power-law fitting with NLSQ (no scipy)., Test basic power-law fitting: y = a*x^b + e., Test that outlier detection logic works correctly., Test intersection-based shift factor calculation., Test shift calculation for overlapping curves. (+3 more)
...
Cohesion: 0.17
Nodes (11): LVEEnvelope, Compute the linear viscoelastic startup stress envelope.      The LVE envelope p, Tests for LVEEnvelope transform., Test analytical LVE envelope computation., Test LVEEnvelope as a BaseTransform., Basic transform with explicit Prony parameters., Read Prony params from data metadata., Should raise ValueError when no Prony params available. (+3 more)
...
Cohesion: 0.12
Nodes (9): Test retardation time calculation for creep., Test string representation., Test basic Zener model functionality., Test Zener model can be instantiated., Test Zener model has correct parameters., Test setting Zener parameters., Test parameter bounds are enforced., Test relaxation time calculation. (+1 more)
...
Cohesion: 0.12
Nodes (9): Test transition from elastic to plastic flow., Test Bauschinger effect from kinematic hardening.          The Bauschinger effec, Test flow curve against analytical steady-state solution., Tests for the MIKH model., Test MIKH model initialization and default parameters., Test that parameter bounds are physically sensible., Test pure elastic response (no yielding, no viscosity)., Test viscous-dominated response (very small elasticity, zero yield). (+1 more)
...
Cohesion: 0.23
Nodes (14): 1. Springpot (Scott Blair Element), 2. Fractional Maxwell Model (FMM) -- Two Springpots in Series, 3. Fractional Kelvin-Voigt (FKV) -- Two Springpots in Parallel, 4. Fractional Zener (Standard Linear Solid), 5. Relaxation Modulus for FMM, 6. Mittag-Leffler Function, 7. Creep Compliance for FMM, Fractional Viscoelastic Models: Equation Verification Report (+6 more)
...
Cohesion: 0.21
Nodes (8): ndarray, Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Predict relaxation modulus G(t).          Theory: G(t) = G_e + G_m * exp(-t/tau), Predict creep compliance J(t).          Theory: J(t) = 1/(G_e+G_m) + (G_m/(G_e*(, Predict complex modulus G*(omega).          Theory:             G'(omega) = G_e, Predict steady shear stress sigma(gamma_dot).          Theory: sigma = eta * gam, Test that prediction methods are JIT-compilable.

### Community 375 - "Community 375"
Cohesion: 0.17
Nodes (11): _jit_creep_kernel(), _jit_flow_curve_single(), _jit_oscillation_kernel(), Array, JIT-friendly creep simulation with controller substep.          The creep P-cont, JIT-friendly oscillation simulation., Dispatch to JIT-compiled creep kernel (substepped controller)., Dispatch to JIT-compiled oscillation kernel. (+3 more)
...
Cohesion: 0.16
Nodes (11): _ensure_matplotlib(), plot_pipkin_diagram(), ndarray, SPP (Sequence of Physical Processes) visualization module.  This module provides, Ensure matplotlib is available., Create Pipkin diagram (gamma_0 vs omega map) colored by a nonlinearity metric., Tests for plot_pipkin_diagram., Pipkin diagram creates figure with colorbar. (+3 more)

### Community 381 - "Community 381"
Cohesion: 0.17
Nodes (10): create_spp_report(), Figure, Create comprehensive SPP analysis report figure.      Generates a multi-panel fi, Tests for create_spp_report., Report creates 6-panel figure., Report with spp_results lacking delta_t hides 6th panel., gamma_0=0 raises ValueError., JAX arrays in strain/stress are accepted. (+2 more)

### Community 382 - "Community 382"
Cohesion: 0.14
Nodes (8): Test BaseModel abstract class., Test that BaseModel defines required interface., Test model fitting with numpy arrays., Test model prediction., Test model parameter management., Test model serialization., Test scikit-learn style interface., TestBaseModel

### Community 383 - "Community 383"
Cohesion: 0.13
Nodes (8): Test registering a transform., Test registering with metadata., Test that registering duplicate names raises error., Test force overwriting existing registration., Test that registering with invalid type raises error., Test plugin registration., Test registering a model., TestRegistryRegistration

### Community 384 - "Community 384"
Cohesion: 0.14
Nodes (8): Test model_function and Bayesian inference for DMT models., Test model_function returns correct flow curve (exponential)., Test model_function returns correct startup stress., Test model_function returns correct relaxation stress., Test model_function returns complex modulus for SAOS., Test model_function returns LAOS stress waveform., Smoke test: fit_bayesian works end-to-end for flow curve., TestDMTBayesian

### Community 385 - "Community 385"
Cohesion: 0.14
Nodes (8): Test apparent viscosity prediction., Test shear-thinning behavior (n < 1)., Test predictions for Herschel-Bulkley model., Test basic stress prediction: σ = σ_y + K γ̇^n., Test that stress is zero below yield threshold., Test that σ_y = 0 reduces to Power Law., Test that n = 1 reduces to Bingham model., TestHerschelBulkleyPredictions
...
Cohesion: 0.14
Nodes (7): Test model_function() for LatticeEPM., model_function for flow_curve should return array with correct shape., model_function for flow_curve should return positive stresses., model_function for startup should return array with correct shape., model_function for relaxation should return array with correct shape., model_function for creep should return array with correct shape., TestLatticeEPMModelFunction
...
Cohesion: 0.16
Nodes (7): Model function using general (non-JIT) methods (for TensorialEPM)., JAX-pure flow curve simulation (no RheoData, no numpy)., Extract the mean shear stress from a stress field.          For scalar EPM (shap, JAX-pure startup simulation., JAX-pure relaxation simulation., JAX-pure creep simulation with P-controller., JAX-pure oscillation simulation.

### Community 393 - "Community 393"
Cohesion: 0.14
Nodes (9): PowerLaw, String representation., Power Law model for non-Newtonian flow (ROTATION only).      The Power Law (Ostw, Initialize Power Law model., Test fitting with synthetic data., Test fit_predict method., Test that model_function output matches predict., Test float64 precision for a flow model.      Flow models have different physics (+1 more)

### Community 394 - "Community 394"
Cohesion: 0.15
Nodes (9): ml_ikh_scan_kernel(), ml_ikh_weighted_sum_kernel(), Multi-Lambda IKH scan kernel (per-mode yield surfaces).      Each mode has indep, ML-IKH with weighted-sum yield surface.      Single global yield surface: σ_y =, Stack per-mode parameters in a single pass.          Reduces repeated dict looku, Predict using parameter dictionary (for NLSQ/Bayesian)., Predict with per-mode yield surfaces., Predict with weighted-sum yield surface. (+1 more)
...
Cohesion: 0.19
Nodes (9): plot_cole_cole(), Create Cole-Cole diagram (G'' vs G') with optional time coloring.      Parameter, Tests for plot_cole_cole., Cole-Cole diagram creates single-axis figure., Trajectory mode with time coloring., Scatter mode (show_trajectory=False)., Mismatched G'/G'' lengths raise ValueError., Empty arrays produce a 'No data' text instead of crash. (+1 more)

### Community 400 - "Community 400"
Cohesion: 0.14
Nodes (13): Tests for Bayesian inference infrastructure.  This module tests the BayesianMixi, Test that BayesianResult dataclass has required fields., Test warm-start with complex oscillatory data converges properly.      This is a, Compare cold-start vs warm-start to verify warm-start benefit.      This test de, Test that seed parameter produces reproducible results., Test that default num_chains is 4 for production-ready diagnostics., Test that multi-chain sampling enables proper R-hat computation., test_bayesian_result_structure() (+5 more)
...
Cohesion: 0.14
Nodes (8): Test that auto_load properly classifies exceptions., FileNotFoundError propagates immediately., Passing a directory raises IsADirectoryError., An empty file should raise ValueError, not crash., A binary file should raise ValueError after trying all readers., PermissionError must propagate, not be caught as format mismatch., Valid CSV data loads successfully through auto_load., TestReaderCascade
...
Cohesion: 0.14
Nodes (8): Test string representation., Test basic Maxwell model functionality., Test Maxwell model can be instantiated., Test Maxwell model has correct parameters., Test setting Maxwell parameters., Test parameter bounds are enforced., Test relaxation time calculation., TestMaxwellBasics
...
Cohesion: 0.14
Nodes (9): Tests for Generalized Maxwell Model Bayesian inference integration.  This module, Test integration of prior safety with Bayesian inference., Test that fit_bayesian uses NLSQ estimates when convergence is good., Regression tests for F-GMM-001/002/003 GUI Bayesian pipeline bugs., F-GMM-001: infer_model_kwargs detects n_modes from G_i names., F-GMM-002: model_function uses _laos_omega/_laos_gamma_0 from self attrs., F-GMM-001: fit_bayesian works after element minimization reduces n_modes., TestGMMBayesianPipelineBugs (+1 more)
...
Cohesion: 0.17
Nodes (9): create_parser(), main(), ArgumentParser, CLI subcommand for NLSQ model fitting.  Usage:     rheojax fit data.csv --mod, Run NLSQ fit from CLI., Create argument parser for fit subcommand., CLI should NOT silently default to 'oscillation' for non-complex data., CLI should reject data with NaN values in x column.          Note: CSV reader re (+1 more)
...
Cohesion: 0.22
Nodes (6): config_to_builder(), Convert a :class:`PipelineConfig` into a :class:`PipelineBuilder`.      Defaults, TestConfigToBuilder, Path, Write YAML to disk, load it back, validate, and build., TestYAMLFileRoundtrip
...
Cohesion: 0.23
Nodes (7): ndarray, Predict response based on input data.          Args:             X: RheoData obj, Model function for Bayesian inference.          This method is required by Bayes, Predict relaxation modulus G(t).          Theory: G(t) = c_alpha * t^(-alpha) /, Predict creep compliance J(t).          Theory: J(t) = (1/c_alpha) * t^alpha / G, Predict complex modulus G*(omega).          Theory: G*(omega) = c_alpha * (i*ome, Test that prediction methods are JIT-compilable.

### Community 424 - "Community 424"
Cohesion: 0.22
Nodes (7): ndarray, Fit steady-state flow curve (stress vs shear rate).          Args:             g, Fit transient response (Stress Growth / Relaxation / Creep).          Args:, Fit oscillation data (SAOS or LAOS).          Routes to specific fitting method, Fit SAOS data using linear viscoelastic approximation.          In SAOS limit, S, Fit LAOS data using full ODE integration + FFT.          Args:             t: Ti, Fit STZ model to data.          Args:             X: Independent variable (time,
...
Cohesion: 0.26
Nodes (7): detect_material_type(), Detect the material type from relaxation or oscillation data.      Parameters, Test detection of solid from oscillation data., Test that no data returns UNKNOWN., Tests for material type detection., Test detection of solid-like material from relaxation., TestMaterialTypeDetection

### Community 428 - "Community 428"
Cohesion: 0.19
Nodes (8): plot_3d_trajectory(), Axes, Plot 3D (gamma, gamma_dot/omega, sigma) trajectory with optional Frenet-Serret f, Tests for plot_3d_trajectory., 3D trajectory creates figure with 3D axes., omega=0 raises ValueError., Empty strain array raises ValueError., TestPlot3DTrajectory
...
Cohesion: 0.21
Nodes (5): Tests for FitResult, ModelInfo, and ModelComparison., Test summary and display methods., Test to_dict and save/load., TestFitResultSerialization, TestFitResultSummary

### Community 431 - "Community 431"
Cohesion: 0.19
Nodes (8): find_test_mode_patterns(), Test the introspection helper functions themselves., Test detection of == patterns., Test detection of 'mode ==' shorthand patterns., Test getting source from a real model., Test detection of dedicated predict_* methods., Find test_mode values referenced in source code.      Searches for patterns li, TestIntrospectionHelpers

### Community 432 - "Community 432"
Cohesion: 0.15
Nodes (6): Restore registry state after each test., Test registry compatibility with plugin system., Test creating plugin instances through registry., Test listing plugins compatible with certain data., Test plugin versioning support., TestRegistryCompatibility

### Community 433 - "Community 433"
Cohesion: 0.15
Nodes (6): Test plugin validation., Test validation of model interface., Test validation of transform interface., Test that validation can be skipped., Save and clear registry before each test., TestRegistryValidation
...
Cohesion: 0.15
Nodes (7): return_full dict has expected keys., Creep compliance under constant stress., No NaN in creep strain., Strain is positive for positive stress., Strain increases with time under load., Higher applied stress → more strain., TestHVMCreep
...
Cohesion: 0.23
Nodes (7): Namespace, Validate a pipeline YAML config against the schema., run_validate(), load_config(), Path, Load and validate a YAML pipeline config file.      Args:         path: Filesyst, TestLoadConfig

### Community 442 - "Community 442"
Cohesion: 0.21
Nodes (9): is_monotonic_decreasing(), is_monotonic_increasing(), ndarray, Check if data is mostly monotonically increasing.      Args:         data: Array, Test monotonicity checking utilities., Test detection of monotonic increasing., Test detection of monotonic decreasing., Test monotonicity with small noise (tolerance). (+1 more)

### Community 443 - "Community 443"
Cohesion: 0.18
Nodes (7): Any, QWidget, Load current options into UI., Handle option change., Get export options.          Returns         -------         dict[str, Any], Initialize export options dialog.          Parameters         ----------, Set up user interface.
...
Cohesion: 0.24
Nodes (10): detect_excel_header_row(), extract_units_from_excel(), _is_numeric(), parse_excel_metadata(), Any, Extract metadata from early rows of Excel sheet.      TRIOS Excel exports have m, Find data table header row in Excel sheet.      Args:         sheet: openpyxl wo, Check if string represents a numeric value. (+2 more)

### Community 446 - "Community 446"
Cohesion: 0.18
Nodes (7): Zener (Standard Linear Solid) viscoelastic model.  The Zener model, also known a, Fit Zener model to data.          Args:             X: RheoData object or indepe, Get characteristic relaxation time tau = eta/G_m.          Returns:, Get characteristic retardation time for creep.          Theory: tau_c = eta * (G, String representation of Zener model., Initialize Zener model with default parameters., Zener

### Community 447 - "Community 447"
Cohesion: 0.18
Nodes (7): EPMBase, Check if this is a scalar (not tensorial) EPM.          Returns True for Lattice, Compute EPM predictions for BayesianMixin integration.          This method prov, Abstract base class for Elasto-Plastic Models.      This class provides common i, Initialize EPM base with common parameters.          The `fluidity_form` argumen, Extract parameters as dictionary for kernel calls.          Returns:, Perform one EPM time step (subclass-specific kernel).          Args:
...
Cohesion: 0.26
Nodes (7): HLGrid, make_grid(), Grid specification for HL solver.      Attributes:         sigma: Stress grid po, Create discretization grid for stress P(sigma).      Args:         sigma_max: Ma, Tests for rheojax.utils.hl_kernels (Hebraud-Lequeux kernels)., Tests for HL grid construction., TestHLGrid
...
Cohesion: 0.21
Nodes (8): Partition function for SGR model normalization.      Computes the normalization, Z(), Test Z(x, omega) partition function., Test Z(x) matches analytical formula: Z = x / (x + 1)., Test that Z is independent of frequency for equilibrium SGR., Test Z(x) asymptotic limits., Test that 0 <= Z(x) <= 1 for all x > 0., TestPartitionFunction

### Community 452 - "Community 452"
Cohesion: 0.17
Nodes (10): Simple model for testing BayesianMixin functionality., Initialize simple model., Simple linear model: y = a * X + b., Test that multi-chain sampling produces consistent results across chains., Test that chain_method is automatically selected based on num_chains and devices, Test that different seeds produce different results., SimpleBayesianModel, test_chain_method_auto_selection() (+2 more)

### Community 453 - "Community 453"
Cohesion: 0.17
Nodes (6): Tests for plugin registry system.  This test suite ensures the registry system c, Test automatic plugin discovery., Test discovering plugins in a module using decorators., Test plugin discovery using decorators., Test discovering plugins in custom path., TestRegistryDiscovery
...
Cohesion: 0.22
Nodes (6): QListWidgetItem, QWidget, Populate the list widget from the CLI template registry., Update the YAML preview and description when selection changes., Show the dialog and return the selected template name.          Parameters, Build the dialog layout.

### Community 484 - "Community 484"
Cohesion: 0.24
Nodes (6): QWidget, Create general settings tab., Create JAX settings tab., Create visualization settings tab., Initialize preferences dialog.          Parameters         ----------         cu, Set up user interface.
...
Cohesion: 0.24
Nodes (6): RheoData, Optimize WLF parameters to minimize overlap error.          Parameters         -, Apply horizontal shift to single-temperature data.          Parameters         -, Apply horizontal shift to single-temperature data or create mastercurve., Create mastercurve from multiple temperature datasets.          Parameters, Compute overlap error for multi-temperature data.          This metric quantifie
...
Cohesion: 0.18
Nodes (6): Test registry creation and initialization., Save registry state before each test., Test creating an empty registry., Test that registry follows singleton pattern., Test that models and transforms have separate namespaces., TestRegistryCreation

### Community 489 - "Community 489"
Cohesion: 0.18
Nodes (6): Test registry management operations., Test unregistering a plugin., Test clearing the registry., Test getting registry statistics., Test exporting and importing registry state., TestRegistryManagement
...
Cohesion: 0.20
Nodes (6): Tests for get_logger function., Test basic get_logger call., Test get_logger with initial context., Test get_logger returns cached instance., Test get_logger creates different loggers for different names., TestGetLogger
...
Cohesion: 0.20
Nodes (6): Test utility methods., Test relaxation spectrum for single mode., Test dimensionless number calculations., Test equilibrium distribution tensor., Test parameter dict round-trip., TestVLBUtilities

### Community 495 - "Community 495"
Cohesion: 0.18
Nodes (7): Validate Maxwell model against ANSYS MELAS reference., Test Maxwell fits ANSYS relaxation data correctly.          Expected behavior: P, Test that Maxwell predictions match ANSYS relaxation behavior.          Uses fit, Test Maxwell fits ANSYS creep data correctly.          Expected behavior on v0.3, Test ANSYS creep predictions match Maxwell model., TestMaxwellANSYSCreep, TestMaxwellANSYSRelaxation
...
Cohesion: 0.20
Nodes (6): Any, QWidget, Load current options into UI., Handle option change., Get Bayesian inference options.          Returns         -------         dict[st, Initialize Bayesian options dialog.          Parameters         ----------

### Community 501 - "Community 501"
Cohesion: 0.20
Nodes (6): Any, QWidget, Load current options into UI., Handle option change., Get fitting options.          Returns         -------         dict[str, Any], Initialize fitting options dialog.          Parameters         ----------

### Community 502 - "Community 502"
Cohesion: 0.31
Nodes (3): TransformState, TransformPickStep, test_groups_and_select()
...
Cohesion: 0.22
Nodes (8): Compute fluidity-dependent yield stress for full coupling mode.      τ_y(f) = τ_, ODE vector field for local Fluidity-Saramito model (stress-controlled creep)., saramito_local_creep_ode_rhs(), yield_stress_from_fluidity(), Tests for dynamic yield stress coupling., Test constant yield stress with zero coupling., Test increased yield stress at low fluidity., TestYieldStressCoupling
...
Cohesion: 0.20
Nodes (6): Tests for BaseModel.precompile() JIT precompilation., precompile() should return compilation time as a float., precompile() should not alter model parameters., precompile() should accept custom X and y arrays., An unfitted model should remain unfitted after precompile()., TestPrecompile
...
Cohesion: 0.20
Nodes (6): Tests for CSV export., Test that CSV file is created., Test that CSV has proper header row., Test that CSV includes Frenet-Serret columns when requested., Test that CSV has correct number of data rows., TestExportSppCsv
...
Cohesion: 0.20
Nodes (6): csv_files(), Tests for parallel batch processing., Create 5 minimal CSV files., Test thread-parallel I/O loading phase., parallel_io defaults to True., TestBatchParallelIO
...
Cohesion: 0.20
Nodes (8): laos_signals(), Tests for SPP (Sequence of Physical Processes) visualization module.  Covers a, Generate synthetic LAOS signals (1 cycle)., Generate synthetic SPP analysis results dict., Gap-5: create_spp_report uses strain_rate_normalized when present., When strain_rate_normalized is provided, it overrides computed rate., spp_results(), TestSPPReportStrainRateNormalized
...
Cohesion: 0.22
Nodes (4): _coerce_ndarray(), Convert any array-like input to a NumPy array for scalar ops., Number of dimensions of y data., Check if y data is complex.
...
Cohesion: 0.42
Nodes (7): ColumnSpec, input_contract(), InputContract, test_flow_curve_default_has_y_column(), test_flow_quantity_from_model(), test_oscillation_contract(), test_relaxation_contract()

### Community 575 - "Community 575"
Cohesion: 0.22
Nodes (9): get_active_bayesian_result(), get_all_bayesian_results(), get_bayesian_result(), is_bayesian_available(), BayesianResult, Get Bayesian result for active model and dataset.      Returns     -------     B, Get Bayesian result for specific model and dataset.      Parameters     --------, Get all Bayesian results.      Returns     -------     dict[str, BayesianResult] (+1 more)

### Community 576 - "Community 576"
Cohesion: 0.22
Nodes (9): get_active_fit_result(), get_all_fit_results(), get_fit_result(), is_fit_available(), FitResult, Get fit result for active model and dataset.      Returns     -------     FitRes, Get fit result for specific model and dataset.      Parameters     ----------, Get all fit results.      Returns     -------     dict[str, FitResult]         A (+1 more)
...
Cohesion: 0.22
Nodes (5): Figure, Connect internal signals., Get matplotlib figure.          Returns         -------         Figure, Initialize residuals panel.          Parameters         ----------         paren, Set up the user interface.

### Community 579 - "Community 579"
Cohesion: 0.25
Nodes (5): ndarray, Predict stress for given shear rates.          Args:             X: Shear rate d, Model function for Bayesian inference.          This method is required by Bayes, Compute shear stress using Herschel-Bulkley model.          Args:             ga, Fit Herschel-Bulkley parameters to data.          Args:             X: Shear rat
...
Cohesion: 0.22
Nodes (6): Tests for log_fit context manager., Test that fit-specific context is logged., Test that completion context is included., Tests for log_io context manager., TestLogFit, TestLogIO

### Community 585 - "Community 585"
Cohesion: 0.25
Nodes (5): Test stress prediction: σ = K * γ̇^n., Test Newtonian limit (n = 1)., Test predictions for Power Law model., Test viscosity prediction for shear-thinning (n < 1)., TestPowerLawPredictions

### Community 586 - "Community 586"
Cohesion: 0.25
Nodes (5): Smoke tests for model integration., Test FluidityLocal inherits from BaseModel., Test both models have fit method., Test both models have predict method., TestFluidityIntegrationSmoke
...
Cohesion: 0.22
Nodes (4): MockModel, Test fitting model instance., Simple mock model for testing., warm_start must not reach model.fit_bayesian (NUTS rejects it).
...
Cohesion: 0.25
Nodes (6): BayesianResult, FitResult, Compact panel to show fit/Bayesian summary metrics., Render a fit result summary., Render a Bayesian result summary., ResultsPanel

### Community 594 - "Community 594"
Cohesion: 0.25
Nodes (5): HerschelBulkley, Herschel-Bulkley model for viscoplastic flow (ROTATION only).      The Herschel-, String representation., Initialize Herschel-Bulkley model., Test that model_function output matches predict.
...
Cohesion: 0.25
Nodes (4): Test JAX functionality., Test vectorization over two parameters simultaneously., Test second derivatives for two parameters., TestFractionalMaxwellModelJAX

### Community 621 - "Community 621"
Cohesion: 0.25
Nodes (4): Test relaxation modulus., G(t) ~ (c1/tau^β) * t^(β-α) at short times., Test effect of having two independent fractional orders., TestFractionalMaxwellModelRelaxation
...
Cohesion: 0.25
Nodes (5): Test NLSQ fitting for MIKH., NLSQ fitting for flow curve should converge., NLSQ fitting for startup should converge., NLSQ should recover parameters within reasonable bounds., TestMIKHNLSQ

### Community 627 - "Community 627"
Cohesion: 0.25
Nodes (5): Test Bayesian inference for MIKH., Smoke test for Bayesian inference on MIKH., Bayesian inference should converge for startup data., Complete NLSQ → NUTS pipeline should work.          Uses flow_curve (not startup, TestMIKHBayesian
...
Cohesion: 0.25
Nodes (5): _maxwell_data(), hessian_ci raises RuntimeError on an unfitted model., bootstrap_ci raises RuntimeError on an unfitted model., Bootstrap 95% CI should cover the true parameter values for noisy data., Generate synthetic Maxwell relaxation data: G(t) = G0 * exp(-t/tau).
...
Cohesion: 0.38
Nodes (5): floating, PlotDataItem, NDArray, Plot data points.          Parameters         ----------         x : NDArray, Plot a line (typically for fits/predictions).          Parameters         ------

### Community 654 - "Community 654"
Cohesion: 0.29
Nodes (4): PlotWidget, Create toolbar with scale and export controls., Get the underlying PlotWidget for advanced customization., Initialize the PyQtGraph canvas.          Parameters         ----------
...
Cohesion: 0.33
Nodes (4): ArrayLike, Ensure data is a proper array., Interpolate data to new x values.          Args:             new_x: New x values, Resample data to specified number of points.          Args:             n_points

### Community 657 - "Community 657"
Cohesion: 0.29
Nodes (3): Any, Serialize to a plain dictionary.          Returns:             Dictionary with a, Save fit result to file. Format is dispatched by extension.          Supported e
...
Cohesion: 0.71
Nodes (5): invalidate_downstream(), FitState, test_changing_columnmap_keeps_data_clears_fits(), test_changing_model_clears_downstream(), test_changing_protocol_clears_control_vars_and_model_config()
...
Cohesion: 0.29
Nodes (5): RheoData, TestMode, Compute apparent viscosity using Herschel-Bulkley model.          Args:, Predict apparent viscosity for given shear rates.          Args:             gam, Predict rheological response for RheoData.          Args:             rheo_data:

### Community 664 - "Community 664"
Cohesion: 0.29
Nodes (4): ndarray, Initialize parameters from SAOS data.          Uses the crossover frequency and, Initialize parameters from viscosity vs shear rate data.          Uses the zero-, Clip estimated parameters to their defined bounds.          Common logic to ensu
...
Cohesion: 0.29
Nodes (4): ndarray, Get extracted yield stresses from amplitude sweep.          Returns:, Execute frequency to time conversion.          Args:             frequency_data:, Inverse Fourier transform from G*(ω) to G(t).          Uses numerical integratio
...
Cohesion: 0.33
Nodes (4): Test model registry integration., Test DMTLocal is in registry., Test creating models via registry., TestDMTRegistry

### Community 671 - "Community 671"
Cohesion: 0.33
Nodes (4): Tests for nonlocal model_function interface., Test model_function routes correctly for flow_curve., Test model_function routes correctly for creep., TestNonlocalModelFunction
...
Cohesion: 0.33
Nodes (4): Test batch export functionality., Test exporting summary to Excel., Test that exporting empty results produces warning., TestBatchExport

### Community 678 - "Community 678"
Cohesion: 0.33
Nodes (4): Detailed tests for the prediction_interval method., Test prediction_interval with x=None uses original x_data., Test prediction_interval returns None when model_fn is missing., TestPredictionIntervalMethod

### Community 679 - "Community 679"
Cohesion: 0.29
Nodes (5): ndarray, Test array matching with matching arrays., Test array matching with mismatched arrays., Validate that two arrays match within tolerance.      Parameters     ----------, _validate_array_match()
...
Cohesion: 0.33
Nodes (4): _jit_flow_curve_batch(), Pre-compile JIT kernels for faster Bayesian inference.          Triggers JAX JIT, Model function using JIT-compiled scalar kernels (for LatticeEPM)., JIT-compiled flow curve for batch of shear rates.      Args:         shear_rates
...
Cohesion: 0.33
Nodes (6): _Gp_integrand_imag(), _Gp_integrand_real(), _Gp_quadrature(), Real part of Gp integrand for storage modulus G'(omega).      Parameters     ---, Imaginary part of Gp integrand for loss modulus G''(omega).      Parameters, Compute Gp(x, z) using numerical quadrature.      Parameters     ----------
...
Cohesion: 0.33
Nodes (6): fitted_maxwell(), fitted_maxwell_oscillation(), _maxwell_oscillation_data(), ndarray, Generate synthetic Maxwell oscillation data: G* = G0*(i*omega*tau)/(1+i*omega*ta, Return a Maxwell model fitted to synthetic relaxation data.
...
Cohesion: 0.40
Nodes (4): parse_args(), Namespace, Parse command line arguments.      Parameters     ----------     argv : list[str, The --workspace flag exists and defaults to False.
...
Cohesion: 0.50
Nodes (3): Tests for mode-aware Bayesian inference (v0.4.0 fix)., Test that test_mode is correctly captured for Bayesian., TestModeAwareBayesian

### Community 759 - "Community 759"
Cohesion: 0.50
Nodes (3): Tests for MCMC diagnostics., Test R-hat < 1.1 for converged chains., TestDiagnostics

### Community 760 - "Community 760"
Cohesion: 0.50
Nodes (3): Tests comparing to literature values., Test α > 0 shows some shear-thinning behavior.          The Giesekus model pre, TestLiteratureComparison
...
Cohesion: 0.67
Nodes (3): get_recent_projects(), Path, Get list of recent project paths.      Returns     -------     list[Path]

## Knowledge Gaps
- **582 isolated node(s):** `$schema`, `title`, `description`, `type`, `type` (+577 more)
...
- **Why does `ModelRegistry` connect `BaseModel API & Methods` to `Core NLSQ & Bayesian Base`, `RheoData & Data Layer`, `GUI Bayesian Page & Jobs`, `Model Registry & Inventory`, `VLB Viscoelastic Models`, `Community 518`, `Community 517`, `Community 519`, `Saramito Fluidity Models`, `ArviZ Utils & Bayesian Results`, `Community 524`, `Community 527`, `Bayesian Pipeline`, `Giesekus Single-Mode Model`, `Community 531`, `Community 20`, `Community 21`, `Community 534`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 532`, `Community 29`, `Community 30`, `Community 535`, `Community 32`, `Community 33`, `Community 542`, `Community 540`, `Community 541`, `Community 37`, `Community 38`, `Community 546`, `Community 40`, `Community 545`, `Community 42`, `Community 43`, `Community 550`, `Community 45`, `Community 549`, `Community 551`, `Community 48`, `Community 555`, `Community 554`, `Community 561`, `Community 558`, `Community 560`, `Community 559`, `Community 55`, `Community 56`, `Community 574`, `Community 64`, `Community 65`, `Community 586`, `Community 76`, `Community 588`, `Community 589`, `Community 79`, `Community 590`, `Community 81`, `Community 594`, `Community 83`, `Community 92`, `Community 605`, `Community 606`, `Community 604`, `Community 607`, `Community 101`, `Community 105`, `Community 618`, `Community 619`, `Community 620`, `Community 621`, `Community 113`, `Community 625`, `Community 115`, `Community 116`, `Community 117`, `Community 633`, `Community 634`, `Community 635`, `Community 533`, `Community 637`, `Community 638`, `Community 636`, `Community 640`, `Community 639`, `Community 642`, `Community 131`, `Community 643`, `Community 641`, `Community 646`, `Community 647`, `Community 648`, `Community 536`, `Community 537`, `Community 144`, `Community 538`, `Community 148`, `Community 539`, `Community 153`, `Community 670`, `Community 673`, `Community 674`, `Community 675`, `Community 164`, `Community 165`, `Community 677`, `Community 170`, `Community 543`, `Community 544`, `Community 185`, `Community 703`, `Community 193`, `Community 194`, `Community 195`, `Community 547`, `Community 548`, `Community 199`, `Community 711`, `Community 716`, `Community 717`, `Community 206`, `Community 719`, `Community 718`, `Community 720`, `Community 216`, `Community 552`, `Community 220`, `Community 223`, `Community 553`, `Community 225`, `Community 738`, `Community 739`, `Community 228`, `Community 740`, `Community 741`, `Community 234`, `Community 238`, `Community 245`, `Community 259`, `Community 262`, `Community 263`, `Community 264`, `Community 265`, `Community 268`, `Community 273`, `Community 277`, `Community 278`, `Community 282`, `Community 284`, `Community 285`, `Community 302`, `Community 303`, `Community 312`, `Community 315`, `Community 323`, `Community 330`, `Community 331`, `Community 332`, `Community 333`, `Community 334`, `Community 345`, `Community 346`, `Community 350`, `Community 351`, `Community 362`, `Community 368`, `Community 369`, `Community 370`, `Community 384`, `Community 386`, `Community 393`, `Community 405`, `Community 406`, `Community 407`, `Community 408`, `Community 412`, `Community 413`, `Community 414`, `Community 415`, `Community 417`, `Community 431`, `Community 435`, `Community 436`, `Community 437`, `Community 446`, `Community 455`, `Community 456`, `Community 459`, `Community 461`, `Community 462`, `Community 467`, `Community 468`, `Community 469`, `Community 470`, `Community 471`, `Community 472`, `Community 473`, `Community 474`, `Community 475`, `Community 476`, `Community 492`, `Community 493`, `Community 494`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `RheoData` connect `RheoData & Data Layer` to `Core NLSQ & Bayesian Base`, `BaseModel API & Methods`, `GUI Bayesian Page & Jobs`, `GUI App & Main Window`, `Model Registry & Inventory`, `Community 516`, `Anton Paar IO Reader`, `CLI SPP Analysis`, `Import Wizard Dialog`, `GUI Import Worker & Drop Zone`, `Community 521`, `ArviZ Utils & Bayesian Results`, `Transform Page & Worker`, `Bayesian Pipeline`, `CSV Reader & IO`, `Community 20`, `Community 27`, `Community 28`, `Community 31`, `Community 32`, `Community 37`, `Community 40`, `Community 44`, `Community 48`, `Community 53`, `Community 55`, `Community 58`, `Community 572`, `Community 573`, `Community 60`, `Community 63`, `Community 65`, `Community 68`, `Community 71`, `Community 583`, `Community 585`, `Community 74`, `Community 75`, `Community 76`, `Community 589`, `Community 78`, `Community 590`, `Community 80`, `Community 81`, `Community 594`, `Community 83`, `Community 77`, `Community 598`, `Community 89`, `Community 602`, `Community 91`, `Community 603`, `Community 609`, `Community 610`, `Community 611`, `Community 612`, `Community 619`, `Community 620`, `Community 621`, `Community 110`, `Community 113`, `Community 626`, `Community 627`, `Community 628`, `Community 117`, `Community 629`, `Community 129`, `Community 130`, `Community 131`, `Community 649`, `Community 143`, `Community 656`, `Community 147`, `Community 148`, `Community 151`, `Community 153`, `Community 667`, `Community 156`, `Community 673`, `Community 677`, `Community 172`, `Community 176`, `Community 178`, `Community 693`, `Community 185`, `Community 698`, `Community 699`, `Community 704`, `Community 705`, `Community 706`, `Community 195`, `Community 707`, `Community 711`, `Community 206`, `Community 209`, `Community 723`, `Community 726`, `Community 215`, `Community 728`, `Community 217`, `Community 218`, `Community 223`, `Community 738`, `Community 739`, `Community 740`, `Community 741`, `Community 745`, `Community 235`, `Community 239`, `Community 243`, `Community 763`, `Community 252`, `Community 255`, `Community 773`, `Community 265`, `Community 277`, `Community 286`, `Community 287`, `Community 288`, `Community 291`, `Community 823`, `Community 825`, `Community 315`, `Community 336`, `Community 348`, `Community 352`, `Community 360`, `Community 362`, `Community 364`, `Community 73`, `Community 372`, `Community 385`, `Community 393`, `Community 401`, `Community 402`, `Community 405`, `Community 442`, `Community 446`, `Community 447`, `Community 454`, `Community 479`, `Community 490`, `Community 495`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `safe_import_jax()` connect `Core NLSQ & Bayesian Base` to `RheoData & Data Layer`, `BaseModel API & Methods`, `GUI App & Main Window`, `Model Registry & Inventory`, `VLB Viscoelastic Models`, `Saramito Fluidity Models`, `ArviZ Utils & Bayesian Results`, `Community 21`, `Community 23`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 42`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 55`, `Community 568`, `Community 58`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 73`, `Community 81`, `Community 84`, `Community 87`, `Community 89`, `Community 95`, `Community 96`, `Community 112`, `Community 113`, `Community 115`, `Community 121`, `Community 122`, `Community 644`, `Community 145`, `Community 150`, `Community 152`, `Community 153`, `Community 157`, `Community 158`, `Community 164`, `Community 169`, `Community 172`, `Community 177`, `Community 178`, `Community 184`, `Community 190`, `Community 192`, `Community 200`, `Community 201`, `Community 207`, `Community 218`, `Community 220`, `Community 221`, `Community 242`, `Community 246`, `Community 247`, `Community 253`, `Community 259`, `Community 268`, `Community 273`, `Community 276`, `Community 284`, `Community 304`, `Community 311`, `Community 312`, `Community 316`, `Community 330`, `Community 368`, `Community 369`, `Community 381`, `Community 410`, `Community 426`, `Community 428`, `Community 429`, `Community 449`, `Community 508`, `Community 509`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Are the 396 inferred relationships involving `RheoData` (e.g. with `BaseModel` and `BaseTransform`) actually correct?**
  _`RheoData` has 396 INFERRED edges - model-reasoned connections that need verification._
- **Are the 422 inferred relationships involving `ModelRegistry` (e.g. with `FitResult` and `ModelComparison`) actually correct?**
  _`ModelRegistry` has 422 INFERRED edges - model-reasoned connections that need verification._
- **Are the 398 inferred relationships involving `ValueError` (e.g. with `_fit_single()` and `_load_from_envelope()`) actually correct?**
  _`ValueError` has 398 INFERRED edges - model-reasoned connections that need verification._
- **Are the 160 inferred relationships involving `ParameterSet` (e.g. with `BaseModel` and `BaseTransform`) actually correct?**
  _`ParameterSet` has 160 INFERRED edges - model-reasoned connections that need verification._