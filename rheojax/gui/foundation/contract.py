...
_TEMPLATES: dict[str, dict] = {
    "flow_curve":  {"columns": [("shear_rate", "1/s")], "domain": "time", "control_vars": []},
    "creep":       {"columns": [("time", "s"), ("strain", "-")], "domain": "time", "control_vars": ["sigma0"]},
    "relaxation":  {"columns": [("time", "s"), ("G_t", "Pa")], "domain": "time", "control_vars": ["gamma0"]},
    "startup":     {"columns": [("time", "s"), ("stress", "Pa")], "domain": "time", "control_vars": ["gamma_dot0"]},
    "oscillation": {"columns": [("omega", "rad/s"), ("G_prime", "Pa"), ("G_double_prime", "Pa")],
                    "domain": "frequency", "unit_conversions": {"x": "Hz->rad/s"}, "control_vars": ["gamma0"]},
    "laos":        {"columns": [("time", "s"), ("stress", "Pa")], "domain": "time", "control_vars": ["omega", "gamma0"]},
}
...
def input_contract(protocol: str, model_key: str | None = None) -> InputContract:
    ...
    return InputContract(
        protocol=protocol, columns=cols, domain=t["domain"], y_quantity=y_quantity,
        unit_conversions=dict(t.get("unit_conversions", {})), control_vars=list(t["control_vars"]),
    )
