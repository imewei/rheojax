...
moduli :math:`G'` and :math:`G''` are not uniquely defined when the strain amplitude is sufficiently large
...
- **Constant across amplitudes**: Unlike :math:`G'`, G\ :sub:`cage` remains constant even at large
  amplitudes where :math:`G'` decreases by more than a decade
...
- Extracting instantaneous moduli :math:`G'(t)`, :math:`G''(t)`
